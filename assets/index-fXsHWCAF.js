const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/M0PreScan-N56nOjVF.js","assets/xlsx-CKN5doRT.js","assets/masterCatalogs-BbD_0MWE.js","assets/M1PHIScrubber-BQl8OIOa.js","assets/M2TriageRouter-EJsIJ5Qj.js","assets/M3AliasEngine-DewfK1ui.js","assets/cohere-Dswmjygu.js","assets/M4ConfidenceThreshold-BHCj4L9S.js","assets/M5DefinitionEngine-DuHuqI1b.js","assets/M6DeltaReport-B9HR-S1R.js","assets/M7AuditLog-zDHMM35J.js"])))=>i.map(i=>d[i]);
...
}`,EA=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],wA=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],w0=new We,zo=new k,Sd=new k;function TA(n,e,t){let i=new Up;const r=new $e,s=new $e,o=new _t,a=new fE,l=new hE,c={},d=t.maxTextureSize,f={[$i]:hn,[hn]:$i,[gi]:gi},u=new wi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:SA,fragmentShader:MA}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new Pt;g.setAttribute("position",new Ht(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ct(g,u),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ql;let h=this.type;this.render=function(b,R,y){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||b.length===0)return;this.type===Q_&&(Le("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ql);const T=n.getRenderTarget(),U=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),z=n.state;z.setBlending(Gi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const V=h!==this.type;V&&R.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(O=>O.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,O=b.length;W<O;W++){const C=b[W],N=C.shadow;if(N===void 0){Le("WebGLShadowMap:",C,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;r.copy(N.mapSize);const L=N.getFrameExtents();r.multiply(L),s.copy(N.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/L.x),r.x=s.x*L.x,N.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/L.y),r.y=s.y*L.y,N.mapSize.y=s.y));const F=n.state.buffers.depth.getReversed();if(N.camera._reversedDepth=F,N.map===null||V===!0){if(N.map!==null&&(N.map.depthTexture!==null&&(N.map.depthTexture.dispose(),N.map.depthTexture=null),N.map.dispose()),this.type===Yo){if(C.isPointLight){Le("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}N.map=new Mi(r.x,r.y,{format:oo,type:Ki,minFilter:Vt,magFilter:Vt,generateMipmaps:!1}),N.map.texture.name=C.name+".shadowMap",N.map.depthTexture=new Da(r.x,r.y,On),N.map.depthTexture.name=C.name+".shadowMapDepth",N.map.depthTexture.format=Zi,N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=zt,N.map.depthTexture.magFilter=zt}else C.isPointLight?(N.map=new Iv(r.x),N.map.depthTexture=new sE(r.x,Ei)):(N.map=new Mi(r.x,r.y),N.map.depthTexture=new Da(r.x,r.y,Ei)),N.map.depthTexture.name=C.name+".shadowMap",N.map.depthTexture.format=Zi,this.type===ql?(N.map.depthTexture.compareFunction=F?Cp:Rp,N.map.depthTexture.minFilter=Vt,N.map.depthTexture.magFilter=Vt):(N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=zt,N.map.depthTexture.magFilter=zt);N.camera.updateProjectionMatrix()}const Y=N.map.isWebGLCubeRenderTarget?6:1;for(let Z=0;Z<Y;Z++){if(N.map.isWebGLCubeRenderTarget)n.setRenderTarget(N.map,Z),n.clear();else{Z===0&&(n.setRenderTarget(N.map),n.clear());const te=N.getViewport(Z);o.set(s.x*te.x,s.y*te.y,s.x*te.z,s.y*te.w),z.viewport(o)}if(C.isPointLight){const te=N.camera,Se=N.matrix,ze=C.distance||te.far;ze!==te.far&&(te.far=ze,te.updateProjectionMatrix()),zo.setFromMatrixPosition(C.matrixWorld),te.position.copy(zo),Sd.copy(te.position),Sd.add(EA[Z]),te.up.copy(wA[Z]),te.lookAt(Sd),te.updateMatrixWorld(),Se.makeTranslation(-zo.x,-zo.y,-zo.z),w0.multiplyMatrices(te.projectionMatrix,te.matrixWorldInverse),N._frustum.setFromProjectionMatrix(w0,te.coordinateSystem,te.reversedDepth)}else N.updateMatrices(C);i=N.getFrustum(),S(R,y,N.camera,C,this.type)}N.isPointLightShadow!==!0&&this.type===Yo&&m(N,y),N.needsUpdate=!1}h=this.type,x.needsUpdate=!1,n.setRenderTarget(T,U,I)};function m(b,R){const y=e.update(v);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Mi(r.x,r.y,{format:oo,type:Ki})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(R,null,y,u,v,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(R,null,y,p,v,null)}function _(b,R,y,T){let U=null;const I=y.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(I!==void 0)U=I;else if(U=y.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const z=U.uuid,V=R.uuid;let W=c[z];W===void 0&&(W={},c[z]=W);let O=W[V];O===void 0&&(O=U.clone(),W[V]=O,R.addEventListener("dispose",w)),U=O}if(U.visible=R.visible,U.wireframe=R.wireframe,T===Yo?U.side=R.shadowSide!==null?R.shadowSide:R.side:U.side=R.shadowSide!==null?R.shadowSide:f[R.side],U.alphaMap=R.alphaMap,U.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,U.map=R.map,U.clipShadows=R.clipShadows,U.clippingPlanes=R.clippingPlanes,U.clipIntersection=R.clipIntersection,U.displacementMap=R.displacementMap,U.displacementScale=R.displacementScale,U.displacementBias=R.displacementBias,U.wireframeLinewidth=R.wireframeLinewidth,U.linewidth=R.linewidth,y.isPointLight===!0&&U.isMeshDistanceMaterial===!0){const z=n.properties.get(U);z.light=y}return U}function S(b,R,y,T,U){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&U===Yo)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,b.matrixWorld);const V=e.update(b),W=b.material;if(Array.isArray(W)){const O=V.groups;for(let C=0,N=O.length;C<N;C++){const L=O[C],F=W[L.materialIndex];if(F&&F.visible){const Y=_(b,F,T,U);b.onBeforeShadow(n,b,R,y,V,Y,L),n.renderBufferDirect(y,null,V,Y,b,L),b.onAfterShadow(n,b,R,y,V,Y,L)}}}else if(W.visible){const O=_(b,W,T,U);b.onBeforeShadow(n,b,R,y,V,O,null),n.renderBufferDirect(y,null,V,O,b,null),b.onAfterShadow(n,b,R,y,V,O,null)}}const z=b.children;for(let V=0,W=z.length;V<W;V++)S(z[V],R,y,T,U)}function w(b){b.target.removeEventListener("dispose",w);for(const y in c){const T=c[y],U=b.target.uuid;U in T&&(T[U].dispose(),delete T[U])}}}function bA(n,e){function t(){let B=!1;const de=new _t;let ce=null;const ye=new _t(0,0,0,0);return{setMask:function(ae){ce!==ae&&!B&&(n.colorMask(ae,ae,ae,ae),ce=ae)},setLocked:function(ae){B=ae},setClear:function(ae,J,we,Be,pt){pt===!0&&(ae*=Be,J*=Be,we*=Be),de.set(ae,J,we,Be),ye.equals(de)===!1&&(n.clearColor(ae,J,we,Be),ye.copy(de))},reset:function(){B=!1,ce=null,ye.set(-1,0,0,0)}}}function i(){let B=!1,de=!1,ce=null,ye=null,ae=null;return{setReversed:function(J){if(de!==J){const we=e.get("EXT_clip_control");J?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),de=J;const Be=ae;ae=null,this.setClear(Be)}},getReversed:function(){return de},setTest:function(J){J?K(n.DEPTH_TEST):ne(n.DEPTH_TEST)},setMask:function(J){ce!==J&&!B&&(n.depthMask(J),ce=J)},setFunc:function(J){if(de&&(J=p1[J]),ye!==J){switch(J){case Af:n.depthFunc(n.NEVER);break;case Rf:n.depthFunc(n.ALWAYS);break;case Cf:n.depthFunc(n.LESS);break;case io:n.depthFunc(n.LEQUAL);break;case Pf:n.depthFunc(n.EQUAL);break;case If:n.depthFunc(n.GEQUAL);break;case Lf:n.depthFunc(n.GREATER);break;case Nf:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ye=J}},setLocked:function(J){B=J},setClear:function(J){ae!==J&&(ae=J,de&&(J=1-J),n.clearDepth(J))},reset:function(){B=!1,ce=null,ye=null,ae=null,de=!1}}}function r(){let B=!1,de=null,ce=null,ye=null,ae=null,J=null,we=null,Be=null,pt=null;return{setTest:function(rt){B||(rt?K(n.STENCIL_TEST):ne(n.STENCIL_TEST))},setMask:function(rt){de!==rt&&!B&&(n.stencilMask(rt),de=rt)},setFunc:function(rt,Ai,Ri){(ce!==rt||ye!==Ai||ae!==Ri)&&(n.stencilFunc(rt,Ai,Ri),ce=rt,ye=Ai,ae=Ri)},setOp:function(rt,Ai,Ri){(J!==rt||we!==Ai||Be!==Ri)&&(n.stencilOp(rt,Ai,Ri),J=rt,we=Ai,Be=Ri)},setLocked:function(rt){B=rt},setClear:function(rt){pt!==rt&&(n.clearStencil(rt),pt=rt)},reset:function(){B=!1,de=null,ce=null,ye=null,ae=null,J=null,we=null,Be=null,pt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let d={},f={},u=new WeakMap,p=[],g=null,v=!1,x=null,h=null,m=null,_=null,S=null,w=null,b=null,R=new ke(0,0,0),y=0,T=!1,U=null,I=null,z=null,V=null,W=null;const O=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let C=!1,N=0;const L=n.getParameter(n.VERSION);L.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(L)[1]),C=N>=1):L.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(L)[1]),C=N>=2);let F=null,Y={};const Z=n.getParameter(n.SCISSOR_BOX),te=n.getParameter(n.VIEWPORT),Se=new _t().fromArray(Z),ze=new _t().fromArray(te);function fe(B,de,ce,ye){const ae=new Uint8Array(4),J=n.createTexture();n.bindTexture(B,J),n.texParameteri(B,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(B,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let we=0;we<ce;we++)B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?n.texImage3D(de,0,n.RGBA,1,1,ye,0,n.RGBA,n.UNSIGNED_BYTE,ae):n.texImage2D(de+we,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ae);return J}const j={};j[n.TEXTURE_2D]=fe(n.TEXTURE_2D,n.TEXTURE_2D,1),j[n.TEXTURE_CUBE_MAP]=fe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[n.TEXTURE_2D_ARRAY]=fe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),j[n.TEXTURE_3D]=fe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),K(n.DEPTH_TEST),o.setFunc(io),Oe(!1),bt(cg),K(n.CULL_FACE),et(Gi);function K(B){d[B]!==!0&&(n.enable(B),d[B]=!0)}function ne(B){d[B]!==!1&&(n.disable(B),d[B]=!1)}function Pe(B,de){return f[B]!==de?(n.bindFramebuffer(B,de),f[B]=de,B===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=de),B===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=de),!0):!1}function xe(B,de){let ce=p,ye=!1;if(B){ce=u.get(de),ce===void 0&&(ce=[],u.set(de,ce));const ae=B.textures;if(ce.length!==ae.length||ce[0]!==n.COLOR_ATTACHMENT0){for(let J=0,we=ae.length;J<we;J++)ce[J]=n.COLOR_ATTACHMENT0+J;ce.length=ae.length,ye=!0}}else ce[0]!==n.BACK&&(ce[0]=n.BACK,ye=!0);ye&&n.drawBuffers(ce)}function De(B){return g!==B?(n.useProgram(B),g=B,!0):!1}const gt={[Gr]:n.FUNC_ADD,[DM]:n.FUNC_SUBTRACT,[UM]:n.FUNC_REVERSE_SUBTRACT};gt[FM]=n.MIN,gt[OM]=n.MAX;const Ye={[kM]:n.ZERO,[BM]:n.ONE,[zM]:n.SRC_COLOR,[Tf]:n.SRC_ALPHA,[XM]:n.SRC_ALPHA_SATURATE,[WM]:n.DST_COLOR,[HM]:n.DST_ALPHA,[VM]:n.ONE_MINUS_SRC_COLOR,[bf]:n.ONE_MINUS_SRC_ALPHA,[jM]:n.ONE_MINUS_DST_COLOR,[GM]:n.ONE_MINUS_DST_ALPHA,[YM]:n.CONSTANT_COLOR,[qM]:n.ONE_MINUS_CONSTANT_COLOR,[$M]:n.CONSTANT_ALPHA,[KM]:n.ONE_MINUS_CONSTANT_ALPHA};function et(B,de,ce,ye,ae,J,we,Be,pt,rt){if(B===Gi){v===!0&&(ne(n.BLEND),v=!1);return}if(v===!1&&(K(n.BLEND),v=!0),B!==NM){if(B!==x||rt!==T){if((h!==Gr||S!==Gr)&&(n.blendEquation(n.FUNC_ADD),h=Gr,S=Gr),rt)switch(B){case Xs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ug:n.blendFunc(n.ONE,n.ONE);break;case dg:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case fg:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Fe("WebGLState: Invalid blending: ",B);break}else switch(B){case Xs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ug:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case dg:Fe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fg:Fe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Fe("WebGLState: Invalid blending: ",B);break}m=null,_=null,w=null,b=null,R.set(0,0,0),y=0,x=B,T=rt}return}ae=ae||de,J=J||ce,we=we||ye,(de!==h||ae!==S)&&(n.blendEquationSeparate(gt[de],gt[ae]),h=de,S=ae),(ce!==m||ye!==_||J!==w||we!==b)&&(n.blendFuncSeparate(Ye[ce],Ye[ye],Ye[J],Ye[we]),m=ce,_=ye,w=J,b=we),(Be.equals(R)===!1||pt!==y)&&(n.blendColor(Be.r,Be.g,Be.b,pt),R.copy(Be),y=pt),x=B,T=!1}function Je(B,de){B.side===gi?ne(n.CULL_FACE):K(n.CULL_FACE);let ce=B.side===hn;de&&(ce=!ce),Oe(ce),B.blending===Xs&&B.transparent===!1?et(Gi):et(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),o.setFunc(B.depthFunc),o.setTest(B.depthTest),o.setMask(B.depthWrite),s.setMask(B.colorWrite);const ye=B.stencilWrite;a.setTest(ye),ye&&(a.setMask(B.stencilWriteMask),a.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),a.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),dt(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?K(n.SAMPLE_ALPHA_TO_COVERAGE):ne(n.SAMPLE_ALPHA_TO_COVERAGE)}function Oe(B){U!==B&&(B?n.frontFace(n.CW):n.frontFace(n.CCW),U=B)}function bt(B){B!==IM?(K(n.CULL_FACE),B!==I&&(B===cg?n.cullFace(n.BACK):B===LM?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ne(n.CULL_FACE),I=B}function D(B){B!==z&&(C&&n.lineWidth(B),z=B)}function dt(B,de,ce){B?(K(n.POLYGON_OFFSET_FILL),(V!==de||W!==ce)&&(V=de,W=ce,o.getReversed()&&(de=-de),n.polygonOffset(de,ce))):ne(n.POLYGON_OFFSET_FILL)}function it(B){B?K(n.SCISSOR_TEST):ne(n.SCISSOR_TEST)}function ht(B){B===void 0&&(B=n.TEXTURE0+O-1),F!==B&&(n.activeTexture(B),F=B)}function Ae(B,de,ce){ce===void 0&&(F===null?ce=n.TEXTURE0+O-1:ce=F);let ye=Y[ce];ye===void 0&&(ye={type:void 0,texture:void 0},Y[ce]=ye),(ye.type!==B||ye.texture!==de)&&(F!==ce&&(n.activeTexture(ce),F=ce),n.bindTexture(B,de||j[B]),ye.type=B,ye.texture=de)}function P(){const B=Y[F];B!==void 0&&B.type!==void 0&&(n.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function M(){try{n.compressedTexImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function H(){try{n.compressedTexImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function ee(){try{n.texSubImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function ie(){try{n.texSubImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Q(){try{n.compressedTexSubImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Me(){try{n.compressedTexSubImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function ue(){try{n.texStorage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Ne(){try{n.texStorage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Ue(){try{n.texImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function oe(){try{n.texImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function le(B){Se.equals(B)===!1&&(n.scissor(B.x,B.y,B.z,B.w),Se.copy(B))}function Ee(B){ze.equals(B)===!1&&(n.viewport(B.x,B.y,B.z,B.w),ze.copy(B))}function Te(B,de){let ce=c.get(de);ce===void 0&&(ce=new WeakMap,c.set(de,ce));let ye=ce.get(B);ye===void 0&&(ye=n.getUniformBlockIndex(de,B.name),ce.set(B,ye))}function ge(B,de){const ye=c.get(de).get(B);l.get(de)!==ye&&(n.uniformBlockBinding(de,ye,B.__bindingPointIndex),l.set(de,ye))}function je(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},F=null,Y={},f={},u=new WeakMap,p=[],g=null,v=!1,x=null,h=null,m=null,_=null,S=null,w=null,b=null,R=new ke(0,0,0),y=0,T=!1,U=null,I=null,z=null,V=null,W=null,Se.set(0,0,n.canvas.width,n.canvas.height),ze.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:K,disable:ne,bindFramebuffer:Pe,drawBuffers:xe,useProgram:De,setBlending:et,setMaterial:Je,setFlipSided:Oe,setCullFace:bt,setLineWidth:D,setPolygonOffset:dt,setScissorTest:it,activeTexture:ht,bindTexture:Ae,unbindTexture:P,compressedTexImage2D:M,compressedTexImage3D:H,texImage2D:Ue,texImage3D:oe,updateUBOMapping:Te,uniformBlockBinding:ge,texStorage2D:ue,texStorage3D:Ne,texSubImage2D:ee,texSubImage3D:ie,compressedTexSubImage2D:Q,compressedTexSubImage3D:Me,scissor:le,viewport:Ee,reset:je}}function AA(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $e,d=new WeakMap;let f;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(P,M){return p?new OffscreenCanvas(P,M):Ia("canvas")}function v(P,M,H){let ee=1;const ie=Ae(P);if((ie.width>H||ie.height>H)&&(ee=H/Math.max(ie.width,ie.height)),ee<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const Q=Math.floor(ee*ie.width),Me=Math.floor(ee*ie.height);f===void 0&&(f=g(Q,Me));const ue=M?g(Q,Me):f;return ue.width=Q,ue.height=Me,ue.getContext("2d").drawImage(P,0,0,Q,Me),Le("WebGLRenderer: Texture has been resized from ("+ie.width+"x"+ie.height+") to ("+Q+"x"+Me+")."),ue}else return"data"in P&&Le("WebGLRenderer: Image in DataTexture is too big ("+ie.width+"x"+ie.height+")."),P;return P}function x(P){return P.generateMipmaps}function h(P){n.generateMipmap(P)}function m(P){return P.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?n.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(P,M,H,ee,ie=!1){if(P!==null){if(n[P]!==void 0)return n[P];Le("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let Q=M;if(M===n.RED&&(H===n.FLOAT&&(Q=n.R32F),H===n.HALF_FLOAT&&(Q=n.R16F),H===n.UNSIGNED_BYTE&&(Q=n.R8)),M===n.RED_INTEGER&&(H===n.UNSIGNED_BYTE&&(Q=n.R8UI),H===n.UNSIGNED_SHORT&&(Q=n.R16UI),H===n.UNSIGNED_INT&&(Q=n.R32UI),H===n.BYTE&&(Q=n.R8I),H===n.SHORT&&(Q=n.R16I),H===n.INT&&(Q=n.R32I)),M===n.RG&&(H===n.FLOAT&&(Q=n.RG32F),H===n.HALF_FLOAT&&(Q=n.RG16F),H===n.UNSIGNED_BYTE&&(Q=n.RG8)),M===n.RG_INTEGER&&(H===n.UNSIGNED_BYTE&&(Q=n.RG8UI),H===n.UNSIGNED_SHORT&&(Q=n.RG16UI),H===n.UNSIGNED_INT&&(Q=n.RG32UI),H===n.BYTE&&(Q=n.RG8I),H===n.SHORT&&(Q=n.RG16I),H===n.INT&&(Q=n.RG32I)),M===n.RGB_INTEGER&&(H===n.UNSIGNED_BYTE&&(Q=n.RGB8UI),H===n.UNSIGNED_SHORT&&(Q=n.RGB16UI),H===n.UNSIGNED_INT&&(Q=n.RGB32UI),H===n.BYTE&&(Q=n.RGB8I),H===n.SHORT&&(Q=n.RGB16I),H===n.INT&&(Q=n.RGB32I)),M===n.RGBA_INTEGER&&(H===n.UNSIGNED_BYTE&&(Q=n.RGBA8UI),H===n.UNSIGNED_SHORT&&(Q=n.RGBA16UI),H===n.UNSIGNED_INT&&(Q=n.RGBA32UI),H===n.BYTE&&(Q=n.RGBA8I),H===n.SHORT&&(Q=n.RGBA16I),H===n.INT&&(Q=n.RGBA32I)),M===n.RGB&&(H===n.UNSIGNED_INT_5_9_9_9_REV&&(Q=n.RGB9_E5),H===n.UNSIGNED_INT_10F_11F_11F_REV&&(Q=n.R11F_G11F_B10F)),M===n.RGBA){const Me=ie?Rc:Qe.getTransfer(ee);H===n.FLOAT&&(Q=n.RGBA32F),H===n.HALF_FLOAT&&(Q=n.RGBA16F),H===n.UNSIGNED_BYTE&&(Q=Me===st?n.SRGB8_ALPHA8:n.RGBA8),H===n.UNSIGNED_SHORT_4_4_4_4&&(Q=n.RGBA4),H===n.UNSIGNED_SHORT_5_5_5_1&&(Q=n.RGB5_A1)}return(Q===n.R16F||Q===n.R32F||Q===n.RG16F||Q===n.RG32F||Q===n.RGBA16F||Q===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function S(P,M){let H;return P?M===null||M===Ei||M===Aa?H=n.DEPTH24_STENCIL8:M===On?H=n.DEPTH32F_STENCIL8:M===ba&&(H=n.DEPTH24_STENCIL8,Le("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Ei||M===Aa?H=n.DEPTH_COMPONENT24:M===On?H=n.DEPTH_COMPONENT32F:M===ba&&(H=n.DEPTH_COMPONENT16),H}function w(P,M){return x(P)===!0||P.isFramebufferTexture&&P.minFilter!==zt&&P.minFilter!==Vt?Math.log2(Math.max(M.width,M.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?M.mipmaps.length:1}function b(P){const M=P.target;M.removeEventListener("dispose",b),y(M),M.isVideoTexture&&d.delete(M)}function R(P){const M=P.target;M.removeEventListener("dispose",R),U(M)}function y(P){const M=i.get(P);if(M.__webglInit===void 0)return;const H=P.source,ee=u.get(H);if(ee){const ie=ee[M.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&T(P),Object.keys(ee).length===0&&u.delete(H)}i.remove(P)}function T(P){const M=i.get(P);n.deleteTexture(M.__webglTexture);const H=P.source,ee=u.get(H);delete ee[M.__cacheKey],o.memory.textures--}function U(P){const M=i.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),i.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(M.__webglFramebuffer[ee]))for(let ie=0;ie<M.__webglFramebuffer[ee].length;ie++)n.deleteFramebuffer(M.__webglFramebuffer[ee][ie]);else n.deleteFramebuffer(M.__webglFramebuffer[ee]);M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer[ee])}else{if(Array.isArray(M.__webglFramebuffer))for(let ee=0;ee<M.__webglFramebuffer.length;ee++)n.deleteFramebuffer(M.__webglFramebuffer[ee]);else n.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&n.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let ee=0;ee<M.__webglColorRenderbuffer.length;ee++)M.__webglColorRenderbuffer[ee]&&n.deleteRenderbuffer(M.__webglColorRenderbuffer[ee]);M.__webglDepthRenderbuffer&&n.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const H=P.textures;for(let ee=0,ie=H.length;ee<ie;ee++){const Q=i.get(H[ee]);Q.__webglTexture&&(n.deleteTexture(Q.__webglTexture),o.memory.textures--),i.remove(H[ee])}i.remove(P)}let I=0;function z(){I=0}function V(){const P=I;return P>=r.maxTextures&&Le("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+r.maxTextures),I+=1,P}function W(P){const M=[];return M.push(P.wrapS),M.push(P.wrapT),M.push(P.wrapR||0),M.push(P.magFilter),M.push(P.minFilter),M.push(P.anisotropy),M.push(P.internalFormat),M.push(P.format),M.push(P.type),M.push(P.generateMipmaps),M.push(P.premultiplyAlpha),M.push(P.flipY),M.push(P.unpackAlignment),M.push(P.colorSpace),M.join()}function O(P,M){const H=i.get(P);if(P.isVideoTexture&&it(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&H.__version!==P.version){const ee=P.image;if(ee===null)Le("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)Le("WebGLRenderer: Texture marked for update but image is incomplete");else{j(H,P,M);return}}else P.isExternalTexture&&(H.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,H.__webglTexture,n.TEXTURE0+M)}function C(P,M){const H=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&H.__version!==P.version){j(H,P,M);return}else P.isExternalTexture&&(H.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,H.__webglTexture,n.TEXTURE0+M)}function N(P,M){const H=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&H.__version!==P.version){j(H,P,M);return}t.bindTexture(n.TEXTURE_3D,H.__webglTexture,n.TEXTURE0+M)}function L(P,M){const H=i.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&H.__version!==P.version){K(H,P,M);return}t.bindTexture(n.TEXTURE_CUBE_MAP,H.__webglTexture,n.TEXTURE0+M)}const F={[so]:n.REPEAT,[xi]:n.CLAMP_TO_EDGE,[Ac]:n.MIRRORED_REPEAT},Y={[zt]:n.NEAREST,[av]:n.NEAREST_MIPMAP_NEAREST,[qo]:n.NEAREST_MIPMAP_LINEAR,[Vt]:n.LINEAR,[$l]:n.LINEAR_MIPMAP_NEAREST,[Bi]:n.LINEAR_MIPMAP_LINEAR},Z={[r1]:n.NEVER,[c1]:n.ALWAYS,[s1]:n.LESS,[Rp]:n.LEQUAL,[o1]:n.EQUAL,[Cp]:n.GEQUAL,[a1]:n.GREATER,[l1]:n.NOTEQUAL};function te(P,M){if(M.type===On&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Vt||M.magFilter===$l||M.magFilter===qo||M.magFilter===Bi||M.minFilter===Vt||M.minFilter===$l||M.minFilter===qo||M.minFilter===Bi)&&Le("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(P,n.TEXTURE_WRAP_S,F[M.wrapS]),n.texParameteri(P,n.TEXTURE_WRAP_T,F[M.wrapT]),(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)&&n.texParameteri(P,n.TEXTURE_WRAP_R,F[M.wrapR]),n.texParameteri(P,n.TEXTURE_MAG_FILTER,Y[M.magFilter]),n.texParameteri(P,n.TEXTURE_MIN_FILTER,Y[M.minFilter]),M.compareFunction&&(n.texParameteri(P,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(P,n.TEXTURE_COMPARE_FUNC,Z[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===zt||M.minFilter!==qo&&M.minFilter!==Bi||M.type===On&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");n.texParameterf(P,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function Se(P,M){let H=!1;P.__webglInit===void 0&&(P.__webglInit=!0,M.addEventListener("dispose",b));const ee=M.source;let ie=u.get(ee);ie===void 0&&(ie={},u.set(ee,ie));const Q=W(M);if(Q!==P.__cacheKey){ie[Q]===void 0&&(ie[Q]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,H=!0),ie[Q].usedTimes++;const Me=ie[P.__cacheKey];Me!==void 0&&(ie[P.__cacheKey].usedTimes--,Me.usedTimes===0&&T(M)),P.__cacheKey=Q,P.__webglTexture=ie[Q].texture}return H}function ze(P,M,H){return Math.floor(Math.floor(P/H)/M)}function fe(P,M,H,ee){const Q=P.updateRanges;if(Q.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,M.width,M.height,H,ee,M.data);else{Q.sort((oe,le)=>oe.start-le.start);let Me=0;for(let oe=1;oe<Q.length;oe++){const le=Q[Me],Ee=Q[oe],Te=le.start+le.count,ge=ze(Ee.start,M.width,4),je=ze(le.start,M.width,4);Ee.start<=Te+1&&ge===je&&ze(Ee.start+Ee.count-1,M.width,4)===ge?le.count=Math.max(le.count,Ee.start+Ee.count-le.start):(++Me,Q[Me]=Ee)}Q.length=Me+1;const ue=n.getParameter(n.UNPACK_ROW_LENGTH),Ne=n.getParameter(n.UNPACK_SKIP_PIXELS),Ue=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,M.width);for(let oe=0,le=Q.length;oe<le;oe++){const Ee=Q[oe],Te=Math.floor(Ee.start/4),ge=Math.ceil(Ee.count/4),je=Te%M.width,B=Math.floor(Te/M.width),de=ge,ce=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,je),n.pixelStorei(n.UNPACK_SKIP_ROWS,B),t.texSubImage2D(n.TEXTURE_2D,0,je,B,de,ce,H,ee,M.data)}P.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ue),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ne),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ue)}}function j(P,M,H){let ee=n.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(ee=n.TEXTURE_2D_ARRAY),M.isData3DTexture&&(ee=n.TEXTURE_3D);const ie=Se(P,M),Q=M.source;t.bindTexture(ee,P.__webglTexture,n.TEXTURE0+H);const Me=i.get(Q);if(Q.version!==Me.__version||ie===!0){t.activeTexture(n.TEXTURE0+H);const ue=Qe.getPrimaries(Qe.workingColorSpace),Ne=M.colorSpace===pr?null:Qe.getPrimaries(M.colorSpace),Ue=M.colorSpace===pr||ue===Ne?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ue);let oe=v(M.image,!1,r.maxTextureSize);oe=ht(M,oe);const le=s.convert(M.format,M.colorSpace),Ee=s.convert(M.type);let Te=_(M.internalFormat,le,Ee,M.colorSpace,M.isVideoTexture);te(ee,M);let ge;const je=M.mipmaps,B=M.isVideoTexture!==!0,de=Me.__version===void 0||ie===!0,ce=Q.dataReady,ye=w(M,oe);if(M.isDepthTexture)Te=S(M.format===$r,M.type),de&&(B?t.texStorage2D(n.TEXTURE_2D,1,Te,oe.width,oe.height):t.texImage2D(n.TEXTURE_2D,0,Te,oe.width,oe.height,0,le,Ee,null));else if(M.isDataTexture)if(je.length>0){B&&de&&t.texStorage2D(n.TEXTURE_2D,ye,Te,je[0].width,je[0].height);for(let ae=0,J=je.length;ae<J;ae++)ge=je[ae],B?ce&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,ge.width,ge.height,le,Ee,ge.data):t.texImage2D(n.TEXTURE_2D,ae,Te,ge.width,ge.height,0,le,Ee,ge.data);M.generateMipmaps=!1}else B?(de&&t.texStorage2D(n.TEXTURE_2D,ye,Te,oe.width,oe.height),ce&&fe(M,oe,le,Ee)):t.texImage2D(n.TEXTURE_2D,0,Te,oe.width,oe.height,0,le,Ee,oe.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){B&&de&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ye,Te,je[0].width,je[0].height,oe.depth);for(let ae=0,J=je.length;ae<J;ae++)if(ge=je[ae],M.format!==kn)if(le!==null)if(B){if(ce)if(M.layerUpdates.size>0){const we=n0(ge.width,ge.height,M.format,M.type);for(const Be of M.layerUpdates){const pt=ge.data.subarray(Be*we/ge.data.BYTES_PER_ELEMENT,(Be+1)*we/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,Be,ge.width,ge.height,1,le,pt)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,0,ge.width,ge.height,oe.depth,le,ge.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ae,Te,ge.width,ge.height,oe.depth,0,ge.data,0,0);else Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else B?ce&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,0,ge.width,ge.height,oe.depth,le,Ee,ge.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ae,Te,ge.width,ge.height,oe.depth,0,le,Ee,ge.data)}else{B&&de&&t.texStorage2D(n.TEXTURE_2D,ye,Te,je[0].width,je[0].height);for(let ae=0,J=je.length;ae<J;ae++)ge=je[ae],M.format!==kn?le!==null?B?ce&&t.compressedTexSubImage2D(n.TEXTURE_2D,ae,0,0,ge.width,ge.height,le,ge.data):t.compressedTexImage2D(n.TEXTURE_2D,ae,Te,ge.width,ge.height,0,ge.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):B?ce&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,ge.width,ge.height,le,Ee,ge.data):t.texImage2D(n.TEXTURE_2D,ae,Te,ge.width,ge.height,0,le,Ee,ge.data)}else if(M.isDataArrayTexture)if(B){if(de&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ye,Te,oe.width,oe.height,oe.depth),ce)if(M.layerUpdates.size>0){const ae=n0(oe.width,oe.height,M.format,M.type);for(const J of M.layerUpdates){const we=oe.data.subarray(J*ae/oe.data.BYTES_PER_ELEMENT,(J+1)*ae/oe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,J,oe.width,oe.height,1,le,Ee,we)}M.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,oe.width,oe.height,oe.depth,le,Ee,oe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Te,oe.width,oe.height,oe.depth,0,le,Ee,oe.data);else if(M.isData3DTexture)B?(de&&t.texStorage3D(n.TEXTURE_3D,ye,Te,oe.width,oe.height,oe.depth),ce&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,oe.width,oe.height,oe.depth,le,Ee,oe.data)):t.texImage3D(n.TEXTURE_3D,0,Te,oe.width,oe.height,oe.depth,0,le,Ee,oe.data);else if(M.isFramebufferTexture){if(de)if(B)t.texStorage2D(n.TEXTURE_2D,ye,Te,oe.width,oe.height);else{let ae=oe.width,J=oe.height;for(let we=0;we<ye;we++)t.texImage2D(n.TEXTURE_2D,we,Te,ae,J,0,le,Ee,null),ae>>=1,J>>=1}}else if(je.length>0){if(B&&de){const ae=Ae(je[0]);t.texStorage2D(n.TEXTURE_2D,ye,Te,ae.width,ae.height)}for(let ae=0,J=je.length;ae<J;ae++)ge=je[ae],B?ce&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,le,Ee,ge):t.texImage2D(n.TEXTURE_2D,ae,Te,le,Ee,ge);M.generateMipmaps=!1}else if(B){if(de){const ae=Ae(oe);t.texStorage2D(n.TEXTURE_2D,ye,Te,ae.width,ae.height)}ce&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,le,Ee,oe)}else t.texImage2D(n.TEXTURE_2D,0,Te,le,Ee,oe);x(M)&&h(ee),Me.__version=Q.version,M.onUpdate&&M.onUpdate(M)}P.__version=M.version}function K(P,M,H){if(M.image.length!==6)return;const ee=Se(P,M),ie=M.source;t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+H);const Q=i.get(ie);if(ie.version!==Q.__version||ee===!0){t.activeTexture(n.TEXTURE0+H);const Me=Qe.getPrimaries(Qe.workingColorSpace),ue=M.colorSpace===pr?null:Qe.getPrimaries(M.colorSpace),Ne=M.colorSpace===pr||Me===ue?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);const Ue=M.isCompressedTexture||M.image[0].isCompressedTexture,oe=M.image[0]&&M.image[0].isDataTexture,le=[];for(let J=0;J<6;J++)!Ue&&!oe?le[J]=v(M.image[J],!0,r.maxCubemapSize):le[J]=oe?M.image[J].image:M.image[J],le[J]=ht(M,le[J]);const Ee=le[0],Te=s.convert(M.format,M.colorSpace),ge=s.convert(M.type),je=_(M.internalFormat,Te,ge,M.colorSpace),B=M.isVideoTexture!==!0,de=Q.__version===void 0||ee===!0,ce=ie.dataReady;let ye=w(M,Ee);te(n.TEXTURE_CUBE_MAP,M);let ae;if(Ue){B&&de&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,je,Ee.width,Ee.height);for(let J=0;J<6;J++){ae=le[J].mipmaps;for(let we=0;we<ae.length;we++){const Be=ae[we];M.format!==kn?Te!==null?B?ce&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,0,0,Be.width,Be.height,Te,Be.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,je,Be.width,Be.height,0,Be.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,0,0,Be.width,Be.height,Te,ge,Be.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,je,Be.width,Be.height,0,Te,ge,Be.data)}}}else{if(ae=M.mipmaps,B&&de){ae.length>0&&ye++;const J=Ae(le[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,je,J.width,J.height)}for(let J=0;J<6;J++)if(oe){B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,le[J].width,le[J].height,Te,ge,le[J].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,je,le[J].width,le[J].height,0,Te,ge,le[J].data);for(let we=0;we<ae.length;we++){const pt=ae[we].image[J].image;B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,0,0,pt.width,pt.height,Te,ge,pt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,je,pt.width,pt.height,0,Te,ge,pt.data)}}else{B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Te,ge,le[J]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,je,Te,ge,le[J]);for(let we=0;we<ae.length;we++){const Be=ae[we];B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,0,0,Te,ge,Be.image[J]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,je,Te,ge,Be.image[J])}}}x(M)&&h(n.TEXTURE_CUBE_MAP),Q.__version=ie.version,M.onUpdate&&M.onUpdate(M)}P.__version=M.version}function ne(P,M,H,ee,ie,Q){const Me=s.convert(H.format,H.colorSpace),ue=s.convert(H.type),Ne=_(H.internalFormat,Me,ue,H.colorSpace),Ue=i.get(M),oe=i.get(H);if(oe.__renderTarget=M,!Ue.__hasExternalTextures){const le=Math.max(1,M.width>>Q),Ee=Math.max(1,M.height>>Q);ie===n.TEXTURE_3D||ie===n.TEXTURE_2D_ARRAY?t.texImage3D(ie,Q,Ne,le,Ee,M.depth,0,Me,ue,null):t.texImage2D(ie,Q,Ne,le,Ee,0,Me,ue,null)}t.bindFramebuffer(n.FRAMEBUFFER,P),dt(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ee,ie,oe.__webglTexture,0,D(M)):(ie===n.TEXTURE_2D||ie>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ee,ie,oe.__webglTexture,Q),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Pe(P,M,H){if(n.bindRenderbuffer(n.RENDERBUFFER,P),M.depthBuffer){const ee=M.depthTexture,ie=ee&&ee.isDepthTexture?ee.type:null,Q=S(M.stencilBuffer,ie),Me=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;dt(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(M),Q,M.width,M.height):H?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(M),Q,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,Q,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Me,n.RENDERBUFFER,P)}else{const ee=M.textures;for(let ie=0;ie<ee.length;ie++){const Q=ee[ie],Me=s.convert(Q.format,Q.colorSpace),ue=s.convert(Q.type),Ne=_(Q.internalFormat,Me,ue,Q.colorSpace);dt(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(M),Ne,M.width,M.height):H?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(M),Ne,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,Ne,M.width,M.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function xe(P,M,H){const ee=M.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,P),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ie=i.get(M.depthTexture);if(ie.__renderTarget=M,(!ie.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),ee){if(ie.__webglInit===void 0&&(ie.__webglInit=!0,M.depthTexture.addEventListener("dispose",b)),ie.__webglTexture===void 0){ie.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ie.__webglTexture),te(n.TEXTURE_CUBE_MAP,M.depthTexture);const Ue=s.convert(M.depthTexture.format),oe=s.convert(M.depthTexture.type);let le;M.depthTexture.format===Zi?le=n.DEPTH_COMPONENT24:M.depthTexture.format===$r&&(le=n.DEPTH24_STENCIL8);for(let Ee=0;Ee<6;Ee++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,0,le,M.width,M.height,0,Ue,oe,null)}}else O(M.depthTexture,0);const Q=ie.__webglTexture,Me=D(M),ue=ee?n.TEXTURE_CUBE_MAP_POSITIVE_X+H:n.TEXTURE_2D,Ne=M.depthTexture.format===$r?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(M.depthTexture.format===Zi)dt(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Ne,ue,Q,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,Ne,ue,Q,0);else if(M.depthTexture.format===$r)dt(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Ne,ue,Q,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,Ne,ue,Q,0);else throw new Error("Unknown depthTexture format")}function De(P){const M=i.get(P),H=P.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==P.depthTexture){const ee=P.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),ee){const ie=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,ee.removeEventListener("dispose",ie)};ee.addEventListener("dispose",ie),M.__depthDisposeCallback=ie}M.__boundDepthTexture=ee}if(P.depthTexture&&!M.__autoAllocateDepthBuffer)if(H)for(let ee=0;ee<6;ee++)xe(M.__webglFramebuffer[ee],P,ee);else{const ee=P.texture.mipmaps;ee&&ee.length>0?xe(M.__webglFramebuffer[0],P,0):xe(M.__webglFramebuffer,P,0)}else if(H){M.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[ee]),M.__webglDepthbuffer[ee]===void 0)M.__webglDepthbuffer[ee]=n.createRenderbuffer(),Pe(M.__webglDepthbuffer[ee],P,!1);else{const ie=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Q=M.__webglDepthbuffer[ee];n.bindRenderbuffer(n.RENDERBUFFER,Q),n.framebufferRenderbuffer(n.FRAMEBUFFER,ie,n.RENDERBUFFER,Q)}}else{const ee=P.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=n.createRenderbuffer(),Pe(M.__webglDepthbuffer,P,!1);else{const ie=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Q=M.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,Q),n.framebufferRenderbuffer(n.FRAMEBUFFER,ie,n.RENDERBUFFER,Q)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function gt(P,M,H){const ee=i.get(P);M!==void 0&&ne(ee.__webglFramebuffer,P,P.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),H!==void 0&&De(P)}function Ye(P){const M=P.texture,H=i.get(P),ee=i.get(M);P.addEventListener("dispose",R);const ie=P.textures,Q=P.isWebGLCubeRenderTarget===!0,Me=ie.length>1;if(Me||(ee.__webglTexture===void 0&&(ee.__webglTexture=n.createTexture()),ee.__version=M.version,o.memory.textures++),Q){H.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(M.mipmaps&&M.mipmaps.length>0){H.__webglFramebuffer[ue]=[];for(let Ne=0;Ne<M.mipmaps.length;Ne++)H.__webglFramebuffer[ue][Ne]=n.createFramebuffer()}else H.__webglFramebuffer[ue]=n.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){H.__webglFramebuffer=[];for(let ue=0;ue<M.mipmaps.length;ue++)H.__webglFramebuffer[ue]=n.createFramebuffer()}else H.__webglFramebuffer=n.createFramebuffer();if(Me)for(let ue=0,Ne=ie.length;ue<Ne;ue++){const Ue=i.get(ie[ue]);Ue.__webglTexture===void 0&&(Ue.__webglTexture=n.createTexture(),o.memory.textures++)}if(P.samples>0&&dt(P)===!1){H.__webglMultisampledFramebuffer=n.createFramebuffer(),H.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let ue=0;ue<ie.length;ue++){const Ne=ie[ue];H.__webglColorRenderbuffer[ue]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,H.__webglColorRenderbuffer[ue]);const Ue=s.convert(Ne.format,Ne.colorSpace),oe=s.convert(Ne.type),le=_(Ne.internalFormat,Ue,oe,Ne.colorSpace,P.isXRRenderTarget===!0),Ee=D(P);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ee,le,P.width,P.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ue,n.RENDERBUFFER,H.__webglColorRenderbuffer[ue])}n.bindRenderbuffer(n.RENDERBUFFER,null),P.depthBuffer&&(H.__webglDepthRenderbuffer=n.createRenderbuffer(),Pe(H.__webglDepthRenderbuffer,P,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Q){t.bindTexture(n.TEXTURE_CUBE_MAP,ee.__webglTexture),te(n.TEXTURE_CUBE_MAP,M);for(let ue=0;ue<6;ue++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ne=0;Ne<M.mipmaps.length;Ne++)ne(H.__webglFramebuffer[ue][Ne],P,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ne);else ne(H.__webglFramebuffer[ue],P,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);x(M)&&h(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let ue=0,Ne=ie.length;ue<Ne;ue++){const Ue=ie[ue],oe=i.get(Ue);let le=n.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(le=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(le,oe.__webglTexture),te(le,Ue),ne(H.__webglFramebuffer,P,Ue,n.COLOR_ATTACHMENT0+ue,le,0),x(Ue)&&h(le)}t.unbindTexture()}else{let ue=n.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(ue=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ue,ee.__webglTexture),te(ue,M),M.mipmaps&&M.mipmaps.length>0)for(let Ne=0;Ne<M.mipmaps.length;Ne++)ne(H.__webglFramebuffer[Ne],P,M,n.COLOR_ATTACHMENT0,ue,Ne);else ne(H.__webglFramebuffer,P,M,n.COLOR_ATTACHMENT0,ue,0);x(M)&&h(ue),t.unbindTexture()}P.depthBuffer&&De(P)}function et(P){const M=P.textures;for(let H=0,ee=M.length;H<ee;H++){const ie=M[H];if(x(ie)){const Q=m(P),Me=i.get(ie).__webglTexture;t.bindTexture(Q,Me),h(Q),t.unbindTexture()}}}const Je=[],Oe=[];function bt(P){if(P.samples>0){if(dt(P)===!1){const M=P.textures,H=P.width,ee=P.height;let ie=n.COLOR_BUFFER_BIT;const Q=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Me=i.get(P),ue=M.length>1;if(ue)for(let Ue=0;Ue<M.length;Ue++)t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer);const Ne=P.texture.mipmaps;Ne&&Ne.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let Ue=0;Ue<M.length;Ue++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(ie|=n.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(ie|=n.STENCIL_BUFFER_BIT)),ue){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Ue]);const oe=i.get(M[Ue]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,oe,0)}n.blitFramebuffer(0,0,H,ee,0,0,H,ee,ie,n.NEAREST),l===!0&&(Je.length=0,Oe.length=0,Je.push(n.COLOR_ATTACHMENT0+Ue),P.depthBuffer&&P.resolveDepthBuffer===!1&&(Je.push(Q),Oe.push(Q),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Oe)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Je))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ue)for(let Ue=0;Ue<M.length;Ue++){t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Ue]);const oe=i.get(M[Ue]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.TEXTURE_2D,oe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const M=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[M])}}}function D(P){return Math.min(r.maxSamples,P.samples)}function dt(P){const M=i.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function it(P){const M=o.render.frame;d.get(P)!==M&&(d.set(P,M),P.update())}function ht(P,M){const H=P.colorSpace,ee=P.format,ie=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||H!==pn&&H!==pr&&(Qe.getTransfer(H)===st?(ee!==kn||ie!==bn)&&Le("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Fe("WebGLTextures: Unsupported texture color space:",H)),M}function Ae(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(c.width=P.naturalWidth||P.width,c.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(c.width=P.displayWidth,c.height=P.displayHeight):(c.width=P.width,c.height=P.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=z,this.setTexture2D=O,this.setTexture2DArray=C,this.setTexture3D=N,this.setTextureCube=L,this.rebindTextures=gt,this.setupRenderTarget=Ye,this.updateRenderTargetMipmap=et,this.updateMultisampleRenderTarget=bt,this.setupDepthRenderbuffer=De,this.setupFrameBufferTexture=ne,this.useMultisampledRTT=dt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function RA(n,e){function t(i,r=pr){let s;const o=Qe.getTransfer(r);if(i===bn)return n.UNSIGNED_BYTE;if(i===Sp)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Mp)return n.UNSIGNED_SHORT_5_5_5_1;if(i===uv)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dv)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===lv)return n.BYTE;if(i===cv)return n.SHORT;if(i===ba)return n.UNSIGNED_SHORT;if(i===yp)return n.INT;if(i===Ei)return n.UNSIGNED_INT;if(i===On)return n.FLOAT;if(i===Ki)return n.HALF_FLOAT;if(i===fv)return n.ALPHA;if(i===hv)return n.RGB;if(i===kn)return n.RGBA;if(i===Zi)return n.DEPTH_COMPONENT;if(i===$r)return n.DEPTH_STENCIL;if(i===Ep)return n.RED;if(i===wp)return n.RED_INTEGER;if(i===oo)return n.RG;if(i===Tp)return n.RG_INTEGER;if(i===bp)return n.RGBA_INTEGER;if(i===Kl||i===Zl||i===Jl||i===Ql)if(o===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Kl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Zl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Jl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ql)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Kl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Zl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Jl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ql)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Df||i===Uf||i===Ff||i===Of)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Df)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ff)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Of)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===kf||i===Bf||i===zf||i===Vf||i===Hf||i===Gf||i===Wf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===kf||i===Bf)return o===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===zf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Vf)return s.COMPRESSED_R11_EAC;if(i===Hf)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Gf)return s.COMPRESSED_RG11_EAC;if(i===Wf)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===jf||i===Xf||i===Yf||i===qf||i===$f||i===Kf||i===Zf||i===Jf||i===Qf||i===eh||i===th||i===nh||i===ih||i===rh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===jf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Xf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Yf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===qf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===$f)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Kf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Jf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Qf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===eh)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===th)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===nh)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ih)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===rh)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===sh||i===oh||i===ah)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===sh)return o===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===oh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ah)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===lh||i===ch||i===uh||i===dh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===lh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ch)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===uh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===dh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Aa?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const CA=`
void main() {
