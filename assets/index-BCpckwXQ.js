const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/M0PreScan-Ur4MfHuB.js","assets/xlsx-CKN5doRT.js","assets/masterCatalogs-BbD_0MWE.js","assets/M1PHIScrubber-CqAhyhEu.js","assets/M2TriageRouter-Dnmkz-6w.js","assets/M3AliasEngine-PUsqw_qI.js","assets/cohere-Dswmjygu.js","assets/M4ConfidenceThreshold-By-k0-Ez.js","assets/M5DefinitionEngine-CftC1Ag6.js","assets/M6DeltaReport-CbC1U3fH.js","assets/M7AuditLog-BhnuXIZ3.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(I,O){var Y=I.length;I.push(O);e:for(;0<Y;){var Z=Y-1>>>1,te=I[Z];if(0<r(te,O))I[Z]=O,I[Y]=te,Y=Z;else break e}}function t(I){return I.length===0?null:I[0]}function i(I){if(I.length===0)return null;var O=I[0],Y=I.pop();if(Y!==O){I[0]=Y;e:for(var Z=0,te=I.length,Pe=te>>>1;Z<Pe;){var Ue=2*(Z+1)-1,he=I[Ue],j=Ue+1,re=I[j];if(0>r(he,Y))j<te&&0>r(re,he)?(I[Z]=re,I[j]=Y,Z=j):(I[Z]=he,I[Ue]=Y,Z=Ue);else if(j<te&&0>r(re,Y))I[Z]=re,I[j]=Y,Z=j;else break e}}return O}function r(I,O){var Y=I.sortIndex-O.sortIndex;return Y!==0?Y:I.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],d=1,f=null,u=3,p=!1,g=!1,v=!1,x=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(I){for(var O=t(c);O!==null;){if(O.callback===null)i(c);else if(O.startTime<=I)i(c),O.sortIndex=O.expirationTime,e(l,O);else break;O=t(c)}}function S(I){if(v=!1,_(I),!g)if(t(l)!==null)g=!0,P(w);else{var O=t(c);O!==null&&N(S,O.startTime-I)}}function w(I,O){g=!1,v&&(v=!1,h(y),y=-1),p=!0;var Y=u;try{for(_(O),f=t(l);f!==null&&(!(f.expirationTime>O)||I&&!L());){var Z=f.callback;if(typeof Z=="function"){f.callback=null,u=f.priorityLevel;var te=Z(f.expirationTime<=O);O=n.unstable_now(),typeof te=="function"?f.callback=te:f===t(l)&&i(l),_(O)}else i(l);f=t(l)}if(f!==null)var Pe=!0;else{var Ue=t(c);Ue!==null&&N(S,Ue.startTime-O),Pe=!1}return Pe}finally{f=null,u=Y,p=!1}}var b=!1,R=null,y=-1,T=5,U=-1;function L(){return!(n.unstable_now()-U<T)}function z(){if(R!==null){var I=n.unstable_now();U=I;var O=!0;try{O=R(!0,I)}finally{O?W():(b=!1,R=null)}}else b=!1}var W;if(typeof m=="function")W=function(){m(z)};else if(typeof MessageChannel<"u"){var H=new MessageChannel,F=H.port2;H.port1.onmessage=z,W=function(){F.postMessage(null)}}else W=function(){x(z,0)};function P(I){R=I,b||(b=!0,W())}function N(I,O){y=x(function(){I(n.unstable_now())},O)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(I){I.callback=null},n.unstable_continueExecution=function(){g||p||(g=!0,P(w))},n.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<I?Math.floor(1e3/I):5},n.unstable_getCurrentPriorityLevel=function(){return u},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(I){switch(u){case 1:case 2:case 3:var O=3;break;default:O=u}var Y=u;u=O;try{return I()}finally{u=Y}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(I,O){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var Y=u;u=I;try{return O()}finally{u=Y}},n.unstable_scheduleCallback=function(I,O,Y){var Z=n.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?Z+Y:Z):Y=Z,I){case 1:var te=-1;break;case 2:te=250;break;case 5:te=1073741823;break;case 4:te=1e4;break;default:te=5e3}return te=Y+te,I={id:d++,callback:O,priorityLevel:I,startTime:Y,expirationTime:te,sortIndex:-1},Y>Z?(I.sortIndex=Y,e(c,I),t(l)===null&&I===t(c)&&(v?(h(y),y=-1):v=!0,N(S,Y-Z))):(I.sortIndex=te,e(l,I),g||p||(g=!0,P(w))),I},n.unstable_shouldYield=L,n.unstable_wrapCallback=function(I){var O=u;return function(){var Y=u;u=O;try{return I.apply(this,arguments)}finally{u=Y}}}})(ex);Q0.exports=ex;var wy=Q0.exports;/**
 * @license React
...
`)}const V2={[ev]:"Linear",[tv]:"Reinhard",[nv]:"Cineon",[tu]:"ACESFilmic",[rv]:"AgX",[sv]:"Neutral",[iv]:"Custom"};function H2(n,e){const t=V2[e];return t===void 0?(Ne("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Nl=new k;function G2(){Qe.getLuminanceCoefficients(Nl);const n=Nl.x.toFixed(4),e=Nl.y.toFixed(4),t=Nl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+h);const _=m+x+o,S=m+h+a,w=p0(r,r.VERTEX_SHADER,_),b=p0(r,r.FRAGMENT_SHADER,S);r.attachShader(v,w),r.attachShader(v,b),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function R(L){if(n.debug.checkShaderErrors){const z=r.getProgramInfoLog(v)||"",W=r.getShaderInfoLog(w)||"",H=r.getShaderInfoLog(b)||"",F=z.trim(),P=W.trim(),N=H.trim();let I=!0,O=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(I=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,w,b);else{const Y=g0(r,w,"vertex"),Z=g0(r,b,"fragment");Oe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,EA=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],wA=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],w0=new je,zo=new k,Sd=new k;function TA(n,e,t){let i=new Up;const r=new qe,s=new qe,o=new xt,a=new fE,l=new hE,c={},d=t.maxTextureSize,f={[qi]:hn,[hn]:qi,[gi]:gi},u=new wi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:SA,fragmentShader:MA}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new Pt;g.setAttribute("position",new Ht(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ct(g,u),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$l;let h=this.type;this.render=function(b,R,y){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||b.length===0)return;this.type===Q_&&(Ne("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=$l);const T=n.getRenderTarget(),U=n.getActiveCubeFace(),L=n.getActiveMipmapLevel(),z=n.state;z.setBlending(Gi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const W=h!==this.type;W&&R.traverse(function(H){H.material&&(Array.isArray(H.material)?H.material.forEach(F=>F.needsUpdate=!0):H.material.needsUpdate=!0)});for(let H=0,F=b.length;H<F;H++){const P=b[H],N=P.shadow;if(N===void 0){Ne("WebGLShadowMap:",P,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;r.copy(N.mapSize);const I=N.getFrameExtents();r.multiply(I),s.copy(N.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/I.x),r.x=s.x*I.x,N.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/I.y),r.y=s.y*I.y,N.mapSize.y=s.y));const O=n.state.buffers.depth.getReversed();if(N.camera._reversedDepth=O,N.map===null||W===!0){if(N.map!==null&&(N.map.depthTexture!==null&&(N.map.depthTexture.dispose(),N.map.depthTexture=null),N.map.dispose()),this.type===Yo){if(P.isPointLight){Ne("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}N.map=new Mi(r.x,r.y,{format:oo,type:Ki,minFilter:Vt,magFilter:Vt,generateMipmaps:!1}),N.map.texture.name=P.name+".shadowMap",N.map.depthTexture=new Da(r.x,r.y,On),N.map.depthTexture.name=P.name+".shadowMapDepth",N.map.depthTexture.format=Zi,N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=zt,N.map.depthTexture.magFilter=zt}else P.isPointLight?(N.map=new Iv(r.x),N.map.depthTexture=new sE(r.x,Ei)):(N.map=new Mi(r.x,r.y),N.map.depthTexture=new Da(r.x,r.y,Ei)),N.map.depthTexture.name=P.name+".shadowMap",N.map.depthTexture.format=Zi,this.type===$l?(N.map.depthTexture.compareFunction=O?Cp:Rp,N.map.depthTexture.minFilter=Vt,N.map.depthTexture.magFilter=Vt):(N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=zt,N.map.depthTexture.magFilter=zt);N.camera.updateProjectionMatrix()}const Y=N.map.isWebGLCubeRenderTarget?6:1;for(let Z=0;Z<Y;Z++){if(N.map.isWebGLCubeRenderTarget)n.setRenderTarget(N.map,Z),n.clear();else{Z===0&&(n.setRenderTarget(N.map),n.clear());const te=N.getViewport(Z);o.set(s.x*te.x,s.y*te.y,s.x*te.z,s.y*te.w),z.viewport(o)}if(P.isPointLight){const te=N.camera,Pe=N.matrix,Ue=P.distance||te.far;Ue!==te.far&&(te.far=Ue,te.updateProjectionMatrix()),zo.setFromMatrixPosition(P.matrixWorld),te.position.copy(zo),Sd.copy(te.position),Sd.add(EA[Z]),te.up.copy(wA[Z]),te.lookAt(Sd),te.updateMatrixWorld(),Pe.makeTranslation(-zo.x,-zo.y,-zo.z),w0.multiplyMatrices(te.projectionMatrix,te.matrixWorldInverse),N._frustum.setFromProjectionMatrix(w0,te.coordinateSystem,te.reversedDepth)}else N.updateMatrices(P);i=N.getFrustum(),S(R,y,N.camera,P,this.type)}N.isPointLightShadow!==!0&&this.type===Yo&&m(N,y),N.needsUpdate=!1}h=this.type,x.needsUpdate=!1,n.setRenderTarget(T,U,L)};function m(b,R){const y=e.update(v);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Mi(r.x,r.y,{format:oo,type:Ki})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(R,null,y,u,v,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(R,null,y,p,v,null)}function _(b,R,y,T){let U=null;const L=y.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(L!==void 0)U=L;else if(U=y.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const z=U.uuid,W=R.uuid;let H=c[z];H===void 0&&(H={},c[z]=H);let F=H[W];F===void 0&&(F=U.clone(),H[W]=F,R.addEventListener("dispose",w)),U=F}if(U.visible=R.visible,U.wireframe=R.wireframe,T===Yo?U.side=R.shadowSide!==null?R.shadowSide:R.side:U.side=R.shadowSide!==null?R.shadowSide:f[R.side],U.alphaMap=R.alphaMap,U.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,U.map=R.map,U.clipShadows=R.clipShadows,U.clippingPlanes=R.clippingPlanes,U.clipIntersection=R.clipIntersection,U.displacementMap=R.displacementMap,U.displacementScale=R.displacementScale,U.displacementBias=R.displacementBias,U.wireframeLinewidth=R.wireframeLinewidth,U.linewidth=R.linewidth,y.isPointLight===!0&&U.isMeshDistanceMaterial===!0){const z=n.properties.get(U);z.light=y}return U}function S(b,R,y,T,U){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&U===Yo)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,b.matrixWorld);const W=e.update(b),H=b.material;if(Array.isArray(H)){const F=W.groups;for(let P=0,N=F.length;P<N;P++){const I=F[P],O=H[I.materialIndex];if(O&&O.visible){const Y=_(b,O,T,U);b.onBeforeShadow(n,b,R,y,W,Y,I),n.renderBufferDirect(y,null,W,Y,b,I),b.onAfterShadow(n,b,R,y,W,Y,I)}}}else if(H.visible){const F=_(b,H,T,U);b.onBeforeShadow(n,b,R,y,W,F,null),n.renderBufferDirect(y,null,W,F,b,null),b.onAfterShadow(n,b,R,y,W,F,null)}}const z=b.children;for(let W=0,H=z.length;W<H;W++)S(z[W],R,y,T,U)}function w(b){b.target.removeEventListener("dispose",w);for(const y in c){const T=c[y],U=b.target.uuid;U in T&&(T[U].dispose(),delete T[U])}}}function bA(n,e){function t(){let B=!1;const de=new xt;let ce=null;const ve=new xt(0,0,0,0);return{setMask:function(ae){ce!==ae&&!B&&(n.colorMask(ae,ae,ae,ae),ce=ae)},setLocked:function(ae){B=ae},setClear:function(ae,J,Te,ze,pt){pt===!0&&(ae*=ze,J*=ze,Te*=ze),de.set(ae,J,Te,ze),ve.equals(de)===!1&&(n.clearColor(ae,J,Te,ze),ve.copy(de))},reset:function(){B=!1,ce=null,ve.set(-1,0,0,0)}}}function i(){let B=!1,de=!1,ce=null,ve=null,ae=null;return{setReversed:function(J){if(de!==J){const Te=e.get("EXT_clip_control");J?Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.ZERO_TO_ONE_EXT):Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.NEGATIVE_ONE_TO_ONE_EXT),de=J;const ze=ae;ae=null,this.setClear(ze)}},getReversed:function(){return de},setTest:function(J){J?re(n.DEPTH_TEST):K(n.DEPTH_TEST)},setMask:function(J){ce!==J&&!B&&(n.depthMask(J),ce=J)},setFunc:function(J){if(de&&(J=p1[J]),ve!==J){switch(J){case Af:n.depthFunc(n.NEVER);break;case Rf:n.depthFunc(n.ALWAYS);break;case Cf:n.depthFunc(n.LESS);break;case io:n.depthFunc(n.LEQUAL);break;case Pf:n.depthFunc(n.EQUAL);break;case If:n.depthFunc(n.GEQUAL);break;case Lf:n.depthFunc(n.GREATER);break;case Nf:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ve=J}},setLocked:function(J){B=J},setClear:function(J){ae!==J&&(ae=J,de&&(J=1-J),n.clearDepth(J))},reset:function(){B=!1,ce=null,ve=null,ae=null,de=!1}}}function r(){let B=!1,de=null,ce=null,ve=null,ae=null,J=null,Te=null,ze=null,pt=null;return{setTest:function(st){B||(st?re(n.STENCIL_TEST):K(n.STENCIL_TEST))},setMask:function(st){de!==st&&!B&&(n.stencilMask(st),de=st)},setFunc:function(st,Ai,Ri){(ce!==st||ve!==Ai||ae!==Ri)&&(n.stencilFunc(st,Ai,Ri),ce=st,ve=Ai,ae=Ri)},setOp:function(st,Ai,Ri){(J!==st||Te!==Ai||ze!==Ri)&&(n.stencilOp(st,Ai,Ri),J=st,Te=Ai,ze=Ri)},setLocked:function(st){B=st},setClear:function(st){pt!==st&&(n.clearStencil(st),pt=st)},reset:function(){B=!1,de=null,ce=null,ve=null,ae=null,J=null,Te=null,ze=null,pt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let d={},f={},u=new WeakMap,p=[],g=null,v=!1,x=null,h=null,m=null,_=null,S=null,w=null,b=null,R=new ke(0,0,0),y=0,T=!1,U=null,L=null,z=null,W=null,H=null;const F=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let P=!1,N=0;const I=n.getParameter(n.VERSION);I.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(I)[1]),P=N>=1):I.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(I)[1]),P=N>=2);let O=null,Y={};const Z=n.getParameter(n.SCISSOR_BOX),te=n.getParameter(n.VIEWPORT),Pe=new xt().fromArray(Z),Ue=new xt().fromArray(te);function he(B,de,ce,ve){const ae=new Uint8Array(4),J=n.createTexture();n.bindTexture(B,J),n.texParameteri(B,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(B,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Te=0;Te<ce;Te++)B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?n.texImage3D(de,0,n.RGBA,1,1,ve,0,n.RGBA,n.UNSIGNED_BYTE,ae):n.texImage2D(de+Te,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ae);return J}const j={};j[n.TEXTURE_2D]=he(n.TEXTURE_2D,n.TEXTURE_2D,1),j[n.TEXTURE_CUBE_MAP]=he(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[n.TEXTURE_2D_ARRAY]=he(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),j[n.TEXTURE_3D]=he(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),re(n.DEPTH_TEST),o.setFunc(io),Be(!1),yt(cg),re(n.CULL_FACE),et(Gi);function re(B){d[B]!==!0&&(n.enable(B),d[B]=!0)}function K(B){d[B]!==!1&&(n.disable(B),d[B]=!1)}function Me(B,de){return f[B]!==de?(n.bindFramebuffer(B,de),f[B]=de,B===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=de),B===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=de),!0):!1}function ye(B,de){let ce=p,ve=!1;if(B){ce=u.get(de),ce===void 0&&(ce=[],u.set(de,ce));const ae=B.textures;if(ce.length!==ae.length||ce[0]!==n.COLOR_ATTACHMENT0){for(let J=0,Te=ae.length;J<Te;J++)ce[J]=n.COLOR_ATTACHMENT0+J;ce.length=ae.length,ve=!0}}else ce[0]!==n.BACK&&(ce[0]=n.BACK,ve=!0);ve&&n.drawBuffers(ce)}function Se(B){return g!==B?(n.useProgram(B),g=B,!0):!1}const vt={[Wr]:n.FUNC_ADD,[DM]:n.FUNC_SUBTRACT,[UM]:n.FUNC_REVERSE_SUBTRACT};vt[FM]=n.MIN,vt[OM]=n.MAX;const Ge={[kM]:n.ZERO,[BM]:n.ONE,[zM]:n.SRC_COLOR,[Tf]:n.SRC_ALPHA,[XM]:n.SRC_ALPHA_SATURATE,[WM]:n.DST_COLOR,[HM]:n.DST_ALPHA,[VM]:n.ONE_MINUS_SRC_COLOR,[bf]:n.ONE_MINUS_SRC_ALPHA,[jM]:n.ONE_MINUS_DST_COLOR,[GM]:n.ONE_MINUS_DST_ALPHA,[YM]:n.CONSTANT_COLOR,[$M]:n.ONE_MINUS_CONSTANT_COLOR,[qM]:n.CONSTANT_ALPHA,[KM]:n.ONE_MINUS_CONSTANT_ALPHA};function et(B,de,ce,ve,ae,J,Te,ze,pt,st){if(B===Gi){v===!0&&(K(n.BLEND),v=!1);return}if(v===!1&&(re(n.BLEND),v=!0),B!==NM){if(B!==x||st!==T){if((h!==Wr||S!==Wr)&&(n.blendEquation(n.FUNC_ADD),h=Wr,S=Wr),st)switch(B){case Xs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ug:n.blendFunc(n.ONE,n.ONE);break;case dg:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case fg:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Oe("WebGLState: Invalid blending: ",B);break}else switch(B){case Xs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ug:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case dg:Oe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fg:Oe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Oe("WebGLState: Invalid blending: ",B);break}m=null,_=null,w=null,b=null,R.set(0,0,0),y=0,x=B,T=st}return}ae=ae||de,J=J||ce,Te=Te||ve,(de!==h||ae!==S)&&(n.blendEquationSeparate(vt[de],vt[ae]),h=de,S=ae),(ce!==m||ve!==_||J!==w||Te!==b)&&(n.blendFuncSeparate(Ge[ce],Ge[ve],Ge[J],Ge[Te]),m=ce,_=ve,w=J,b=Te),(ze.equals(R)===!1||pt!==y)&&(n.blendColor(ze.r,ze.g,ze.b,pt),R.copy(ze),y=pt),x=B,T=!1}function it(B,de){B.side===gi?K(n.CULL_FACE):re(n.CULL_FACE);let ce=B.side===hn;de&&(ce=!ce),Be(ce),B.blending===Xs&&B.transparent===!1?et(Gi):et(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),o.setFunc(B.depthFunc),o.setTest(B.depthTest),o.setMask(B.depthWrite),s.setMask(B.colorWrite);const ve=B.stencilWrite;a.setTest(ve),ve&&(a.setMask(B.stencilWriteMask),a.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),a.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),rt(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?re(n.SAMPLE_ALPHA_TO_COVERAGE):K(n.SAMPLE_ALPHA_TO_COVERAGE)}function Be(B){U!==B&&(B?n.frontFace(n.CW):n.frontFace(n.CCW),U=B)}function yt(B){B!==IM?(re(n.CULL_FACE),B!==L&&(B===cg?n.cullFace(n.BACK):B===LM?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):K(n.CULL_FACE),L=B}function D(B){B!==z&&(P&&n.lineWidth(B),z=B)}function rt(B,de,ce){B?(re(n.POLYGON_OFFSET_FILL),(W!==de||H!==ce)&&(W=de,H=ce,o.getReversed()&&(de=-de),n.polygonOffset(de,ce))):K(n.POLYGON_OFFSET_FILL)}function Je(B){B?re(n.SCISSOR_TEST):K(n.SCISSOR_TEST)}function ut(B){B===void 0&&(B=n.TEXTURE0+F-1),O!==B&&(n.activeTexture(B),O=B)}function be(B,de,ce){ce===void 0&&(O===null?ce=n.TEXTURE0+F-1:ce=O);let ve=Y[ce];ve===void 0&&(ve={type:void 0,texture:void 0},Y[ce]=ve),(ve.type!==B||ve.texture!==de)&&(O!==ce&&(n.activeTexture(ce),O=ce),n.bindTexture(B,de||j[B]),ve.type=B,ve.texture=de)}function C(){const B=Y[O];B!==void 0&&B.type!==void 0&&(n.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function M(){try{n.compressedTexImage2D(...arguments)}catch(B){Oe("WebGLState:",B)}}function V(){try{n.compressedTexImage3D(...arguments)}catch(B){Oe("WebGLState:",B)}}function ee(){try{n.texSubImage2D(...arguments)}catch(B){Oe("WebGLState:",B)}}function ne(){try{n.texSubImage3D(...arguments)}catch(B){Oe("WebGLState:",B)}}function Q(){try{n.compressedTexSubImage2D(...arguments)}catch(B){Oe("WebGLState:",B)}}function Ee(){try{n.compressedTexSubImage3D(...arguments)}catch(B){Oe("WebGLState:",B)}}function ue(){try{n.texStorage2D(...arguments)}catch(B){Oe("WebGLState:",B)}}function De(){try{n.texStorage3D(...arguments)}catch(B){Oe("WebGLState:",B)}}function Fe(){try{n.texImage2D(...arguments)}catch(B){Oe("WebGLState:",B)}}function oe(){try{n.texImage3D(...arguments)}catch(B){Oe("WebGLState:",B)}}function le(B){Pe.equals(B)===!1&&(n.scissor(B.x,B.y,B.z,B.w),Pe.copy(B))}function we(B){Ue.equals(B)===!1&&(n.viewport(B.x,B.y,B.z,B.w),Ue.copy(B))}function Ae(B,de){let ce=c.get(de);ce===void 0&&(ce=new WeakMap,c.set(de,ce));let ve=ce.get(B);ve===void 0&&(ve=n.getUniformBlockIndex(de,B.name),ce.set(B,ve))}function ge(B,de){const ve=c.get(de).get(B);l.get(de)!==ve&&(n.uniformBlockBinding(de,ve,B.__bindingPointIndex),l.set(de,ve))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},O=null,Y={},f={},u=new WeakMap,p=[],g=null,v=!1,x=null,h=null,m=null,_=null,S=null,w=null,b=null,R=new ke(0,0,0),y=0,T=!1,U=null,L=null,z=null,W=null,H=null,Pe.set(0,0,n.canvas.width,n.canvas.height),Ue.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:re,disable:K,bindFramebuffer:Me,drawBuffers:ye,useProgram:Se,setBlending:et,setMaterial:it,setFlipSided:Be,setCullFace:yt,setLineWidth:D,setPolygonOffset:rt,setScissorTest:Je,activeTexture:ut,bindTexture:be,unbindTexture:C,compressedTexImage2D:M,compressedTexImage3D:V,texImage2D:Fe,texImage3D:oe,updateUBOMapping:Ae,uniformBlockBinding:ge,texStorage2D:ue,texStorage3D:De,texSubImage2D:ee,texSubImage3D:ne,compressedTexSubImage2D:Q,compressedTexSubImage3D:Ee,scissor:le,viewport:we,reset:Xe}}function AA(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new qe,d=new WeakMap;let f;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,M){return p?new OffscreenCanvas(C,M):Ia("canvas")}function v(C,M,V){let ee=1;const ne=be(C);if((ne.width>V||ne.height>V)&&(ee=V/Math.max(ne.width,ne.height)),ee<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const Q=Math.floor(ee*ne.width),Ee=Math.floor(ee*ne.height);f===void 0&&(f=g(Q,Ee));const ue=M?g(Q,Ee):f;return ue.width=Q,ue.height=Ee,ue.getContext("2d").drawImage(C,0,0,Q,Ee),Ne("WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+Q+"x"+Ee+")."),ue}else return"data"in C&&Ne("WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),C;return C}function x(C){return C.generateMipmaps}function h(C){n.generateMipmap(C)}function m(C){return C.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?n.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(C,M,V,ee,ne=!1){if(C!==null){if(n[C]!==void 0)return n[C];Ne("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let Q=M;if(M===n.RED&&(V===n.FLOAT&&(Q=n.R32F),V===n.HALF_FLOAT&&(Q=n.R16F),V===n.UNSIGNED_BYTE&&(Q=n.R8)),M===n.RED_INTEGER&&(V===n.UNSIGNED_BYTE&&(Q=n.R8UI),V===n.UNSIGNED_SHORT&&(Q=n.R16UI),V===n.UNSIGNED_INT&&(Q=n.R32UI),V===n.BYTE&&(Q=n.R8I),V===n.SHORT&&(Q=n.R16I),V===n.INT&&(Q=n.R32I)),M===n.RG&&(V===n.FLOAT&&(Q=n.RG32F),V===n.HALF_FLOAT&&(Q=n.RG16F),V===n.UNSIGNED_BYTE&&(Q=n.RG8)),M===n.RG_INTEGER&&(V===n.UNSIGNED_BYTE&&(Q=n.RG8UI),V===n.UNSIGNED_SHORT&&(Q=n.RG16UI),V===n.UNSIGNED_INT&&(Q=n.RG32UI),V===n.BYTE&&(Q=n.RG8I),V===n.SHORT&&(Q=n.RG16I),V===n.INT&&(Q=n.RG32I)),M===n.RGB_INTEGER&&(V===n.UNSIGNED_BYTE&&(Q=n.RGB8UI),V===n.UNSIGNED_SHORT&&(Q=n.RGB16UI),V===n.UNSIGNED_INT&&(Q=n.RGB32UI),V===n.BYTE&&(Q=n.RGB8I),V===n.SHORT&&(Q=n.RGB16I),V===n.INT&&(Q=n.RGB32I)),M===n.RGBA_INTEGER&&(V===n.UNSIGNED_BYTE&&(Q=n.RGBA8UI),V===n.UNSIGNED_SHORT&&(Q=n.RGBA16UI),V===n.UNSIGNED_INT&&(Q=n.RGBA32UI),V===n.BYTE&&(Q=n.RGBA8I),V===n.SHORT&&(Q=n.RGBA16I),V===n.INT&&(Q=n.RGBA32I)),M===n.RGB&&(V===n.UNSIGNED_INT_5_9_9_9_REV&&(Q=n.RGB9_E5),V===n.UNSIGNED_INT_10F_11F_11F_REV&&(Q=n.R11F_G11F_B10F)),M===n.RGBA){const Ee=ne?Rc:Qe.getTransfer(ee);V===n.FLOAT&&(Q=n.RGBA32F),V===n.HALF_FLOAT&&(Q=n.RGBA16F),V===n.UNSIGNED_BYTE&&(Q=Ee===ot?n.SRGB8_ALPHA8:n.RGBA8),V===n.UNSIGNED_SHORT_4_4_4_4&&(Q=n.RGBA4),V===n.UNSIGNED_SHORT_5_5_5_1&&(Q=n.RGB5_A1)}return(Q===n.R16F||Q===n.R32F||Q===n.RG16F||Q===n.RG32F||Q===n.RGBA16F||Q===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function S(C,M){let V;return C?M===null||M===Ei||M===Aa?V=n.DEPTH24_STENCIL8:M===On?V=n.DEPTH32F_STENCIL8:M===ba&&(V=n.DEPTH24_STENCIL8,Ne("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Ei||M===Aa?V=n.DEPTH_COMPONENT24:M===On?V=n.DEPTH_COMPONENT32F:M===ba&&(V=n.DEPTH_COMPONENT16),V}function w(C,M){return x(C)===!0||C.isFramebufferTexture&&C.minFilter!==zt&&C.minFilter!==Vt?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function b(C){const M=C.target;M.removeEventListener("dispose",b),y(M),M.isVideoTexture&&d.delete(M)}function R(C){const M=C.target;M.removeEventListener("dispose",R),U(M)}function y(C){const M=i.get(C);if(M.__webglInit===void 0)return;const V=C.source,ee=u.get(V);if(ee){const ne=ee[M.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&T(C),Object.keys(ee).length===0&&u.delete(V)}i.remove(C)}function T(C){const M=i.get(C);n.deleteTexture(M.__webglTexture);const V=C.source,ee=u.get(V);delete ee[M.__cacheKey],o.memory.textures--}function U(C){const M=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(M.__webglFramebuffer[ee]))for(let ne=0;ne<M.__webglFramebuffer[ee].length;ne++)n.deleteFramebuffer(M.__webglFramebuffer[ee][ne]);else n.deleteFramebuffer(M.__webglFramebuffer[ee]);M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer[ee])}else{if(Array.isArray(M.__webglFramebuffer))for(let ee=0;ee<M.__webglFramebuffer.length;ee++)n.deleteFramebuffer(M.__webglFramebuffer[ee]);else n.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&n.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let ee=0;ee<M.__webglColorRenderbuffer.length;ee++)M.__webglColorRenderbuffer[ee]&&n.deleteRenderbuffer(M.__webglColorRenderbuffer[ee]);M.__webglDepthRenderbuffer&&n.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const V=C.textures;for(let ee=0,ne=V.length;ee<ne;ee++){const Q=i.get(V[ee]);Q.__webglTexture&&(n.deleteTexture(Q.__webglTexture),o.memory.textures--),i.remove(V[ee])}i.remove(C)}let L=0;function z(){L=0}function W(){const C=L;return C>=r.maxTextures&&Ne("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),L+=1,C}function H(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function F(C,M){const V=i.get(C);if(C.isVideoTexture&&Je(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&V.__version!==C.version){const ee=C.image;if(ee===null)Ne("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)Ne("WebGLRenderer: Texture marked for update but image is incomplete");else{j(V,C,M);return}}else C.isExternalTexture&&(V.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,V.__webglTexture,n.TEXTURE0+M)}function P(C,M){const V=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&V.__version!==C.version){j(V,C,M);return}else C.isExternalTexture&&(V.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,V.__webglTexture,n.TEXTURE0+M)}function N(C,M){const V=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&V.__version!==C.version){j(V,C,M);return}t.bindTexture(n.TEXTURE_3D,V.__webglTexture,n.TEXTURE0+M)}function I(C,M){const V=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&V.__version!==C.version){re(V,C,M);return}t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture,n.TEXTURE0+M)}const O={[so]:n.REPEAT,[xi]:n.CLAMP_TO_EDGE,[Ac]:n.MIRRORED_REPEAT},Y={[zt]:n.NEAREST,[av]:n.NEAREST_MIPMAP_NEAREST,[$o]:n.NEAREST_MIPMAP_LINEAR,[Vt]:n.LINEAR,[ql]:n.LINEAR_MIPMAP_NEAREST,[Bi]:n.LINEAR_MIPMAP_LINEAR},Z={[r1]:n.NEVER,[c1]:n.ALWAYS,[s1]:n.LESS,[Rp]:n.LEQUAL,[o1]:n.EQUAL,[Cp]:n.GEQUAL,[a1]:n.GREATER,[l1]:n.NOTEQUAL};function te(C,M){if(M.type===On&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Vt||M.magFilter===ql||M.magFilter===$o||M.magFilter===Bi||M.minFilter===Vt||M.minFilter===ql||M.minFilter===$o||M.minFilter===Bi)&&Ne("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(C,n.TEXTURE_WRAP_S,O[M.wrapS]),n.texParameteri(C,n.TEXTURE_WRAP_T,O[M.wrapT]),(C===n.TEXTURE_3D||C===n.TEXTURE_2D_ARRAY)&&n.texParameteri(C,n.TEXTURE_WRAP_R,O[M.wrapR]),n.texParameteri(C,n.TEXTURE_MAG_FILTER,Y[M.magFilter]),n.texParameteri(C,n.TEXTURE_MIN_FILTER,Y[M.minFilter]),M.compareFunction&&(n.texParameteri(C,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(C,n.TEXTURE_COMPARE_FUNC,Z[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===zt||M.minFilter!==$o&&M.minFilter!==Bi||M.type===On&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const V=e.get("EXT_texture_filter_anisotropic");n.texParameterf(C,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function Pe(C,M){let V=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",b));const ee=M.source;let ne=u.get(ee);ne===void 0&&(ne={},u.set(ee,ne));const Q=H(M);if(Q!==C.__cacheKey){ne[Q]===void 0&&(ne[Q]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,V=!0),ne[Q].usedTimes++;const Ee=ne[C.__cacheKey];Ee!==void 0&&(ne[C.__cacheKey].usedTimes--,Ee.usedTimes===0&&T(M)),C.__cacheKey=Q,C.__webglTexture=ne[Q].texture}return V}function Ue(C,M,V){return Math.floor(Math.floor(C/V)/M)}function he(C,M,V,ee){const Q=C.updateRanges;if(Q.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,M.width,M.height,V,ee,M.data);else{Q.sort((oe,le)=>oe.start-le.start);let Ee=0;for(let oe=1;oe<Q.length;oe++){const le=Q[Ee],we=Q[oe],Ae=le.start+le.count,ge=Ue(we.start,M.width,4),Xe=Ue(le.start,M.width,4);we.start<=Ae+1&&ge===Xe&&Ue(we.start+we.count-1,M.width,4)===ge?le.count=Math.max(le.count,we.start+we.count-le.start):(++Ee,Q[Ee]=we)}Q.length=Ee+1;const ue=n.getParameter(n.UNPACK_ROW_LENGTH),De=n.getParameter(n.UNPACK_SKIP_PIXELS),Fe=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,M.width);for(let oe=0,le=Q.length;oe<le;oe++){const we=Q[oe],Ae=Math.floor(we.start/4),ge=Math.ceil(we.count/4),Xe=Ae%M.width,B=Math.floor(Ae/M.width),de=ge,ce=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(n.UNPACK_SKIP_ROWS,B),t.texSubImage2D(n.TEXTURE_2D,0,Xe,B,de,ce,V,ee,M.data)}C.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ue),n.pixelStorei(n.UNPACK_SKIP_PIXELS,De),n.pixelStorei(n.UNPACK_SKIP_ROWS,Fe)}}function j(C,M,V){let ee=n.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(ee=n.TEXTURE_2D_ARRAY),M.isData3DTexture&&(ee=n.TEXTURE_3D);const ne=Pe(C,M),Q=M.source;t.bindTexture(ee,C.__webglTexture,n.TEXTURE0+V);const Ee=i.get(Q);if(Q.version!==Ee.__version||ne===!0){t.activeTexture(n.TEXTURE0+V);const ue=Qe.getPrimaries(Qe.workingColorSpace),De=M.colorSpace===pr?null:Qe.getPrimaries(M.colorSpace),Fe=M.colorSpace===pr||ue===De?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe);let oe=v(M.image,!1,r.maxTextureSize);oe=ut(M,oe);const le=s.convert(M.format,M.colorSpace),we=s.convert(M.type);let Ae=_(M.internalFormat,le,we,M.colorSpace,M.isVideoTexture);te(ee,M);let ge;const Xe=M.mipmaps,B=M.isVideoTexture!==!0,de=Ee.__version===void 0||ne===!0,ce=Q.dataReady,ve=w(M,oe);if(M.isDepthTexture)Ae=S(M.format===Kr,M.type),de&&(B?t.texStorage2D(n.TEXTURE_2D,1,Ae,oe.width,oe.height):t.texImage2D(n.TEXTURE_2D,0,Ae,oe.width,oe.height,0,le,we,null));else if(M.isDataTexture)if(Xe.length>0){B&&de&&t.texStorage2D(n.TEXTURE_2D,ve,Ae,Xe[0].width,Xe[0].height);for(let ae=0,J=Xe.length;ae<J;ae++)ge=Xe[ae],B?ce&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,ge.width,ge.height,le,we,ge.data):t.texImage2D(n.TEXTURE_2D,ae,Ae,ge.width,ge.height,0,le,we,ge.data);M.generateMipmaps=!1}else B?(de&&t.texStorage2D(n.TEXTURE_2D,ve,Ae,oe.width,oe.height),ce&&he(M,oe,le,we)):t.texImage2D(n.TEXTURE_2D,0,Ae,oe.width,oe.height,0,le,we,oe.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){B&&de&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ve,Ae,Xe[0].width,Xe[0].height,oe.depth);for(let ae=0,J=Xe.length;ae<J;ae++)if(ge=Xe[ae],M.format!==kn)if(le!==null)if(B){if(ce)if(M.layerUpdates.size>0){const Te=n0(ge.width,ge.height,M.format,M.type);for(const ze of M.layerUpdates){const pt=ge.data.subarray(ze*Te/ge.data.BYTES_PER_ELEMENT,(ze+1)*Te/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,ze,ge.width,ge.height,1,le,pt)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,0,ge.width,ge.height,oe.depth,le,ge.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ae,Ae,ge.width,ge.height,oe.depth,0,ge.data,0,0);else Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else B?ce&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,0,ge.width,ge.height,oe.depth,le,we,ge.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ae,Ae,ge.width,ge.height,oe.depth,0,le,we,ge.data)}else{B&&de&&t.texStorage2D(n.TEXTURE_2D,ve,Ae,Xe[0].width,Xe[0].height);for(let ae=0,J=Xe.length;ae<J;ae++)ge=Xe[ae],M.format!==kn?le!==null?B?ce&&t.compressedTexSubImage2D(n.TEXTURE_2D,ae,0,0,ge.width,ge.height,le,ge.data):t.compressedTexImage2D(n.TEXTURE_2D,ae,Ae,ge.width,ge.height,0,ge.data):Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):B?ce&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,ge.width,ge.height,le,we,ge.data):t.texImage2D(n.TEXTURE_2D,ae,Ae,ge.width,ge.height,0,le,we,ge.data)}else if(M.isDataArrayTexture)if(B){if(de&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ve,Ae,oe.width,oe.height,oe.depth),ce)if(M.layerUpdates.size>0){const ae=n0(oe.width,oe.height,M.format,M.type);for(const J of M.layerUpdates){const Te=oe.data.subarray(J*ae/oe.data.BYTES_PER_ELEMENT,(J+1)*ae/oe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,J,oe.width,oe.height,1,le,we,Te)}M.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,oe.width,oe.height,oe.depth,le,we,oe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ae,oe.width,oe.height,oe.depth,0,le,we,oe.data);else if(M.isData3DTexture)B?(de&&t.texStorage3D(n.TEXTURE_3D,ve,Ae,oe.width,oe.height,oe.depth),ce&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,oe.width,oe.height,oe.depth,le,we,oe.data)):t.texImage3D(n.TEXTURE_3D,0,Ae,oe.width,oe.height,oe.depth,0,le,we,oe.data);else if(M.isFramebufferTexture){if(de)if(B)t.texStorage2D(n.TEXTURE_2D,ve,Ae,oe.width,oe.height);else{let ae=oe.width,J=oe.height;for(let Te=0;Te<ve;Te++)t.texImage2D(n.TEXTURE_2D,Te,Ae,ae,J,0,le,we,null),ae>>=1,J>>=1}}else if(Xe.length>0){if(B&&de){const ae=be(Xe[0]);t.texStorage2D(n.TEXTURE_2D,ve,Ae,ae.width,ae.height)}for(let ae=0,J=Xe.length;ae<J;ae++)ge=Xe[ae],B?ce&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,le,we,ge):t.texImage2D(n.TEXTURE_2D,ae,Ae,le,we,ge);M.generateMipmaps=!1}else if(B){if(de){const ae=be(oe);t.texStorage2D(n.TEXTURE_2D,ve,Ae,ae.width,ae.height)}ce&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,le,we,oe)}else t.texImage2D(n.TEXTURE_2D,0,Ae,le,we,oe);x(M)&&h(ee),Ee.__version=Q.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function re(C,M,V){if(M.image.length!==6)return;const ee=Pe(C,M),ne=M.source;t.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+V);const Q=i.get(ne);if(ne.version!==Q.__version||ee===!0){t.activeTexture(n.TEXTURE0+V);const Ee=Qe.getPrimaries(Qe.workingColorSpace),ue=M.colorSpace===pr?null:Qe.getPrimaries(M.colorSpace),De=M.colorSpace===pr||Ee===ue?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,De);const Fe=M.isCompressedTexture||M.image[0].isCompressedTexture,oe=M.image[0]&&M.image[0].isDataTexture,le=[];for(let J=0;J<6;J++)!Fe&&!oe?le[J]=v(M.image[J],!0,r.maxCubemapSize):le[J]=oe?M.image[J].image:M.image[J],le[J]=ut(M,le[J]);const we=le[0],Ae=s.convert(M.format,M.colorSpace),ge=s.convert(M.type),Xe=_(M.internalFormat,Ae,ge,M.colorSpace),B=M.isVideoTexture!==!0,de=Q.__version===void 0||ee===!0,ce=ne.dataReady;let ve=w(M,we);te(n.TEXTURE_CUBE_MAP,M);let ae;if(Fe){B&&de&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ve,Xe,we.width,we.height);for(let J=0;J<6;J++){ae=le[J].mipmaps;for(let Te=0;Te<ae.length;Te++){const ze=ae[Te];M.format!==kn?Ae!==null?B?ce&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,0,0,ze.width,ze.height,Ae,ze.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,Xe,ze.width,ze.height,0,ze.data):Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,0,0,ze.width,ze.height,Ae,ge,ze.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,Xe,ze.width,ze.height,0,Ae,ge,ze.data)}}}else{if(ae=M.mipmaps,B&&de){ae.length>0&&ve++;const J=be(le[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ve,Xe,J.width,J.height)}for(let J=0;J<6;J++)if(oe){B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,le[J].width,le[J].height,Ae,ge,le[J].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Xe,le[J].width,le[J].height,0,Ae,ge,le[J].data);for(let Te=0;Te<ae.length;Te++){const pt=ae[Te].image[J].image;B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,0,0,pt.width,pt.height,Ae,ge,pt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,Xe,pt.width,pt.height,0,Ae,ge,pt.data)}}else{B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ae,ge,le[J]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Xe,Ae,ge,le[J]);for(let Te=0;Te<ae.length;Te++){const ze=ae[Te];B?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,0,0,Ae,ge,ze.image[J]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,Xe,Ae,ge,ze.image[J])}}}x(M)&&h(n.TEXTURE_CUBE_MAP),Q.__version=ne.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function K(C,M,V,ee,ne,Q){const Ee=s.convert(V.format,V.colorSpace),ue=s.convert(V.type),De=_(V.internalFormat,Ee,ue,V.colorSpace),Fe=i.get(M),oe=i.get(V);if(oe.__renderTarget=M,!Fe.__hasExternalTextures){const le=Math.max(1,M.width>>Q),we=Math.max(1,M.height>>Q);ne===n.TEXTURE_3D||ne===n.TEXTURE_2D_ARRAY?t.texImage3D(ne,Q,De,le,we,M.depth,0,Ee,ue,null):t.texImage2D(ne,Q,De,le,we,0,Ee,ue,null)}t.bindFramebuffer(n.FRAMEBUFFER,C),rt(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ee,ne,oe.__webglTexture,0,D(M)):(ne===n.TEXTURE_2D||ne>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ee,ne,oe.__webglTexture,Q),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Me(C,M,V){if(n.bindRenderbuffer(n.RENDERBUFFER,C),M.depthBuffer){const ee=M.depthTexture,ne=ee&&ee.isDepthTexture?ee.type:null,Q=S(M.stencilBuffer,ne),Ee=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;rt(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(M),Q,M.width,M.height):V?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(M),Q,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,Q,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Ee,n.RENDERBUFFER,C)}else{const ee=M.textures;for(let ne=0;ne<ee.length;ne++){const Q=ee[ne],Ee=s.convert(Q.format,Q.colorSpace),ue=s.convert(Q.type),De=_(Q.internalFormat,Ee,ue,Q.colorSpace);rt(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(M),De,M.width,M.height):V?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(M),De,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,De,M.width,M.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ye(C,M,V){const ee=M.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ne=i.get(M.depthTexture);if(ne.__renderTarget=M,(!ne.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),ee){if(ne.__webglInit===void 0&&(ne.__webglInit=!0,M.depthTexture.addEventListener("dispose",b)),ne.__webglTexture===void 0){ne.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ne.__webglTexture),te(n.TEXTURE_CUBE_MAP,M.depthTexture);const Fe=s.convert(M.depthTexture.format),oe=s.convert(M.depthTexture.type);let le;M.depthTexture.format===Zi?le=n.DEPTH_COMPONENT24:M.depthTexture.format===Kr&&(le=n.DEPTH24_STENCIL8);for(let we=0;we<6;we++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,le,M.width,M.height,0,Fe,oe,null)}}else F(M.depthTexture,0);const Q=ne.__webglTexture,Ee=D(M),ue=ee?n.TEXTURE_CUBE_MAP_POSITIVE_X+V:n.TEXTURE_2D,De=M.depthTexture.format===Kr?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(M.depthTexture.format===Zi)rt(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,De,ue,Q,0,Ee):n.framebufferTexture2D(n.FRAMEBUFFER,De,ue,Q,0);else if(M.depthTexture.format===Kr)rt(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,De,ue,Q,0,Ee):n.framebufferTexture2D(n.FRAMEBUFFER,De,ue,Q,0);else throw new Error("Unknown depthTexture format")}function Se(C){const M=i.get(C),V=C.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==C.depthTexture){const ee=C.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),ee){const ne=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,ee.removeEventListener("dispose",ne)};ee.addEventListener("dispose",ne),M.__depthDisposeCallback=ne}M.__boundDepthTexture=ee}if(C.depthTexture&&!M.__autoAllocateDepthBuffer)if(V)for(let ee=0;ee<6;ee++)ye(M.__webglFramebuffer[ee],C,ee);else{const ee=C.texture.mipmaps;ee&&ee.length>0?ye(M.__webglFramebuffer[0],C,0):ye(M.__webglFramebuffer,C,0)}else if(V){M.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[ee]),M.__webglDepthbuffer[ee]===void 0)M.__webglDepthbuffer[ee]=n.createRenderbuffer(),Me(M.__webglDepthbuffer[ee],C,!1);else{const ne=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Q=M.__webglDepthbuffer[ee];n.bindRenderbuffer(n.RENDERBUFFER,Q),n.framebufferRenderbuffer(n.FRAMEBUFFER,ne,n.RENDERBUFFER,Q)}}else{const ee=C.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=n.createRenderbuffer(),Me(M.__webglDepthbuffer,C,!1);else{const ne=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Q=M.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,Q),n.framebufferRenderbuffer(n.FRAMEBUFFER,ne,n.RENDERBUFFER,Q)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function vt(C,M,V){const ee=i.get(C);M!==void 0&&K(ee.__webglFramebuffer,C,C.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),V!==void 0&&Se(C)}function Ge(C){const M=C.texture,V=i.get(C),ee=i.get(M);C.addEventListener("dispose",R);const ne=C.textures,Q=C.isWebGLCubeRenderTarget===!0,Ee=ne.length>1;if(Ee||(ee.__webglTexture===void 0&&(ee.__webglTexture=n.createTexture()),ee.__version=M.version,o.memory.textures++),Q){V.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(M.mipmaps&&M.mipmaps.length>0){V.__webglFramebuffer[ue]=[];for(let De=0;De<M.mipmaps.length;De++)V.__webglFramebuffer[ue][De]=n.createFramebuffer()}else V.__webglFramebuffer[ue]=n.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){V.__webglFramebuffer=[];for(let ue=0;ue<M.mipmaps.length;ue++)V.__webglFramebuffer[ue]=n.createFramebuffer()}else V.__webglFramebuffer=n.createFramebuffer();if(Ee)for(let ue=0,De=ne.length;ue<De;ue++){const Fe=i.get(ne[ue]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=n.createTexture(),o.memory.textures++)}if(C.samples>0&&rt(C)===!1){V.__webglMultisampledFramebuffer=n.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let ue=0;ue<ne.length;ue++){const De=ne[ue];V.__webglColorRenderbuffer[ue]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,V.__webglColorRenderbuffer[ue]);const Fe=s.convert(De.format,De.colorSpace),oe=s.convert(De.type),le=_(De.internalFormat,Fe,oe,De.colorSpace,C.isXRRenderTarget===!0),we=D(C);n.renderbufferStorageMultisample(n.RENDERBUFFER,we,le,C.width,C.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ue,n.RENDERBUFFER,V.__webglColorRenderbuffer[ue])}n.bindRenderbuffer(n.RENDERBUFFER,null),C.depthBuffer&&(V.__webglDepthRenderbuffer=n.createRenderbuffer(),Me(V.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Q){t.bindTexture(n.TEXTURE_CUBE_MAP,ee.__webglTexture),te(n.TEXTURE_CUBE_MAP,M);for(let ue=0;ue<6;ue++)if(M.mipmaps&&M.mipmaps.length>0)for(let De=0;De<M.mipmaps.length;De++)K(V.__webglFramebuffer[ue][De],C,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,De);else K(V.__webglFramebuffer[ue],C,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);x(M)&&h(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ee){for(let ue=0,De=ne.length;ue<De;ue++){const Fe=ne[ue],oe=i.get(Fe);let le=n.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(le=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(le,oe.__webglTexture),te(le,Fe),K(V.__webglFramebuffer,C,Fe,n.COLOR_ATTACHMENT0+ue,le,0),x(Fe)&&h(le)}t.unbindTexture()}else{let ue=n.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ue=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ue,ee.__webglTexture),te(ue,M),M.mipmaps&&M.mipmaps.length>0)for(let De=0;De<M.mipmaps.length;De++)K(V.__webglFramebuffer[De],C,M,n.COLOR_ATTACHMENT0,ue,De);else K(V.__webglFramebuffer,C,M,n.COLOR_ATTACHMENT0,ue,0);x(M)&&h(ue),t.unbindTexture()}C.depthBuffer&&Se(C)}function et(C){const M=C.textures;for(let V=0,ee=M.length;V<ee;V++){const ne=M[V];if(x(ne)){const Q=m(C),Ee=i.get(ne).__webglTexture;t.bindTexture(Q,Ee),h(Q),t.unbindTexture()}}}const it=[],Be=[];function yt(C){if(C.samples>0){if(rt(C)===!1){const M=C.textures,V=C.width,ee=C.height;let ne=n.COLOR_BUFFER_BIT;const Q=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Ee=i.get(C),ue=M.length>1;if(ue)for(let Fe=0;Fe<M.length;Fe++)t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer);const De=C.texture.mipmaps;De&&De.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer);for(let Fe=0;Fe<M.length;Fe++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(ne|=n.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(ne|=n.STENCIL_BUFFER_BIT)),ue){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Ee.__webglColorRenderbuffer[Fe]);const oe=i.get(M[Fe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,oe,0)}n.blitFramebuffer(0,0,V,ee,0,0,V,ee,ne,n.NEAREST),l===!0&&(it.length=0,Be.length=0,it.push(n.COLOR_ATTACHMENT0+Fe),C.depthBuffer&&C.resolveDepthBuffer===!1&&(it.push(Q),Be.push(Q),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Be)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,it))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ue)for(let Fe=0;Fe<M.length;Fe++){t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,Ee.__webglColorRenderbuffer[Fe]);const oe=i.get(M[Fe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,oe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const M=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[M])}}}function D(C){return Math.min(r.maxSamples,C.samples)}function rt(C){const M=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Je(C){const M=o.render.frame;d.get(C)!==M&&(d.set(C,M),C.update())}function ut(C,M){const V=C.colorSpace,ee=C.format,ne=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||V!==pn&&V!==pr&&(Qe.getTransfer(V)===ot?(ee!==kn||ne!==bn)&&Ne("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Oe("WebGLTextures: Unsupported texture color space:",V)),M}function be(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=z,this.setTexture2D=F,this.setTexture2DArray=P,this.setTexture3D=N,this.setTextureCube=I,this.rebindTextures=vt,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=et,this.updateMultisampleRenderTarget=yt,this.setupDepthRenderbuffer=Se,this.setupFrameBufferTexture=K,this.useMultisampledRTT=rt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function RA(n,e){function t(i,r=pr){let s;const o=Qe.getTransfer(r);if(i===bn)return n.UNSIGNED_BYTE;if(i===Sp)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Mp)return n.UNSIGNED_SHORT_5_5_5_1;if(i===uv)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dv)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===lv)return n.BYTE;if(i===cv)return n.SHORT;if(i===ba)return n.UNSIGNED_SHORT;if(i===yp)return n.INT;if(i===Ei)return n.UNSIGNED_INT;if(i===On)return n.FLOAT;if(i===Ki)return n.HALF_FLOAT;if(i===fv)return n.ALPHA;if(i===hv)return n.RGB;if(i===kn)return n.RGBA;if(i===Zi)return n.DEPTH_COMPONENT;if(i===Kr)return n.DEPTH_STENCIL;if(i===Ep)return n.RED;if(i===wp)return n.RED_INTEGER;if(i===oo)return n.RG;if(i===Tp)return n.RG_INTEGER;if(i===bp)return n.RGBA_INTEGER;if(i===Kl||i===Zl||i===Jl||i===Ql)if(o===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Kl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Zl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Jl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ql)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Kl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Zl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Jl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ql)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Df||i===Uf||i===Ff||i===Of)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Df)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ff)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Of)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===kf||i===Bf||i===zf||i===Vf||i===Hf||i===Gf||i===Wf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===kf||i===Bf)return o===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===zf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Vf)return s.COMPRESSED_R11_EAC;if(i===Hf)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Gf)return s.COMPRESSED_RG11_EAC;if(i===Wf)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===jf||i===Xf||i===Yf||i===$f||i===qf||i===Kf||i===Zf||i===Jf||i===Qf||i===eh||i===th||i===nh||i===ih||i===rh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===jf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Xf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Yf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===$f)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Kf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Jf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Qf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===eh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===th)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===nh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ih)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===rh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===sh||i===oh||i===ah)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===sh)return o===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===oh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ah)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===lh||i===ch||i===uh||i===dh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===lh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ch)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===uh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===dh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Aa?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const CA=`
void main() {
...
`;function F0({role:n}){return n!=="SUPER_ADMIN"?null:E.jsx(dC,{})}function dC(){const[n,e]=ie.useState("idle"),[t,i]=ie.useState(""),[r,s]=ie.useState(""),[o,a]=ie.useState(!1),[l,c]=ie.useState(0),[d,f]=ie.useState(""),[u,p]=ie.useState(""),[g,v]=ie.useState("enter"),[x,h]=ie.useState({}),[m,_]=ie.useState({});ie.useEffect(()=>{_({gemini:di("gemini"),groq:di("groq"),openRouter:di("openRouter"),cerebras:di("cerebras"),deepseek:di("deepseek"),mistral:di("mistral"),togetherAI:di("togetherAI"),cohere:di("cohere"),umls:di("umls"),bioportal:di("bioportal")})},[n]),ie.useEffect(()=>{const P=setInterval(()=>{const{locked:N,remainingMs:I}=Cd();c(N?I:0)},500);return()=>clearInterval(P)},[]);function S(){const P=!!localStorage.getItem(Rd);e(P?"pin-entry":"pin-setup"),i(""),s("")}function w(){e("idle"),i(""),s("")}async function b(P){if(n==="pin-entry"){if(P==="⌫"){i(I=>I.slice(0,-1));return}if(P==="✓"){await R();return}if(t.length>=4)return;const N=t+P;i(N),N.length===4&&setTimeout(()=>R(N),100)}if(n==="pin-setup")if(g==="enter"){if(P==="⌫"){f(N=>N.slice(0,-1));return}if(P==="✓"||d.length===3){const N=P==="⌫"||P==="✓"?d:d+P;if(N.length===4){f(N),v("confirm"),p("");return}P!=="⌫"&&P!=="✓"&&f(I=>I.length<4?I+P:I);return}f(N=>N.length<4?N+P:N),d.length+1===4&&P!=="⌫"&&P!=="✓"&&setTimeout(()=>{v("confirm"),p("")},150)}else{if(P==="⌫"){p(I=>I.slice(0,-1));return}if(P==="✓"){await y();return}const N=u+P;p(N),N.length===4&&setTimeout(()=>y(N),100)}}async function R(P){const{locked:N}=Cd();if(N)return;const I=P||t;if(I.length<4){s("Enter all 4 digits");return}const O=localStorage.getItem(Rd);if(await D0(I)===O)aC(),e("open"),i(""),s("");else{oC();const{locked:Z,remainingMs:te}=Cd();Z&&c(te),T(),s(Z?`Locked for ${N0(Eh)}`:"Wrong PIN"),i("")}}async function y(P){const N=d;if(N!==(P||u)){T(),s("PINs don't match — try again"),v("enter"),f(""),p("");return}const O=await D0(N);localStorage.setItem(Rd,O),e("open"),f(""),p(""),s("")}function T(){a(!0),setTimeout(()=>a(!1),500)}const[U,L]=ie.useState({});function z(P,N){_(I=>({...I,[P]:N})),GR(P,N),L(I=>({...I,[P]:"idle"}))}async function W(P,N){if(N.trim()){L(I=>({...I,[P]:"testing"}));try{const I="Reply with exactly: OK";if(P==="groq")await $R(N,I,5);else if(P==="gemini")await JR(N,I,5);else if(P==="openRouter")await tC(N,I,5);else if(P==="deepseek")await rC(N,I,5);else if(P==="umls"){const O=await fetch(`https://uts-ws.nlm.nih.gov/rest/search/current?string=aspirin&apiKey=${encodeURIComponent(N)}&pageSize=1`);if(!O.ok)throw new Error("UMLS "+O.status)}else if(P==="bioportal"){const O=await fetch(`https://data.bioontology.org/search?q=aspirin&apikey=${encodeURIComponent(N)}&pagesize=1`);if(!O.ok)throw new Error("BioPortal "+O.status)}L(O=>({...O,[P]:"ok"}))}catch{L(I=>({...I,[P]:"fail"}))}}}const H=U0.map(P=>P.id),F=H.filter(P=>{var N;return(N=m[P])==null?void 0:N.trim()}).length;return E.jsxs(E.Fragment,{children:[E.jsx("style",{children:uC}),E.jsxs("div",{style:{maxWidth:1100,margin:"0 auto",padding:"10px 20px 0"},children:[n==="idle"&&E.jsxs("button",{onClick:S,style:{display:"flex",alignItems:"center",gap:8,padding:"8px 16px",borderRadius:10,border:"1px solid rgba(124,58,237,0.3)",background:"rgba(124,58,237,0.1)",cursor:"pointer",fontSize:13,fontWeight:600,color:"#c4b5fd",width:"100%",transition:"all 0.2s"},children:[E.jsx("span",{style:{fontSize:14},children:"🔑"}),E.jsxs("span",{style:{flex:1},children:["API Keys — ",F===0?"No keys set yet":`${F}/${H.length} AI providers active`]}),E.jsx("span",{style:{fontSize:11,padding:"2px 8px",borderRadius:10,background:"rgba(124,58,237,0.2)",color:"#a78bfa"},children:"🔒 PIN protected"}),E.jsx("span",{style:{fontSize:11,color:"rgba(255,255,255,0.3)"},children:"▼ open"})]}),(n==="pin-entry"||n==="pin-setup")&&E.jsxs("div",{style:{background:"rgba(10,10,26,0.97)",border:"1px solid rgba(124,58,237,0.3)",borderRadius:16,padding:24,display:"flex",flexDirection:"column",alignItems:"center",gap:16,position:"relative"},children:[E.jsx("button",{onClick:w,style:{position:"absolute",top:12,right:14,background:"none",border:"none",color:"rgba(255,255,255,0.4)",cursor:"pointer",fontSize:18},children:"✕"}),E.jsx("div",{style:{fontSize:24,filter:"drop-shadow(0 0 10px rgba(124,58,237,0.7))"},children:"🔑"}),E.jsx("div",{style:{color:"#fff",fontWeight:700,fontSize:14,textAlign:"center"},children:n==="pin-entry"?"Enter your 4-digit PIN":g==="enter"?"Set a 4-digit PIN for API Keys":"Confirm your PIN"}),l>0&&E.jsxs("div",{style:{background:"rgba(244,63,94,0.15)",border:"1px solid rgba(244,63,94,0.3)",borderRadius:8,padding:"8px 16px",fontSize:12,color:"#f43f5e",textAlign:"center"},children:["🔒 Locked — try again in ",N0(l)]}),E.jsx("div",{className:o?"pin-shake":"",style:{display:"flex",gap:12,marginTop:4},children:Array.from({length:4}).map((P,N)=>{const I=n==="pin-entry"?N<t.length:g==="enter"?N<d.length:N<u.length;return E.jsx("div",{style:{width:14,height:14,borderRadius:"50%",border:"2px solid rgba(124,58,237,0.6)",background:I?"#7c3aed":"transparent",boxShadow:I?"0 0 8px rgba(124,58,237,0.8)":"none",transition:"all 0.15s"}},N)})}),r&&E.jsx("div",{style:{fontSize:12,color:"#f43f5e",textAlign:"center"},children:r}),E.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,width:200},children:cC.map(P=>E.jsx("button",{className:"pin-digit-btn",onClick:()=>b(P),disabled:l>0||P==="✓"&&(n==="pin-entry"?t.length<4:g==="enter"?d.length<4:u.length<4),style:{padding:"14px 0",borderRadius:10,border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.05)",color:P==="✓"?"#10b981":P==="⌫"?"#f43f5e":"#fff",fontSize:P==="✓"||P==="⌫"?18:20,fontWeight:700,cursor:"pointer"},children:P},P))}),n==="pin-setup"&&g==="confirm"&&E.jsx("button",{onClick:()=>{v("enter"),f(""),p(""),s("")},style:{fontSize:11,color:"rgba(255,255,255,0.35)",background:"none",border:"none",cursor:"pointer"},children:"← Re-enter PIN"})]}),n==="open"&&E.jsxs("div",{style:{background:"rgba(10,10,26,0.95)",border:"1px solid rgba(124,58,237,0.25)",borderRadius:16,padding:16,display:"flex",flexDirection:"column",gap:12},children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[E.jsx("span",{style:{fontSize:14,color:"#c4b5fd"},children:"🔑"}),E.jsxs("span",{style:{flex:1,fontWeight:700,fontSize:13,color:"#fff"},children:["API Keys — ",F,"/",H.length," AI providers active"]}),E.jsx("button",{onClick:w,style:{padding:"4px 12px",borderRadius:8,border:"1px solid rgba(255,255,255,0.1)",background:"transparent",color:"rgba(255,255,255,0.4)",fontSize:11,cursor:"pointer"},children:"🔒 Lock"})]}),E.jsx("div",{style:{fontSize:11,color:"rgba(255,255,255,0.35)",paddingBottom:8,borderBottom:"1px solid rgba(255,255,255,0.06)"},children:"Keys saved in browser storage — never leave your device."}),E.jsxs("div",{style:{fontSize:10,fontWeight:800,color:"rgba(255,255,255,0.3)",letterSpacing:"1px",textTransform:"uppercase"},children:["🤖 AI Providers (",F,"/",H.length,")"]}),U0.map(P=>{const N=m[P.id]||"",I=N.trim().length>0,O=U[P.id]||"idle";return E.jsxs("div",{className:"key-row-card",style:{background:"rgba(255,255,255,0.03)",border:`1px solid ${O==="ok"?"rgba(52,211,153,0.3)":O==="fail"?"rgba(244,63,94,0.3)":"rgba(255,255,255,0.06)"}`,borderRadius:10,padding:"10px 14px"},children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:7},children:[E.jsx("span",{style:{fontSize:14},children:P.icon}),E.jsx("span",{style:{fontWeight:700,fontSize:12,color:P.color},children:P.label}),E.jsx("span",{style:{fontSize:9,fontWeight:800,color:"#fff",background:P.color+"33",border:`1px solid ${P.color}55`,padding:"1px 6px",borderRadius:8},children:P.badge}),O==="ok"&&E.jsx("span",{style:{fontSize:10,color:"#34d399",marginLeft:"auto"},children:"✓ Valid"}),O==="fail"&&E.jsx("span",{style:{fontSize:10,color:"#f87171",marginLeft:"auto"},children:"✗ Invalid"}),O==="idle"&&I&&E.jsx("span",{style:{fontSize:10,color:"rgba(255,255,255,0.3)",marginLeft:"auto"},children:"saved"})]}),E.jsxs("div",{style:{display:"flex",gap:7},children:[E.jsx("input",{type:x[P.id]?"text":"password",value:N,onChange:Y=>z(P.id,Y.target.value),placeholder:P.placeholder,style:{flex:1,padding:"7px 10px",borderRadius:7,border:"1px solid rgba(255,255,255,0.08)",background:"rgba(255,255,255,0.04)",color:"#fff",fontSize:11,fontFamily:"monospace",outline:"none"}}),I&&E.jsx("button",{onClick:()=>W(P.id,N),disabled:O==="testing",style:{padding:"6px 10px",borderRadius:7,border:"1px solid rgba(52,211,153,0.3)",background:"rgba(52,211,153,0.08)",cursor:"pointer",fontSize:11,color:"#34d399",whiteSpace:"nowrap"},children:O==="testing"?"…":"▶ Test"}),E.jsx("button",{onClick:()=>h(Y=>({...Y,[P.id]:!Y[P.id]})),style:{padding:"6px 10px",borderRadius:7,border:"1px solid rgba(255,255,255,0.08)",background:"rgba(255,255,255,0.05)",cursor:"pointer",fontSize:12,color:"rgba(255,255,255,0.5)"},children:x[P.id]?"🙈":"👁"}),I&&E.jsx("button",{onClick:()=>z(P.id,""),style:{padding:"6px 10px",borderRadius:7,border:"1px solid rgba(244,63,94,0.3)",background:"rgba(244,63,94,0.1)",cursor:"pointer",fontSize:11,color:"#f87171"},children:"✕"})]}),E.jsx("div",{style:{fontSize:10,color:"rgba(255,255,255,0.3)",marginTop:5},children:P.hint})]},P.id)}),E.jsx("div",{style:{fontSize:10,fontWeight:800,color:"rgba(255,255,255,0.3)",letterSpacing:"1px",textTransform:"uppercase",marginTop:4},children:"🗄️ Data Source Keys (optional)"}),lC.map(P=>{const N=m[P.id]||"",I=N.trim().length>0;return E.jsxs("div",{className:"key-row-card",style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:10,padding:"10px 14px"},children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:7},children:[E.jsx("span",{style:{fontSize:14},children:P.icon}),E.jsx("span",{style:{fontWeight:700,fontSize:12,color:P.color},children:P.label}),E.jsx("span",{style:{fontSize:9,fontWeight:800,color:"#fff",background:P.color+"33",padding:"1px 6px",borderRadius:8},children:"DATA"}),I&&E.jsx("span",{style:{fontSize:10,color:"#34d399",marginLeft:"auto"},children:"✓ saved"})]}),E.jsxs("div",{style:{display:"flex",gap:7},children:[E.jsx("input",{type:x[P.id]?"text":"password",value:N,onChange:O=>z(P.id,O.target.value),placeholder:P.placeholder,style:{flex:1,padding:"7px 10px",borderRadius:7,border:"1px solid rgba(255,255,255,0.08)",background:"rgba(255,255,255,0.04)",color:"#fff",fontSize:11,fontFamily:"monospace",outline:"none"}}),E.jsx("button",{onClick:()=>h(O=>({...O,[P.id]:!O[P.id]})),style:{padding:"6px 10px",borderRadius:7,border:"1px solid rgba(255,255,255,0.08)",background:"rgba(255,255,255,0.05)",cursor:"pointer",fontSize:12,color:"rgba(255,255,255,0.5)"},children:x[P.id]?"🙈":"👁"}),I&&E.jsx("button",{onClick:()=>z(P.id,""),style:{padding:"6px 10px",borderRadius:7,border:"1px solid rgba(244,63,94,0.3)",background:"rgba(244,63,94,0.1)",cursor:"pointer",fontSize:11,color:"#f87171"},children:"✕"})]}),E.jsx("div",{style:{fontSize:10,color:"rgba(255,255,255,0.3)",marginTop:5},children:P.hint})]},P.id)}),E.jsx("div",{style:{fontSize:10,color:"rgba(255,255,255,0.2)",padding:"8px 12px",background:"rgba(255,255,255,0.02)",borderRadius:8,border:"1px solid rgba(255,255,255,0.04)",marginTop:4},children:"💡 Gemini handles M5 matching. DeepSeek & Cerebras are fast fallbacks. All 8 AI providers form a waterfall chain — no batch is ever dropped. UMLS & BioPortal unlock extra M3 terminology tiers."})]})]})]})}const fC=`
...
`;function EC({onComplete:n}){var z,W,H,F,P,N;const{state:e,setM0:t,setM1:i,setM2:r,setM3:s,setM4:o,setM5:a}=Xv(),[l,c]=ie.useState({m0:"running",m1:"waiting",m2:"waiting",m3:"waiting",m5:"waiting",m4:"waiting",m6:"waiting"}),[d,f]=ie.useState({m0:"Upload catalog files to begin"}),[u,p]=ie.useState("m0"),[g,v]=ie.useState("uploading"),[x,h]=ie.useState(1);function m(I,O,Y){c(Z=>({...Z,[I]:O})),Y&&f(Z=>({...Z,[I]:Y}))}function _(I){var Z,te;t(I);const O=((Z=I==null?void 0:I.preMatched)==null?void 0:Z.length)||0,Y=((te=I==null?void 0:I.toProcess)==null?void 0:te.length)||0;m("m0","done",`${O} pre-matched · ${Y} to process`),v("running"),p("m1"),m("m1","running","Scanning for PHI…"),h(2)}function S(I){i(I),m("m1","done",`Risk: ${(I==null?void 0:I.riskLevel)||"clean"}`),p("m2"),m("m2","running","Routing by domain…"),h(3)}function w(I){var O;r(I),m("m2","done",`${((O=I==null?void 0:I.triaged)==null?void 0:O.length)||0} items triaged`),p("m3"),m("m3","running","Resolving aliases…"),h(4)}function b(I){var O;s(I),m("m3","done",`${((O=I==null?void 0:I.resolved)==null?void 0:O.length)||0} resolved`),p("m5"),m("m5","running","Enriching definitions…"),h(5)}function R(I){var O;a(I),m("m5","done",`${((O=I==null?void 0:I.enriched)==null?void 0:O.length)||0} enriched`),p("m4"),m("m4","running","Assigning DNA codes…"),h(6)}function y(I){var O;o(I),m("m4","done",`${((O=I==null?void 0:I.results)==null?void 0:O.length)||0} codes assigned`),p("m6"),m("m6","running","Generating delta report…"),h(7)}function T(){m("m6","done","Report generated · downloaded ✓"),p(null),v("done"),n==null||n()}const U=Object.values(l).filter(I=>I==="done").length,L=Math.round(U/Pd.length*100);return E.jsxs(E.Fragment,{children:[E.jsx("style",{children:MC}),E.jsxs("div",{style:{maxWidth:860,margin:"0 auto",padding:"32px 20px"},children:[E.jsxs("div",{style:{marginBottom:24},children:[E.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",marginBottom:6},children:[E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:10,fontWeight:700,color:"#dc2626",letterSpacing:"3px",textTransform:"uppercase",marginBottom:4},children:"Auto Pipeline"}),E.jsx("h2",{style:{fontSize:24,fontWeight:900,color:"#ffffff",letterSpacing:"-0.04em",lineHeight:1},children:g==="uploading"?"Upload Files to Begin":g==="done"?"Pipeline Complete":`Processing — ${U}/7`})]}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[g==="running"&&E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:7,padding:"5px 12px",borderRadius:6,border:"1px solid rgba(220,38,38,0.35)",background:"rgba(220,38,38,0.07)"},children:[E.jsx("div",{className:"live-dot"}),E.jsx("span",{style:{fontSize:10,fontWeight:700,color:"#dc2626",letterSpacing:"2px",textTransform:"uppercase"},children:"Live"})]}),E.jsxs("span",{style:{fontSize:22,fontWeight:900,color:L===100?"#ffffff":"rgba(255,255,255,0.3)"},children:[L,"%"]})]})]}),(g==="running"||g==="done")&&E.jsx("div",{style:{height:2,background:"rgba(255,255,255,0.08)",borderRadius:1,overflow:"hidden"},children:E.jsx("div",{style:{height:"100%",width:`${L}%`,background:L===100?"#ffffff":"#dc2626",transition:"width 0.6s cubic-bezier(0.16,1,0.3,1)",animation:"amp-barFill 0.6s ease"}})})]}),E.jsxs("div",{style:{border:"1px solid rgba(255,255,255,0.08)",borderRadius:16,overflow:"hidden"},children:[E.jsx("div",{style:{display:"grid",gridTemplateColumns:"48px 1fr 100px 120px",padding:"10px 20px",background:"rgba(255,255,255,0.03)",borderBottom:"1px solid rgba(255,255,255,0.06)"},children:["#","Module","Status","Result"].map(I=>E.jsx("span",{style:{fontSize:9,fontWeight:700,color:"rgba(255,255,255,0.25)",letterSpacing:"2px",textTransform:"uppercase"},children:I},I))}),Pd.map((I,O)=>{const Y=l[I.key],Z=d[I.key],te=u===I.key,Pe=Y==="done";return E.jsxs("div",{className:`amp-row${te?" amp-active-row":""}`,style:{display:"grid",gridTemplateColumns:"48px 1fr 100px 120px",padding:"14px 20px",alignItems:"center",background:Pe?"rgba(255,255,255,0.02)":te?"rgba(220,38,38,0.05)":"transparent",borderBottom:O<Pd.length-1?"1px solid rgba(255,255,255,0.05)":"none",transition:"background 0.3s",animationDelay:`${O*.04}s`},children:[E.jsx("span",{style:{fontWeight:900,fontSize:13,fontFamily:"monospace",color:Pe?"rgba(255,255,255,0.2)":te?"#dc2626":"rgba(255,255,255,0.12)"},children:I.num}),E.jsxs("div",{children:[E.jsxs("div",{style:{fontWeight:700,fontSize:13,color:Pe?"rgba(255,255,255,0.5)":te?"#ffffff":"rgba(255,255,255,0.3)",marginBottom:2},children:[te&&E.jsx("span",{className:"amp-spinner",style:{marginRight:8}}),I.label]}),E.jsx("div",{style:{fontSize:11,color:"rgba(255,255,255,0.2)"},children:I.desc})]}),E.jsxs("div",{children:[Y==="waiting"&&E.jsx("span",{style:{fontSize:9,padding:"3px 8px",borderRadius:4,background:"rgba(255,255,255,0.04)",color:"rgba(255,255,255,0.2)",fontWeight:700,letterSpacing:"1px"},children:"WAITING"}),Y==="running"&&E.jsx("span",{style:{fontSize:9,padding:"3px 8px",borderRadius:4,background:"rgba(220,38,38,0.15)",color:"#ef4444",fontWeight:700,letterSpacing:"1px",border:"1px solid rgba(220,38,38,0.3)"},children:"RUNNING"}),Y==="done"&&E.jsx("span",{style:{fontSize:9,padding:"3px 8px",borderRadius:4,background:"rgba(255,255,255,0.08)",color:"#ffffff",fontWeight:700,letterSpacing:"1px"},children:"DONE"}),Y==="error"&&E.jsx("span",{style:{fontSize:9,padding:"3px 8px",borderRadius:4,background:"rgba(220,38,38,0.2)",color:"#ef4444",fontWeight:700,letterSpacing:"1px"},children:"ERROR"})]}),E.jsx("div",{className:te?"amp-running-text":"",style:{fontSize:11,color:Pe?"rgba(255,255,255,0.45)":"rgba(255,255,255,0.2)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:Z||"—"})]},I.key)})]}),g==="uploading"&&E.jsxs("div",{style:{marginTop:24},children:[E.jsx("div",{style:{fontSize:10,fontWeight:700,color:"rgba(255,255,255,0.3)",letterSpacing:"2px",textTransform:"uppercase",marginBottom:12},children:"Step 01 — Pre-Scan Upload"}),E.jsx(ie.Suspense,{fallback:E.jsx("div",{style:{padding:32,textAlign:"center",border:"1px dashed rgba(255,255,255,0.08)",borderRadius:12,color:"rgba(255,255,255,0.3)",fontSize:13},children:"Loading upload module…"}),children:E.jsx(mC,{onComplete:_})})]}),g==="done"&&E.jsxs("div",{style:{marginTop:24,padding:"28px 32px",background:"#ffffff",borderRadius:16,display:"flex",alignItems:"center",justifyContent:"space-between"},children:[E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:10,fontWeight:700,color:"#dc2626",letterSpacing:"3px",textTransform:"uppercase",marginBottom:4},children:"Pipeline Complete"}),E.jsx("div",{style:{fontSize:20,fontWeight:900,color:"#000000",letterSpacing:"-0.04em"},children:"All 7 modules finished"}),E.jsx("div",{style:{fontSize:13,color:"rgba(0,0,0,0.5)",marginTop:4},children:"Delta report has been generated and downloaded."})]}),E.jsx("div",{style:{fontSize:40},children:"✓"})]}),g==="running"&&E.jsx("div",{style:{position:"absolute",left:"-9999px",pointerEvents:"none",width:1,height:1,overflow:"hidden"},children:E.jsxs(ie.Suspense,{fallback:null,children:[x===2&&E.jsx(gC,{prefillData:e.m0Result?{toProcess:e.m0Result.toProcess}:null,onComplete:S}),x===3&&E.jsx(xC,{prefillData:e.m1Result,onComplete:w}),x===4&&E.jsx(_C,{prefillData:e.m2Result,onComplete:b}),x===5&&E.jsx(yC,{prefillData:e.m3Result,onComplete:R}),x===6&&E.jsx(vC,{prefillData:{...e.m5Result||e.m3Result,masterCatalogs:(z=e.m0Result)==null?void 0:z.masterCatalogs},onComplete:y}),x===7&&E.jsx(SC,{prefillData:{results:(W=e.m4Result)==null?void 0:W.results,hospitalName:(H=e.m4Result)==null?void 0:H.hospitalName,masterCatalogs:(F=e.m4Result)==null?void 0:F.masterCatalogs,masterDNAs:(P=e.m4Result)==null?void 0:P.masterDNAs,preMatched:(N=e.m0Result)==null?void 0:N.preMatched},onComplete:T})]})})]})]})}const kc="audit_log_v1",Yv=500;function z0(n){try{const e=JSON.parse(localStorage.getItem(kc)||"[]"),t={...n,id:crypto.randomUUID?crypto.randomUUID():Date.now().toString(36),timestamp:new Date().toISOString()};localStorage.setItem(kc,JSON.stringify([t,...e].slice(0,Yv)))}catch{}}function wC(n="system"){function e(i){z0({...i,user:n})}function t(i,r,s="pipeline"){z0({module:i,action:"ERROR: "+r,fileName:s,outcome:"error",itemCount:0,user:n})}return{writeEntry:e,logError:t}}function UC(n,e,t="pipeline"){try{const i=JSON.parse(localStorage.getItem(kc)||"[]"),r={id:crypto.randomUUID?crypto.randomUUID():Date.now().toString(36),timestamp:new Date().toISOString(),module:n,action:"ERROR: "+e,fileName:t,outcome:"error",itemCount:0,user:"system"};localStorage.setItem(kc,JSON.stringify([r,...i].slice(0,Yv)))}catch{}}const TC=ie.lazy(()=>bt(()=>import("./M0PreScan-Ur4MfHuB.js"),__vite__mapDeps([0,1,2]))),bC=ie.lazy(()=>bt(()=>import("./M1PHIScrubber-CqAhyhEu.js"),__vite__mapDeps([3,1]))),AC=ie.lazy(()=>bt(()=>import("./M2TriageRouter-Dnmkz-6w.js"),__vite__mapDeps([4,1]))),RC=ie.lazy(()=>bt(()=>import("./M3AliasEngine-PUsqw_qI.js"),__vite__mapDeps([5,1,6]))),CC=ie.lazy(()=>bt(()=>import("./M4ConfidenceThreshold-By-k0-Ez.js"),__vite__mapDeps([7,1,6,2]))),PC=ie.lazy(()=>bt(()=>import("./M5DefinitionEngine-CftC1Ag6.js"),__vite__mapDeps([8,1]))),IC=ie.lazy(()=>bt(()=>import("./M6DeltaReport-CbC1U3fH.js"),__vite__mapDeps([9,1]))),LC=ie.lazy(()=>bt(()=>import("./M7AuditLog-BhnuXIZ3.js"),__vite__mapDeps([10,1]))),NC=30*60*1e3,Ho="eden_mode_v1";function DC(){var O,Y,Z,te,Pe,Ue;const[n,e]=ie.useState("landing"),[t,i]=ie.useState(null),[r,s]=ie.useState("USER"),[o,a]=ie.useState(1),[l,c]=ie.useState(new Set),[d,f]=ie.useState(null),[u,p]=ie.useState(!1),[g,v]=ie.useState(null),[x,h]=ie.useState(0),m=ie.useRef(null),{state:_,setM0:S,setM1:w,setM2:b,setM3:R,setM4:y,setM5:T}=Xv();ie.useEffect(()=>{const he=sessionStorage.getItem(tc);if(he)try{const j=JSON.parse(he);if(j.username){const re=btoa((navigator.userAgent+window.screen.width+window.screen.height).slice(0,200));if(j.fingerprint&&j.fingerprint!==re){sessionStorage.removeItem(tc);return}i(j.username),s(j.role||"USER"),U();const K=sessionStorage.getItem(Ho);(K==="auto"||K==="manual")&&f(K),e("app")}}catch{}},[]),ie.useEffect(()=>{if(!t)return;function he(){m.current&&clearTimeout(m.current),m.current=setTimeout(()=>{H("session-expired")},NC)}return he(),window.addEventListener("mousemove",he),window.addEventListener("keydown",he),window.addEventListener("click",he),()=>{m.current&&clearTimeout(m.current),window.removeEventListener("mousemove",he),window.removeEventListener("keydown",he),window.removeEventListener("click",he)}},[t]);function U(){try{h(du().length)}catch{h(1)}}const{writeEntry:L}=wC(t||"system");function z(he,j="info"){v({msg:he,type:j}),setTimeout(()=>v(null),3500)}function W(he,j){i(he),s(j),U(),f(null),sessionStorage.removeItem(Ho),e("app")}function H(he){sessionStorage.removeItem(tc),sessionStorage.removeItem(Ho),i(null),s("USER"),a(1),c(new Set),f(null),p(!1),e("landing"),he==="session-expired"&&z("Session expired — please sign in again.","error")}function F(){H()}function P(he){f(he),sessionStorage.setItem(Ho,he)}function N(){const he=d==="auto"?"manual":"auto";f(he),sessionStorage.setItem(Ho,he)}function I(he,j,re){var K,Me,ye,Se,vt,Ge;re(j),c(et=>new Set([...et,he])),a(he+1<=8?he+1:he),L({module:"Step"+he,action:"Step completed — passed to Step "+(he+1),fileName:"pipeline",outcome:"success",itemCount:Array.isArray(j)?j.length:((K=j==null?void 0:j.rows)==null?void 0:K.length)||((Me=j==null?void 0:j.triaged)==null?void 0:Me.length)||((ye=j==null?void 0:j.resolved)==null?void 0:ye.length)||((Se=j==null?void 0:j.results)==null?void 0:Se.length)||((vt=j==null?void 0:j.enriched)==null?void 0:vt.length)||((Ge=j==null?void 0:j.toProcess)==null?void 0:Ge.length)||0})}return n==="landing"?E.jsx(vR,{onEnter:()=>e("login")}):t?d===null?E.jsxs(E.Fragment,{children:[E.jsx(pC,{onSelect:P}),g&&E.jsx(Ul,{msg:g.msg,type:g.type})]}):d==="auto"?E.jsxs(E.Fragment,{children:[E.jsx(L0,{username:t,role:r,mode:d,onModeToggle:N,onLogout:F,onAdminPanel:r==="SUPER_ADMIN"?()=>p(!0):void 0,userCount:r==="SUPER_ADMIN"?x:void 0,pipelineRunning:!0}),E.jsx(F0,{role:r}),E.jsx(EC,{onComplete:()=>z("Pipeline complete! Delta report downloaded.","success")}),u&&r==="SUPER_ADMIN"&&E.jsx(O0,{currentUser:t,onClose:()=>{p(!1),U()}}),g&&E.jsx(Ul,{msg:g.msg,type:g.type})]}):E.jsxs(E.Fragment,{children:[E.jsx(L0,{username:t,role:r,mode:d,onModeToggle:N,onLogout:F,onAdminPanel:r==="SUPER_ADMIN"?()=>p(!0):void 0,userCount:r==="SUPER_ADMIN"?x:void 0}),E.jsx(F0,{role:r}),E.jsx("div",{style:{display:"none"},children:E.jsxs(ie.Suspense,{fallback:null,children:[o===2&&E.jsx(bC,{prefillData:_.m0Result?{toProcess:_.m0Result.toProcess}:null,onComplete:he=>I(2,he,w)}),o===3&&E.jsx(AC,{prefillData:_.m1Result,onComplete:he=>I(3,he,b)}),o===4&&E.jsx(RC,{prefillData:_.m2Result,onComplete:he=>I(4,he,R)}),o===5&&E.jsx(PC,{prefillData:_.m3Result,onComplete:he=>I(5,he,T)}),o===6&&E.jsx(CC,{prefillData:{..._.m5Result||_.m3Result,masterCatalogs:(O=_.m0Result)==null?void 0:O.masterCatalogs},onComplete:he=>I(6,he,y)}),o===7&&E.jsx(IC,{prefillData:{results:(Y=_.m4Result)==null?void 0:Y.results,hospitalName:(Z=_.m4Result)==null?void 0:Z.hospitalName,masterCatalogs:(te=_.m4Result)==null?void 0:te.masterCatalogs,masterDNAs:(Pe=_.m4Result)==null?void 0:Pe.masterDNAs,preMatched:(Ue=_.m0Result)==null?void 0:Ue.preMatched},onComplete:()=>I(7,{},()=>{})}),o===8&&E.jsx(LC,{}),o===1&&E.jsx(TC,{onComplete:he=>I(1,he,S)})]})}),u&&r==="SUPER_ADMIN"&&E.jsx(O0,{currentUser:t,onClose:()=>{p(!1),U()}}),g&&E.jsx(Ul,{msg:g.msg,type:g.type})]}):E.jsxs(E.Fragment,{children:[E.jsx(CR,{onLogin:W}),g&&E.jsx(Ul,{msg:g.msg,type:g.type})]})}function Ul({msg:n,type:e}){const i={error:{bg:"#fff5f5",border:"#dc2626",text:"#dc2626"},success:{bg:"#f0fdf4",border:"#16a34a",text:"#16a34a"},info:{bg:"#f8fafc",border:"#64748b",text:"#334155"}}[e];return E.jsx("div",{style:{position:"fixed",bottom:28,left:"50%",transform:"translateX(-50%)",background:i.bg,border:"1px solid rgba(0,0,0,0.08)",borderLeft:`3px solid ${i.border}`,borderRadius:10,padding:"12px 24px",color:i.text,fontSize:12,fontWeight:700,zIndex:9999,boxShadow:"0 8px 40px rgba(0,0,0,0.12)",whiteSpace:"nowrap",letterSpacing:"0.5px",animation:"toastSlide 0.3s cubic-bezier(0.16,1,0.3,1)",fontFamily:"Inter, -apple-system, sans-serif"},children:n})}Id.createRoot(document.getElementById("root")).render(E.jsx(xy.StrictMode,{children:E.jsx(DC,{})}));export{xy as R,JR as a,tC as b,$R as c,rC as d,di as g,E as j,UC as l,ie as r,GR as s,wC as u};
