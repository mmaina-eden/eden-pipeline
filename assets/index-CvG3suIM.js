const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/M0PreScan-BcBFb3O7.js","assets/xlsx-CKN5doRT.js","assets/masterCatalogs-BbD_0MWE.js","assets/M1PHIScrubber-CHugOnr5.js","assets/M2TriageRouter-CzDMdD-8.js","assets/M3AliasEngine-BUJhfHea.js","assets/cohere-Dswmjygu.js","assets/M4ConfidenceThreshold-CZeRgybl.js","assets/M5DefinitionEngine-Cu_4M4n9.js","assets/M6DeltaReport-DJ8HAQTz.js","assets/M7AuditLog-DHO3A3Wz.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();function ty(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var V0={exports:{}},Bc={},H0={exports:{}},Ze={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(P,O){var X=P.length;P.push(O);e:for(;0<X;){var Z=X-1>>>1,ee=P[Z];if(0<r(ee,O))P[Z]=O,P[X]=ee,X=Z;else break e}}function t(P){return P.length===0?null:P[0]}function i(P){if(P.length===0)return null;var O=P[0],X=P.pop();if(X!==O){P[0]=X;e:for(var Z=0,ee=P.length,Ce=ee>>>1;Z<Ce;){var ze=2*(Z+1)-1,pe=P[ze],j=ze+1,re=P[j];if(0>r(pe,X))j<ee&&0>r(re,pe)?(P[Z]=re,P[j]=X,Z=j):(P[Z]=pe,P[ze]=X,Z=ze);else if(j<ee&&0>r(re,X))P[Z]=re,P[j]=X,Z=j;else break e}}return O}function r(P,O){var X=P.sortIndex-O.sortIndex;return X!==0?X:P.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],d=1,f=null,u=3,p=!1,g=!1,v=!1,x=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(P){for(var O=t(c);O!==null;){if(O.callback===null)i(c);else if(O.startTime<=P)i(c),O.sortIndex=O.expirationTime,e(l,O);else break;O=t(c)}}function S(P){if(v=!1,_(P),!g)if(t(l)!==null)g=!0,C(w);else{var O=t(c);O!==null&&N(S,O.startTime-P)}}function w(P,O){g=!1,v&&(v=!1,h(y),y=-1),p=!0;var X=u;try{for(_(O),f=t(l);f!==null&&(!(f.expirationTime>O)||P&&!L());){var Z=f.callback;if(typeof Z=="function"){f.callback=null,u=f.priorityLevel;var ee=Z(f.expirationTime<=O);O=n.unstable_now(),typeof ee=="function"?f.callback=ee:f===t(l)&&i(l),_(O)}else i(l);f=t(l)}if(f!==null)var Ce=!0;else{var ze=t(c);ze!==null&&N(S,ze.startTime-O),Ce=!1}return Ce}finally{f=null,u=X,p=!1}}var b=!1,R=null,y=-1,T=5,U=-1;function L(){return!(n.unstable_now()-U<T)}function z(){if(R!==null){var P=n.unstable_now();U=P;var O=!0;try{O=R(!0,P)}finally{O?G():(b=!1,R=null)}}else b=!1}var G;if(typeof m=="function")G=function(){m(z)};else if(typeof MessageChannel<"u"){var W=new MessageChannel,F=W.port2;W.port1.onmessage=z,G=function(){F.postMessage(null)}}else G=function(){x(z,0)};function C(P){R=P,b||(b=!0,G())}function N(P,O){y=x(function(){P(n.unstable_now())},O)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(P){P.callback=null},n.unstable_continueExecution=function(){g||p||(g=!0,C(w))},n.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<P?Math.floor(1e3/P):5},n.unstable_getCurrentPriorityLevel=function(){return u},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(P){switch(u){case 1:case 2:case 3:var O=3;break;default:O=u}var X=u;u=O;try{return P()}finally{u=X}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(P,O){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var X=u;u=P;try{return O()}finally{u=X}},n.unstable_scheduleCallback=function(P,O,X){var Z=n.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?Z+X:Z):X=Z,P){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=X+ee,P={id:d++,callback:O,priorityLevel:P,startTime:X,expirationTime:ee,sortIndex:-1},X>Z?(P.sortIndex=X,e(c,P),t(l)===null&&P===t(c)&&(v?(h(y),y=-1):v=!0,N(S,X-Z))):(P.sortIndex=ee,e(l,P),g||p||(g=!0,C(w))),P},n.unstable_shouldYield=L,n.unstable_wrapCallback=function(P){var O=u;return function(){var X=u;u=O;try{return P.apply(this,arguments)}finally{u=X}}}})(ex);Q0.exports=ex;var wy=Q0.exports;/**
 * @license React
...
void main() {
	...
	`}class Iv extends Ei{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Ev(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const V2={[ev]:"Linear",[tv]:"Reinhard",[nv]:"Cineon",[tu]:"ACESFilmic",[rv]:"AgX",[sv]:"Neutral",[iv]:"Custom"};function H2(n,e){const t=V2[e];return t===void 0?(Le("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Nl=new k;function G2(){Qe.getLuminanceCoefficients(Nl);const n=Nl.x.toFixed(4),e=Nl.y.toFixed(4),t=Nl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,EA=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],wA=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],w0=new je,zo=new k,Sd=new k;function TA(n,e,t){let i=new Up;const r=new $e,s=new $e,o=new _t,a=new fE,l=new hE,c={},d=t.maxTextureSize,f={[Ki]:hn,[hn]:Ki,[gi]:gi},u=new Ti({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:SA,fragmentShader:MA}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new Pt;g.setAttribute("position",new Ht(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ct(g,u),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ql;let h=this.type;this.render=function(b,R,y){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||b.length===0)return;this.type===Q_&&(Le("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ql);const T=n.getRenderTarget(),U=n.getActiveCubeFace(),L=n.getActiveMipmapLevel(),z=n.state;z.setBlending(Wi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const G=h!==this.type;G&&R.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(F=>F.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,F=b.length;W<F;W++){const C=b[W],N=C.shadow;if(N===void 0){Le("WebGLShadowMap:",C,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;r.copy(N.mapSize);const P=N.getFrameExtents();r.multiply(P),s.copy(N.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/P.x),r.x=s.x*P.x,N.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/P.y),r.y=s.y*P.y,N.mapSize.y=s.y));const O=n.state.buffers.depth.getReversed();if(N.camera._reversedDepth=O,N.map===null||G===!0){if(N.map!==null&&(N.map.depthTexture!==null&&(N.map.depthTexture.dispose(),N.map.depthTexture=null),N.map.dispose()),this.type===Yo){if(C.isPointLight){Le("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}N.map=new Ei(r.x,r.y,{format:oo,type:Zi,minFilter:Vt,magFilter:Vt,generateMipmaps:!1}),N.map.texture.name=C.name+".shadowMap",N.map.depthTexture=new Da(r.x,r.y,On),N.map.depthTexture.name=C.name+".shadowMapDepth",N.map.depthTexture.format=Ji,N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=zt,N.map.depthTexture.magFilter=zt}else C.isPointLight?(N.map=new Iv(r.x),N.map.depthTexture=new sE(r.x,wi)):(N.map=new Ei(r.x,r.y),N.map.depthTexture=new Da(r.x,r.y,wi)),N.map.depthTexture.name=C.name+".shadowMap",N.map.depthTexture.format=Ji,this.type===ql?(N.map.depthTexture.compareFunction=O?Cp:Rp,N.map.depthTexture.minFilter=Vt,N.map.depthTexture.magFilter=Vt):(N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=zt,N.map.depthTexture.magFilter=zt);N.camera.updateProjectionMatrix()}const X=N.map.isWebGLCubeRenderTarget?6:1;for(let Z=0;Z<X;Z++){if(N.map.isWebGLCubeRenderTarget)n.setRenderTarget(N.map,Z),n.clear();else{Z===0&&(n.setRenderTarget(N.map),n.clear());const ee=N.getViewport(Z);o.set(s.x*ee.x,s.y*ee.y,s.x*ee.z,s.y*ee.w),z.viewport(o)}if(C.isPointLight){const ee=N.camera,Ce=N.matrix,ze=C.distance||ee.far;ze!==ee.far&&(ee.far=ze,ee.updateProjectionMatrix()),zo.setFromMatrixPosition(C.matrixWorld),ee.position.copy(zo),Sd.copy(ee.position),Sd.add(EA[Z]),ee.up.copy(wA[Z]),ee.lookAt(Sd),ee.updateMatrixWorld(),Ce.makeTranslation(-zo.x,-zo.y,-zo.z),w0.multiplyMatrices(ee.projectionMatrix,ee.matrixWorldInverse),N._frustum.setFromProjectionMatrix(w0,ee.coordinateSystem,ee.reversedDepth)}else N.updateMatrices(C);i=N.getFrustum(),S(R,y,N.camera,C,this.type)}N.isPointLightShadow!==!0&&this.type===Yo&&m(N,y),N.needsUpdate=!1}h=this.type,x.needsUpdate=!1,n.setRenderTarget(T,U,L)};function m(b,R){const y=e.update(v);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Ei(r.x,r.y,{format:oo,type:Zi})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(R,null,y,u,v,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(R,null,y,p,v,null)}function _(b,R,y,T){let U=null;const L=y.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(L!==void 0)U=L;else if(U=y.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const z=U.uuid,G=R.uuid;let W=c[z];W===void 0&&(W={},c[z]=W);let F=W[G];F===void 0&&(F=U.clone(),W[G]=F,R.addEventListener("dispose",w)),U=F}if(U.visible=R.visible,U.wireframe=R.wireframe,T===Yo?U.side=R.shadowSide!==null?R.shadowSide:R.side:U.side=R.shadowSide!==null?R.shadowSide:f[R.side],U.alphaMap=R.alphaMap,U.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,U.map=R.map,U.clipShadows=R.clipShadows,U.clippingPlanes=R.clippingPlanes,U.clipIntersection=R.clipIntersection,U.displacementMap=R.displacementMap,U.displacementScale=R.displacementScale,U.displacementBias=R.displacementBias,U.wireframeLinewidth=R.wireframeLinewidth,U.linewidth=R.linewidth,y.isPointLight===!0&&U.isMeshDistanceMaterial===!0){const z=n.properties.get(U);z.light=y}return U}function S(b,R,y,T,U){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&U===Yo)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,b.matrixWorld);const G=e.update(b),W=b.material;if(Array.isArray(W)){const F=G.groups;for(let C=0,N=F.length;C<N;C++){const P=F[C],O=W[P.materialIndex];if(O&&O.visible){const X=_(b,O,T,U);b.onBeforeShadow(n,b,R,y,G,X,P),n.renderBufferDirect(y,null,G,X,b,P),b.onAfterShadow(n,b,R,y,G,X,P)}}}else if(W.visible){const F=_(b,W,T,U);b.onBeforeShadow(n,b,R,y,G,F,null),n.renderBufferDirect(y,null,G,F,b,null),b.onAfterShadow(n,b,R,y,G,F,null)}}const z=b.children;for(let G=0,W=z.length;G<W;G++)S(z[G],R,y,T,U)}function w(b){b.target.removeEventListener("dispose",w);for(const y in c){const T=c[y],U=b.target.uuid;U in T&&(T[U].dispose(),delete T[U])}}}function bA(n,e){function t(){let B=!1;const fe=new _t;let ue=null;const Me=new _t(0,0,0,0);return{setMask:function(le){ue!==le&&!B&&(n.colorMask(le,le,le,le),ue=le)},setLocked:function(le){B=le},setClear:function(le,K,Te,Be,mt){mt===!0&&(le*=Be,K*=Be,Te*=Be),fe.set(le,K,Te,Be),Me.equals(fe)===!1&&(n.clearColor(le,K,Te,Be),Me.copy(fe))},reset:function(){B=!1,ue=null,Me.set(-1,0,0,0)}}}function i(){let B=!1,fe=!1,ue=null,Me=null,le=null;return{setReversed:function(K){if(fe!==K){const Te=e.get("EXT_clip_control");K?Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.ZERO_TO_ONE_EXT):Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.NEGATIVE_ONE_TO_ONE_EXT),fe=K;const Be=le;le=null,this.setClear(Be)}},getReversed:function(){return fe},setTest:function(K){K?re(n.DEPTH_TEST):se(n.DEPTH_TEST)},setMask:function(K){ue!==K&&!B&&(n.depthMask(K),ue=K)},setFunc:function(K){if(fe&&(K=p1[K]),Me!==K){switch(K){case Af:n.depthFunc(n.NEVER);break;case Rf:n.depthFunc(n.ALWAYS);break;case Cf:n.depthFunc(n.LESS);break;case io:n.depthFunc(n.LEQUAL);break;case Pf:n.depthFunc(n.EQUAL);break;case If:n.depthFunc(n.GEQUAL);break;case Lf:n.depthFunc(n.GREATER);break;case Nf:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Me=K}},setLocked:function(K){B=K},setClear:function(K){le!==K&&(le=K,fe&&(K=1-K),n.clearDepth(K))},reset:function(){B=!1,ue=null,Me=null,le=null,fe=!1}}}function r(){let B=!1,fe=null,ue=null,Me=null,le=null,K=null,Te=null,Be=null,mt=null;return{setTest:function(ot){B||(ot?re(n.STENCIL_TEST):se(n.STENCIL_TEST))},setMask:function(ot){fe!==ot&&!B&&(n.stencilMask(ot),fe=ot)},setFunc:function(ot,Ri,Ci){(ue!==ot||Me!==Ri||le!==Ci)&&(n.stencilFunc(ot,Ri,Ci),ue=ot,Me=Ri,le=Ci)},setOp:function(ot,Ri,Ci){(K!==ot||Te!==Ri||Be!==Ci)&&(n.stencilOp(ot,Ri,Ci),K=ot,Te=Ri,Be=Ci)},setLocked:function(ot){B=ot},setClear:function(ot){mt!==ot&&(n.clearStencil(ot),mt=ot)},reset:function(){B=!1,fe=null,ue=null,Me=null,le=null,K=null,Te=null,Be=null,mt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let d={},f={},u=new WeakMap,p=[],g=null,v=!1,x=null,h=null,m=null,_=null,S=null,w=null,b=null,R=new ke(0,0,0),y=0,T=!1,U=null,L=null,z=null,G=null,W=null;const F=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let C=!1,N=0;const P=n.getParameter(n.VERSION);P.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(P)[1]),C=N>=1):P.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(P)[1]),C=N>=2);let O=null,X={};const Z=n.getParameter(n.SCISSOR_BOX),ee=n.getParameter(n.VIEWPORT),Ce=new _t().fromArray(Z),ze=new _t().fromArray(ee);function pe(B,fe,ue,Me){const le=new Uint8Array(4),K=n.createTexture();n.bindTexture(B,K),n.texParameteri(B,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(B,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Te=0;Te<ue;Te++)B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?n.texImage3D(fe,0,n.RGBA,1,1,Me,0,n.RGBA,n.UNSIGNED_BYTE,le):n.texImage2D(fe+Te,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,le);return K}const j={};j[n.TEXTURE_2D]=pe(n.TEXTURE_2D,n.TEXTURE_2D,1),j[n.TEXTURE_CUBE_MAP]=pe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[n.TEXTURE_2D_ARRAY]=pe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),j[n.TEXTURE_3D]=pe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),re(n.DEPTH_TEST),o.setFunc(io),He(!1),Mt(cg),re(n.CULL_FACE),et(Wi);function re(B){d[B]!==!0&&(n.enable(B),d[B]=!0)}function se(B){d[B]!==!1&&(n.disable(B),d[B]=!1)}function Oe(B,fe){return f[B]!==fe?(n.bindFramebuffer(B,fe),f[B]=fe,B===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=fe),B===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=fe),!0):!1}function ne(B,fe){let ue=p,Me=!1;if(B){ue=u.get(fe),ue===void 0&&(ue=[],u.set(fe,ue));const le=B.textures;if(ue.length!==le.length||ue[0]!==n.COLOR_ATTACHMENT0){for(let K=0,Te=le.length;K<Te;K++)ue[K]=n.COLOR_ATTACHMENT0+K;ue.length=le.length,Me=!0}}else ue[0]!==n.BACK&&(ue[0]=n.BACK,Me=!0);Me&&n.drawBuffers(ue)}function _e(B){return g!==B?(n.useProgram(B),g=B,!0):!1}const tt={[Wr]:n.FUNC_ADD,[DM]:n.FUNC_SUBTRACT,[UM]:n.FUNC_REVERSE_SUBTRACT};tt[FM]=n.MIN,tt[OM]=n.MAX;const De={[kM]:n.ZERO,[BM]:n.ONE,[zM]:n.SRC_COLOR,[Tf]:n.SRC_ALPHA,[XM]:n.SRC_ALPHA_SATURATE,[WM]:n.DST_COLOR,[HM]:n.DST_ALPHA,[VM]:n.ONE_MINUS_SRC_COLOR,[bf]:n.ONE_MINUS_SRC_ALPHA,[jM]:n.ONE_MINUS_DST_COLOR,[GM]:n.ONE_MINUS_DST_ALPHA,[YM]:n.CONSTANT_COLOR,[qM]:n.ONE_MINUS_CONSTANT_COLOR,[$M]:n.CONSTANT_ALPHA,[KM]:n.ONE_MINUS_CONSTANT_ALPHA};function et(B,fe,ue,Me,le,K,Te,Be,mt,ot){if(B===Wi){v===!0&&(se(n.BLEND),v=!1);return}if(v===!1&&(re(n.BLEND),v=!0),B!==NM){if(B!==x||ot!==T){if((h!==Wr||S!==Wr)&&(n.blendEquation(n.FUNC_ADD),h=Wr,S=Wr),ot)switch(B){case Xs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ug:n.blendFunc(n.ONE,n.ONE);break;case dg:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case fg:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Fe("WebGLState: Invalid blending: ",B);break}else switch(B){case Xs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ug:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case dg:Fe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fg:Fe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Fe("WebGLState: Invalid blending: ",B);break}m=null,_=null,w=null,b=null,R.set(0,0,0),y=0,x=B,T=ot}return}le=le||fe,K=K||ue,Te=Te||Me,(fe!==h||le!==S)&&(n.blendEquationSeparate(tt[fe],tt[le]),h=fe,S=le),(ue!==m||Me!==_||K!==w||Te!==b)&&(n.blendFuncSeparate(De[ue],De[Me],De[K],De[Te]),m=ue,_=Me,w=K,b=Te),(Be.equals(R)===!1||mt!==y)&&(n.blendColor(Be.r,Be.g,Be.b,mt),R.copy(Be),y=mt),x=B,T=!1}function rt(B,fe){B.side===gi?se(n.CULL_FACE):re(n.CULL_FACE);let ue=B.side===hn;fe&&(ue=!ue),He(ue),B.blending===Xs&&B.transparent===!1?et(Wi):et(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),o.setFunc(B.depthFunc),o.setTest(B.depthTest),o.setMask(B.depthWrite),s.setMask(B.colorWrite);const Me=B.stencilWrite;a.setTest(Me),Me&&(a.setMask(B.stencilWriteMask),a.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),a.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),ht(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?re(n.SAMPLE_ALPHA_TO_COVERAGE):se(n.SAMPLE_ALPHA_TO_COVERAGE)}function He(B){U!==B&&(B?n.frontFace(n.CW):n.frontFace(n.CCW),U=B)}function Mt(B){B!==IM?(re(n.CULL_FACE),B!==L&&(B===cg?n.cullFace(n.BACK):B===LM?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):se(n.CULL_FACE),L=B}function D(B){B!==z&&(C&&n.lineWidth(B),z=B)}function ht(B,fe,ue){B?(re(n.POLYGON_OFFSET_FILL),(G!==fe||W!==ue)&&(G=fe,W=ue,o.getReversed()&&(fe=-fe),n.polygonOffset(fe,ue))):se(n.POLYGON_OFFSET_FILL)}function st(B){B?re(n.SCISSOR_TEST):se(n.SCISSOR_TEST)}function Je(B){B===void 0&&(B=n.TEXTURE0+F-1),O!==B&&(n.activeTexture(B),O=B)}function ve(B,fe,ue){ue===void 0&&(O===null?ue=n.TEXTURE0+F-1:ue=O);let Me=X[ue];Me===void 0&&(Me={type:void 0,texture:void 0},X[ue]=Me),(Me.type!==B||Me.texture!==fe)&&(O!==ue&&(n.activeTexture(ue),O=ue),n.bindTexture(B,fe||j[B]),Me.type=B,Me.texture=fe)}function I(){const B=X[O];B!==void 0&&B.type!==void 0&&(n.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function M(){try{n.compressedTexImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function V(){try{n.compressedTexImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Q(){try{n.texSubImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function te(){try{n.texSubImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function J(){try{n.compressedTexSubImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Ee(){try{n.compressedTexSubImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function de(){try{n.texStorage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Ne(){try{n.texStorage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function Ue(){try{n.texImage2D(...arguments)}catch(B){Fe("WebGLState:",B)}}function ae(){try{n.texImage3D(...arguments)}catch(B){Fe("WebGLState:",B)}}function ce(B){Ce.equals(B)===!1&&(n.scissor(B.x,B.y,B.z,B.w),Ce.copy(B))}function we(B){ze.equals(B)===!1&&(n.viewport(B.x,B.y,B.z,B.w),ze.copy(B))}function be(B,fe){let ue=c.get(fe);ue===void 0&&(ue=new WeakMap,c.set(fe,ue));let Me=ue.get(B);Me===void 0&&(Me=n.getUniformBlockIndex(fe,B.name),ue.set(B,Me))}function xe(B,fe){const Me=c.get(fe).get(B);l.get(fe)!==Me&&(n.uniformBlockBinding(fe,Me,B.__bindingPointIndex),l.set(fe,Me))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},O=null,X={},f={},u=new WeakMap,p=[],g=null,v=!1,x=null,h=null,m=null,_=null,S=null,w=null,b=null,R=new ke(0,0,0),y=0,T=!1,U=null,L=null,z=null,G=null,W=null,Ce.set(0,0,n.canvas.width,n.canvas.height),ze.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:re,disable:se,bindFramebuffer:Oe,drawBuffers:ne,useProgram:_e,setBlending:et,setMaterial:rt,setFlipSided:He,setCullFace:Mt,setLineWidth:D,setPolygonOffset:ht,setScissorTest:st,activeTexture:Je,bindTexture:ve,unbindTexture:I,compressedTexImage2D:M,compressedTexImage3D:V,texImage2D:Ue,texImage3D:ae,updateUBOMapping:be,uniformBlockBinding:xe,texStorage2D:de,texStorage3D:Ne,texSubImage2D:Q,texSubImage3D:te,compressedTexSubImage2D:J,compressedTexSubImage3D:Ee,scissor:ce,viewport:we,reset:Xe}}function AA(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $e,d=new WeakMap;let f;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(I,M){return p?new OffscreenCanvas(I,M):Ia("canvas")}function v(I,M,V){let Q=1;const te=ve(I);if((te.width>V||te.height>V)&&(Q=V/Math.max(te.width,te.height)),Q<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const J=Math.floor(Q*te.width),Ee=Math.floor(Q*te.height);f===void 0&&(f=g(J,Ee));const de=M?g(J,Ee):f;return de.width=J,de.height=Ee,de.getContext("2d").drawImage(I,0,0,J,Ee),Le("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+J+"x"+Ee+")."),de}else return"data"in I&&Le("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),I;return I}function x(I){return I.generateMipmaps}function h(I){n.generateMipmap(I)}function m(I){return I.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?n.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(I,M,V,Q,te=!1){if(I!==null){if(n[I]!==void 0)return n[I];Le("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let J=M;if(M===n.RED&&(V===n.FLOAT&&(J=n.R32F),V===n.HALF_FLOAT&&(J=n.R16F),V===n.UNSIGNED_BYTE&&(J=n.R8)),M===n.RED_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.R8UI),V===n.UNSIGNED_SHORT&&(J=n.R16UI),V===n.UNSIGNED_INT&&(J=n.R32UI),V===n.BYTE&&(J=n.R8I),V===n.SHORT&&(J=n.R16I),V===n.INT&&(J=n.R32I)),M===n.RG&&(V===n.FLOAT&&(J=n.RG32F),V===n.HALF_FLOAT&&(J=n.RG16F),V===n.UNSIGNED_BYTE&&(J=n.RG8)),M===n.RG_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.RG8UI),V===n.UNSIGNED_SHORT&&(J=n.RG16UI),V===n.UNSIGNED_INT&&(J=n.RG32UI),V===n.BYTE&&(J=n.RG8I),V===n.SHORT&&(J=n.RG16I),V===n.INT&&(J=n.RG32I)),M===n.RGB_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.RGB8UI),V===n.UNSIGNED_SHORT&&(J=n.RGB16UI),V===n.UNSIGNED_INT&&(J=n.RGB32UI),V===n.BYTE&&(J=n.RGB8I),V===n.SHORT&&(J=n.RGB16I),V===n.INT&&(J=n.RGB32I)),M===n.RGBA_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.RGBA8UI),V===n.UNSIGNED_SHORT&&(J=n.RGBA16UI),V===n.UNSIGNED_INT&&(J=n.RGBA32UI),V===n.BYTE&&(J=n.RGBA8I),V===n.SHORT&&(J=n.RGBA16I),V===n.INT&&(J=n.RGBA32I)),M===n.RGB&&(V===n.UNSIGNED_INT_5_9_9_9_REV&&(J=n.RGB9_E5),V===n.UNSIGNED_INT_10F_11F_11F_REV&&(J=n.R11F_G11F_B10F)),M===n.RGBA){const Ee=te?Rc:Qe.getTransfer(Q);V===n.FLOAT&&(J=n.RGBA32F),V===n.HALF_FLOAT&&(J=n.RGBA16F),V===n.UNSIGNED_BYTE&&(J=Ee===at?n.SRGB8_ALPHA8:n.RGBA8),V===n.UNSIGNED_SHORT_4_4_4_4&&(J=n.RGBA4),V===n.UNSIGNED_SHORT_5_5_5_1&&(J=n.RGB5_A1)}return(J===n.R16F||J===n.R32F||J===n.RG16F||J===n.RG32F||J===n.RGBA16F||J===n.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function S(I,M){let V;return I?M===null||M===wi||M===Aa?V=n.DEPTH24_STENCIL8:M===On?V=n.DEPTH32F_STENCIL8:M===ba&&(V=n.DEPTH24_STENCIL8,Le("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===wi||M===Aa?V=n.DEPTH_COMPONENT24:M===On?V=n.DEPTH_COMPONENT32F:M===ba&&(V=n.DEPTH_COMPONENT16),V}function w(I,M){return x(I)===!0||I.isFramebufferTexture&&I.minFilter!==zt&&I.minFilter!==Vt?Math.log2(Math.max(M.width,M.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?M.mipmaps.length:1}function b(I){const M=I.target;M.removeEventListener("dispose",b),y(M),M.isVideoTexture&&d.delete(M)}function R(I){const M=I.target;M.removeEventListener("dispose",R),U(M)}function y(I){const M=i.get(I);if(M.__webglInit===void 0)return;const V=I.source,Q=u.get(V);if(Q){const te=Q[M.__cacheKey];te.usedTimes--,te.usedTimes===0&&T(I),Object.keys(Q).length===0&&u.delete(V)}i.remove(I)}function T(I){const M=i.get(I);n.deleteTexture(M.__webglTexture);const V=I.source,Q=u.get(V);delete Q[M.__cacheKey],o.memory.textures--}function U(I){const M=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(M.__webglFramebuffer[Q]))for(let te=0;te<M.__webglFramebuffer[Q].length;te++)n.deleteFramebuffer(M.__webglFramebuffer[Q][te]);else n.deleteFramebuffer(M.__webglFramebuffer[Q]);M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer[Q])}else{if(Array.isArray(M.__webglFramebuffer))for(let Q=0;Q<M.__webglFramebuffer.length;Q++)n.deleteFramebuffer(M.__webglFramebuffer[Q]);else n.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&n.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Q=0;Q<M.__webglColorRenderbuffer.length;Q++)M.__webglColorRenderbuffer[Q]&&n.deleteRenderbuffer(M.__webglColorRenderbuffer[Q]);M.__webglDepthRenderbuffer&&n.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const V=I.textures;for(let Q=0,te=V.length;Q<te;Q++){const J=i.get(V[Q]);J.__webglTexture&&(n.deleteTexture(J.__webglTexture),o.memory.textures--),i.remove(V[Q])}i.remove(I)}let L=0;function z(){L=0}function G(){const I=L;return I>=r.maxTextures&&Le("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),L+=1,I}function W(I){const M=[];return M.push(I.wrapS),M.push(I.wrapT),M.push(I.wrapR||0),M.push(I.magFilter),M.push(I.minFilter),M.push(I.anisotropy),M.push(I.internalFormat),M.push(I.format),M.push(I.type),M.push(I.generateMipmaps),M.push(I.premultiplyAlpha),M.push(I.flipY),M.push(I.unpackAlignment),M.push(I.colorSpace),M.join()}function F(I,M){const V=i.get(I);if(I.isVideoTexture&&st(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&V.__version!==I.version){const Q=I.image;if(Q===null)Le("WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)Le("WebGLRenderer: Texture marked for update but image is incomplete");else{j(V,I,M);return}}else I.isExternalTexture&&(V.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,V.__webglTexture,n.TEXTURE0+M)}function C(I,M){const V=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&V.__version!==I.version){j(V,I,M);return}else I.isExternalTexture&&(V.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,V.__webglTexture,n.TEXTURE0+M)}function N(I,M){const V=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&V.__version!==I.version){j(V,I,M);return}t.bindTexture(n.TEXTURE_3D,V.__webglTexture,n.TEXTURE0+M)}function P(I,M){const V=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&V.__version!==I.version){re(V,I,M);return}t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture,n.TEXTURE0+M)}const O={[so]:n.REPEAT,[xi]:n.CLAMP_TO_EDGE,[Ac]:n.MIRRORED_REPEAT},X={[zt]:n.NEAREST,[av]:n.NEAREST_MIPMAP_NEAREST,[qo]:n.NEAREST_MIPMAP_LINEAR,[Vt]:n.LINEAR,[$l]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},Z={[r1]:n.NEVER,[c1]:n.ALWAYS,[s1]:n.LESS,[Rp]:n.LEQUAL,[o1]:n.EQUAL,[Cp]:n.GEQUAL,[a1]:n.GREATER,[l1]:n.NOTEQUAL};function ee(I,M){if(M.type===On&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Vt||M.magFilter===$l||M.magFilter===qo||M.magFilter===zi||M.minFilter===Vt||M.minFilter===$l||M.minFilter===qo||M.minFilter===zi)&&Le("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(I,n.TEXTURE_WRAP_S,O[M.wrapS]),n.texParameteri(I,n.TEXTURE_WRAP_T,O[M.wrapT]),(I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY)&&n.texParameteri(I,n.TEXTURE_WRAP_R,O[M.wrapR]),n.texParameteri(I,n.TEXTURE_MAG_FILTER,X[M.magFilter]),n.texParameteri(I,n.TEXTURE_MIN_FILTER,X[M.minFilter]),M.compareFunction&&(n.texParameteri(I,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(I,n.TEXTURE_COMPARE_FUNC,Z[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===zt||M.minFilter!==qo&&M.minFilter!==zi||M.type===On&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const V=e.get("EXT_texture_filter_anisotropic");n.texParameterf(I,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function Ce(I,M){let V=!1;I.__webglInit===void 0&&(I.__webglInit=!0,M.addEventListener("dispose",b));const Q=M.source;let te=u.get(Q);te===void 0&&(te={},u.set(Q,te));const J=W(M);if(J!==I.__cacheKey){te[J]===void 0&&(te[J]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,V=!0),te[J].usedTimes++;const Ee=te[I.__cacheKey];Ee!==void 0&&(te[I.__cacheKey].usedTimes--,Ee.usedTimes===0&&T(M)),I.__cacheKey=J,I.__webglTexture=te[J].texture}return V}function ze(I,M,V){return Math.floor(Math.floor(I/V)/M)}function pe(I,M,V,Q){const J=I.updateRanges;if(J.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,M.width,M.height,V,Q,M.data);else{J.sort((ae,ce)=>ae.start-ce.start);let Ee=0;for(let ae=1;ae<J.length;ae++){const ce=J[Ee],we=J[ae],be=ce.start+ce.count,xe=ze(we.start,M.width,4),Xe=ze(ce.start,M.width,4);we.start<=be+1&&xe===Xe&&ze(we.start+we.count-1,M.width,4)===xe?ce.count=Math.max(ce.count,we.start+we.count-ce.start):(++Ee,J[Ee]=we)}J.length=Ee+1;const de=n.getParameter(n.UNPACK_ROW_LENGTH),Ne=n.getParameter(n.UNPACK_SKIP_PIXELS),Ue=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,M.width);for(let ae=0,ce=J.length;ae<ce;ae++){const we=J[ae],be=Math.floor(we.start/4),xe=Math.ceil(we.count/4),Xe=be%M.width,B=Math.floor(be/M.width),fe=xe,ue=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(n.UNPACK_SKIP_ROWS,B),t.texSubImage2D(n.TEXTURE_2D,0,Xe,B,fe,ue,V,Q,M.data)}I.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,de),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ne),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ue)}}function j(I,M,V){let Q=n.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Q=n.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Q=n.TEXTURE_3D);const te=Ce(I,M),J=M.source;t.bindTexture(Q,I.__webglTexture,n.TEXTURE0+V);const Ee=i.get(J);if(J.version!==Ee.__version||te===!0){t.activeTexture(n.TEXTURE0+V);const de=Qe.getPrimaries(Qe.workingColorSpace),Ne=M.colorSpace===mr?null:Qe.getPrimaries(M.colorSpace),Ue=M.colorSpace===mr||de===Ne?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ue);let ae=v(M.image,!1,r.maxTextureSize);ae=Je(M,ae);const ce=s.convert(M.format,M.colorSpace),we=s.convert(M.type);let be=_(M.internalFormat,ce,we,M.colorSpace,M.isVideoTexture);ee(Q,M);let xe;const Xe=M.mipmaps,B=M.isVideoTexture!==!0,fe=Ee.__version===void 0||te===!0,ue=J.dataReady,Me=w(M,ae);if(M.isDepthTexture)be=S(M.format===Kr,M.type),fe&&(B?t.texStorage2D(n.TEXTURE_2D,1,be,ae.width,ae.height):t.texImage2D(n.TEXTURE_2D,0,be,ae.width,ae.height,0,ce,we,null));else if(M.isDataTexture)if(Xe.length>0){B&&fe&&t.texStorage2D(n.TEXTURE_2D,Me,be,Xe[0].width,Xe[0].height);for(let le=0,K=Xe.length;le<K;le++)xe=Xe[le],B?ue&&t.texSubImage2D(n.TEXTURE_2D,le,0,0,xe.width,xe.height,ce,we,xe.data):t.texImage2D(n.TEXTURE_2D,le,be,xe.width,xe.height,0,ce,we,xe.data);M.generateMipmaps=!1}else B?(fe&&t.texStorage2D(n.TEXTURE_2D,Me,be,ae.width,ae.height),ue&&pe(M,ae,ce,we)):t.texImage2D(n.TEXTURE_2D,0,be,ae.width,ae.height,0,ce,we,ae.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){B&&fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Me,be,Xe[0].width,Xe[0].height,ae.depth);for(let le=0,K=Xe.length;le<K;le++)if(xe=Xe[le],M.format!==kn)if(ce!==null)if(B){if(ue)if(M.layerUpdates.size>0){const Te=n0(xe.width,xe.height,M.format,M.type);for(const Be of M.layerUpdates){const mt=xe.data.subarray(Be*Te/xe.data.BYTES_PER_ELEMENT,(Be+1)*Te/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,le,0,0,Be,xe.width,xe.height,1,ce,mt)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,le,0,0,0,xe.width,xe.height,ae.depth,ce,xe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,le,be,xe.width,xe.height,ae.depth,0,xe.data,0,0);else Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else B?ue&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,le,0,0,0,xe.width,xe.height,ae.depth,ce,we,xe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,le,be,xe.width,xe.height,ae.depth,0,ce,we,xe.data)}else{B&&fe&&t.texStorage2D(n.TEXTURE_2D,Me,be,Xe[0].width,Xe[0].height);for(let le=0,K=Xe.length;le<K;le++)xe=Xe[le],M.format!==kn?ce!==null?B?ue&&t.compressedTexSubImage2D(n.TEXTURE_2D,le,0,0,xe.width,xe.height,ce,xe.data):t.compressedTexImage2D(n.TEXTURE_2D,le,be,xe.width,xe.height,0,xe.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):B?ue&&t.texSubImage2D(n.TEXTURE_2D,le,0,0,xe.width,xe.height,ce,we,xe.data):t.texImage2D(n.TEXTURE_2D,le,be,xe.width,xe.height,0,ce,we,xe.data)}else if(M.isDataArrayTexture)if(B){if(fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Me,be,ae.width,ae.height,ae.depth),ue)if(M.layerUpdates.size>0){const le=n0(ae.width,ae.height,M.format,M.type);for(const K of M.layerUpdates){const Te=ae.data.subarray(K*le/ae.data.BYTES_PER_ELEMENT,(K+1)*le/ae.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,K,ae.width,ae.height,1,ce,we,Te)}M.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ae.width,ae.height,ae.depth,ce,we,ae.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,be,ae.width,ae.height,ae.depth,0,ce,we,ae.data);else if(M.isData3DTexture)B?(fe&&t.texStorage3D(n.TEXTURE_3D,Me,be,ae.width,ae.height,ae.depth),ue&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ae.width,ae.height,ae.depth,ce,we,ae.data)):t.texImage3D(n.TEXTURE_3D,0,be,ae.width,ae.height,ae.depth,0,ce,we,ae.data);else if(M.isFramebufferTexture){if(fe)if(B)t.texStorage2D(n.TEXTURE_2D,Me,be,ae.width,ae.height);else{let le=ae.width,K=ae.height;for(let Te=0;Te<Me;Te++)t.texImage2D(n.TEXTURE_2D,Te,be,le,K,0,ce,we,null),le>>=1,K>>=1}}else if(Xe.length>0){if(B&&fe){const le=ve(Xe[0]);t.texStorage2D(n.TEXTURE_2D,Me,be,le.width,le.height)}for(let le=0,K=Xe.length;le<K;le++)xe=Xe[le],B?ue&&t.texSubImage2D(n.TEXTURE_2D,le,0,0,ce,we,xe):t.texImage2D(n.TEXTURE_2D,le,be,ce,we,xe);M.generateMipmaps=!1}else if(B){if(fe){const le=ve(ae);t.texStorage2D(n.TEXTURE_2D,Me,be,le.width,le.height)}ue&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ce,we,ae)}else t.texImage2D(n.TEXTURE_2D,0,be,ce,we,ae);x(M)&&h(Q),Ee.__version=J.version,M.onUpdate&&M.onUpdate(M)}I.__version=M.version}function re(I,M,V){if(M.image.length!==6)return;const Q=Ce(I,M),te=M.source;t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+V);const J=i.get(te);if(te.version!==J.__version||Q===!0){t.activeTexture(n.TEXTURE0+V);const Ee=Qe.getPrimaries(Qe.workingColorSpace),de=M.colorSpace===mr?null:Qe.getPrimaries(M.colorSpace),Ne=M.colorSpace===mr||Ee===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);const Ue=M.isCompressedTexture||M.image[0].isCompressedTexture,ae=M.image[0]&&M.image[0].isDataTexture,ce=[];for(let K=0;K<6;K++)!Ue&&!ae?ce[K]=v(M.image[K],!0,r.maxCubemapSize):ce[K]=ae?M.image[K].image:M.image[K],ce[K]=Je(M,ce[K]);const we=ce[0],be=s.convert(M.format,M.colorSpace),xe=s.convert(M.type),Xe=_(M.internalFormat,be,xe,M.colorSpace),B=M.isVideoTexture!==!0,fe=J.__version===void 0||Q===!0,ue=te.dataReady;let Me=w(M,we);ee(n.TEXTURE_CUBE_MAP,M);let le;if(Ue){B&&fe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Me,Xe,we.width,we.height);for(let K=0;K<6;K++){le=ce[K].mipmaps;for(let Te=0;Te<le.length;Te++){const Be=le[Te];M.format!==kn?be!==null?B?ue&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te,0,0,Be.width,Be.height,be,Be.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te,Xe,Be.width,Be.height,0,Be.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):B?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te,0,0,Be.width,Be.height,be,xe,Be.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te,Xe,Be.width,Be.height,0,be,xe,Be.data)}}}else{if(le=M.mipmaps,B&&fe){le.length>0&&Me++;const K=ve(ce[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Me,Xe,K.width,K.height)}for(let K=0;K<6;K++)if(ae){B?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ce[K].width,ce[K].height,be,xe,ce[K].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Xe,ce[K].width,ce[K].height,0,be,xe,ce[K].data);for(let Te=0;Te<le.length;Te++){const mt=le[Te].image[K].image;B?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te+1,0,0,mt.width,mt.height,be,xe,mt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te+1,Xe,mt.width,mt.height,0,be,xe,mt.data)}}else{B?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,be,xe,ce[K]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Xe,be,xe,ce[K]);for(let Te=0;Te<le.length;Te++){const Be=le[Te];B?ue&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te+1,0,0,be,xe,Be.image[K]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Te+1,Xe,be,xe,Be.image[K])}}}x(M)&&h(n.TEXTURE_CUBE_MAP),J.__version=te.version,M.onUpdate&&M.onUpdate(M)}I.__version=M.version}function se(I,M,V,Q,te,J){const Ee=s.convert(V.format,V.colorSpace),de=s.convert(V.type),Ne=_(V.internalFormat,Ee,de,V.colorSpace),Ue=i.get(M),ae=i.get(V);if(ae.__renderTarget=M,!Ue.__hasExternalTextures){const ce=Math.max(1,M.width>>J),we=Math.max(1,M.height>>J);te===n.TEXTURE_3D||te===n.TEXTURE_2D_ARRAY?t.texImage3D(te,J,Ne,ce,we,M.depth,0,Ee,de,null):t.texImage2D(te,J,Ne,ce,we,0,Ee,de,null)}t.bindFramebuffer(n.FRAMEBUFFER,I),ht(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,te,ae.__webglTexture,0,D(M)):(te===n.TEXTURE_2D||te>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Q,te,ae.__webglTexture,J),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Oe(I,M,V){if(n.bindRenderbuffer(n.RENDERBUFFER,I),M.depthBuffer){const Q=M.depthTexture,te=Q&&Q.isDepthTexture?Q.type:null,J=S(M.stencilBuffer,te),Ee=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ht(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(M),J,M.width,M.height):V?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(M),J,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,J,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Ee,n.RENDERBUFFER,I)}else{const Q=M.textures;for(let te=0;te<Q.length;te++){const J=Q[te],Ee=s.convert(J.format,J.colorSpace),de=s.convert(J.type),Ne=_(J.internalFormat,Ee,de,J.colorSpace);ht(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(M),Ne,M.width,M.height):V?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(M),Ne,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,Ne,M.width,M.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ne(I,M,V){const Q=M.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,I),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const te=i.get(M.depthTexture);if(te.__renderTarget=M,(!te.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Q){if(te.__webglInit===void 0&&(te.__webglInit=!0,M.depthTexture.addEventListener("dispose",b)),te.__webglTexture===void 0){te.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,te.__webglTexture),ee(n.TEXTURE_CUBE_MAP,M.depthTexture);const Ue=s.convert(M.depthTexture.format),ae=s.convert(M.depthTexture.type);let ce;M.depthTexture.format===Ji?ce=n.DEPTH_COMPONENT24:M.depthTexture.format===Kr&&(ce=n.DEPTH24_STENCIL8);for(let we=0;we<6;we++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,ce,M.width,M.height,0,Ue,ae,null)}}else F(M.depthTexture,0);const J=te.__webglTexture,Ee=D(M),de=Q?n.TEXTURE_CUBE_MAP_POSITIVE_X+V:n.TEXTURE_2D,Ne=M.depthTexture.format===Kr?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(M.depthTexture.format===Ji)ht(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Ne,de,J,0,Ee):n.framebufferTexture2D(n.FRAMEBUFFER,Ne,de,J,0);else if(M.depthTexture.format===Kr)ht(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Ne,de,J,0,Ee):n.framebufferTexture2D(n.FRAMEBUFFER,Ne,de,J,0);else throw new Error("Unknown depthTexture format")}function _e(I){const M=i.get(I),V=I.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==I.depthTexture){const Q=I.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Q){const te=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Q.removeEventListener("dispose",te)};Q.addEventListener("dispose",te),M.__depthDisposeCallback=te}M.__boundDepthTexture=Q}if(I.depthTexture&&!M.__autoAllocateDepthBuffer)if(V)for(let Q=0;Q<6;Q++)ne(M.__webglFramebuffer[Q],I,Q);else{const Q=I.texture.mipmaps;Q&&Q.length>0?ne(M.__webglFramebuffer[0],I,0):ne(M.__webglFramebuffer,I,0)}else if(V){M.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[Q]),M.__webglDepthbuffer[Q]===void 0)M.__webglDepthbuffer[Q]=n.createRenderbuffer(),Oe(M.__webglDepthbuffer[Q],I,!1);else{const te=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,J=M.__webglDepthbuffer[Q];n.bindRenderbuffer(n.RENDERBUFFER,J),n.framebufferRenderbuffer(n.FRAMEBUFFER,te,n.RENDERBUFFER,J)}}else{const Q=I.texture.mipmaps;if(Q&&Q.length>0?t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=n.createRenderbuffer(),Oe(M.__webglDepthbuffer,I,!1);else{const te=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,J=M.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,J),n.framebufferRenderbuffer(n.FRAMEBUFFER,te,n.RENDERBUFFER,J)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function tt(I,M,V){const Q=i.get(I);M!==void 0&&se(Q.__webglFramebuffer,I,I.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),V!==void 0&&_e(I)}function De(I){const M=I.texture,V=i.get(I),Q=i.get(M);I.addEventListener("dispose",R);const te=I.textures,J=I.isWebGLCubeRenderTarget===!0,Ee=te.length>1;if(Ee||(Q.__webglTexture===void 0&&(Q.__webglTexture=n.createTexture()),Q.__version=M.version,o.memory.textures++),J){V.__webglFramebuffer=[];for(let de=0;de<6;de++)if(M.mipmaps&&M.mipmaps.length>0){V.__webglFramebuffer[de]=[];for(let Ne=0;Ne<M.mipmaps.length;Ne++)V.__webglFramebuffer[de][Ne]=n.createFramebuffer()}else V.__webglFramebuffer[de]=n.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){V.__webglFramebuffer=[];for(let de=0;de<M.mipmaps.length;de++)V.__webglFramebuffer[de]=n.createFramebuffer()}else V.__webglFramebuffer=n.createFramebuffer();if(Ee)for(let de=0,Ne=te.length;de<Ne;de++){const Ue=i.get(te[de]);Ue.__webglTexture===void 0&&(Ue.__webglTexture=n.createTexture(),o.memory.textures++)}if(I.samples>0&&ht(I)===!1){V.__webglMultisampledFramebuffer=n.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let de=0;de<te.length;de++){const Ne=te[de];V.__webglColorRenderbuffer[de]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,V.__webglColorRenderbuffer[de]);const Ue=s.convert(Ne.format,Ne.colorSpace),ae=s.convert(Ne.type),ce=_(Ne.internalFormat,Ue,ae,Ne.colorSpace,I.isXRRenderTarget===!0),we=D(I);n.renderbufferStorageMultisample(n.RENDERBUFFER,we,ce,I.width,I.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,V.__webglColorRenderbuffer[de])}n.bindRenderbuffer(n.RENDERBUFFER,null),I.depthBuffer&&(V.__webglDepthRenderbuffer=n.createRenderbuffer(),Oe(V.__webglDepthRenderbuffer,I,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(J){t.bindTexture(n.TEXTURE_CUBE_MAP,Q.__webglTexture),ee(n.TEXTURE_CUBE_MAP,M);for(let de=0;de<6;de++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ne=0;Ne<M.mipmaps.length;Ne++)se(V.__webglFramebuffer[de][Ne],I,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ne);else se(V.__webglFramebuffer[de],I,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);x(M)&&h(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ee){for(let de=0,Ne=te.length;de<Ne;de++){const Ue=te[de],ae=i.get(Ue);let ce=n.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(ce=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ce,ae.__webglTexture),ee(ce,Ue),se(V.__webglFramebuffer,I,Ue,n.COLOR_ATTACHMENT0+de,ce,0),x(Ue)&&h(ce)}t.unbindTexture()}else{let de=n.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(de=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(de,Q.__webglTexture),ee(de,M),M.mipmaps&&M.mipmaps.length>0)for(let Ne=0;Ne<M.mipmaps.length;Ne++)se(V.__webglFramebuffer[Ne],I,M,n.COLOR_ATTACHMENT0,de,Ne);else se(V.__webglFramebuffer,I,M,n.COLOR_ATTACHMENT0,de,0);x(M)&&h(de),t.unbindTexture()}I.depthBuffer&&_e(I)}function et(I){const M=I.textures;for(let V=0,Q=M.length;V<Q;V++){const te=M[V];if(x(te)){const J=m(I),Ee=i.get(te).__webglTexture;t.bindTexture(J,Ee),h(J),t.unbindTexture()}}}const rt=[],He=[];function Mt(I){if(I.samples>0){if(ht(I)===!1){const M=I.textures,V=I.width,Q=I.height;let te=n.COLOR_BUFFER_BIT;const J=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Ee=i.get(I),de=M.length>1;if(de)for(let Ue=0;Ue<M.length;Ue++)t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer);const Ne=I.texture.mipmaps;Ne&&Ne.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer);for(let Ue=0;Ue<M.length;Ue++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(te|=n.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(te|=n.STENCIL_BUFFER_BIT)),de){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Ee.__webglColorRenderbuffer[Ue]);const ae=i.get(M[Ue]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ae,0)}n.blitFramebuffer(0,0,V,Q,0,0,V,Q,te,n.NEAREST),l===!0&&(rt.length=0,He.length=0,rt.push(n.COLOR_ATTACHMENT0+Ue),I.depthBuffer&&I.resolveDepthBuffer===!1&&(rt.push(J),He.push(J),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,He)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,rt))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),de)for(let Ue=0;Ue<M.length;Ue++){t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.RENDERBUFFER,Ee.__webglColorRenderbuffer[Ue]);const ae=i.get(M[Ue]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Ee.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ue,n.TEXTURE_2D,ae,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&l){const M=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[M])}}}function D(I){return Math.min(r.maxSamples,I.samples)}function ht(I){const M=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function st(I){const M=o.render.frame;d.get(I)!==M&&(d.set(I,M),I.update())}function Je(I,M){const V=I.colorSpace,Q=I.format,te=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||V!==pn&&V!==mr&&(Qe.getTransfer(V)===at?(Q!==kn||te!==bn)&&Le("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Fe("WebGLTextures: Unsupported texture color space:",V)),M}function ve(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(c.width=I.naturalWidth||I.width,c.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(c.width=I.displayWidth,c.height=I.displayHeight):(c.width=I.width,c.height=I.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=z,this.setTexture2D=F,this.setTexture2DArray=C,this.setTexture3D=N,this.setTextureCube=P,this.rebindTextures=tt,this.setupRenderTarget=De,this.updateRenderTargetMipmap=et,this.updateMultisampleRenderTarget=Mt,this.setupDepthRenderbuffer=_e,this.setupFrameBufferTexture=se,this.useMultisampledRTT=ht,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function RA(n,e){function t(i,r=mr){let s;const o=Qe.getTransfer(r);if(i===bn)return n.UNSIGNED_BYTE;if(i===Sp)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Mp)return n.UNSIGNED_SHORT_5_5_5_1;if(i===uv)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dv)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===lv)return n.BYTE;if(i===cv)return n.SHORT;if(i===ba)return n.UNSIGNED_SHORT;if(i===yp)return n.INT;if(i===wi)return n.UNSIGNED_INT;if(i===On)return n.FLOAT;if(i===Zi)return n.HALF_FLOAT;if(i===fv)return n.ALPHA;if(i===hv)return n.RGB;if(i===kn)return n.RGBA;if(i===Ji)return n.DEPTH_COMPONENT;if(i===Kr)return n.DEPTH_STENCIL;if(i===Ep)return n.RED;if(i===wp)return n.RED_INTEGER;if(i===oo)return n.RG;if(i===Tp)return n.RG_INTEGER;if(i===bp)return n.RGBA_INTEGER;if(i===Kl||i===Zl||i===Jl||i===Ql)if(o===at)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Kl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Zl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Jl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ql)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Kl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Zl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Jl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ql)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Df||i===Uf||i===Ff||i===Of)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Df)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ff)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Of)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===kf||i===Bf||i===zf||i===Vf||i===Hf||i===Gf||i===Wf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===kf||i===Bf)return o===at?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===zf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Vf)return s.COMPRESSED_R11_EAC;if(i===Hf)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Gf)return s.COMPRESSED_RG11_EAC;if(i===Wf)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===jf||i===Xf||i===Yf||i===qf||i===$f||i===Kf||i===Zf||i===Jf||i===Qf||i===eh||i===th||i===nh||i===ih||i===rh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===jf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Xf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Yf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===qf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===$f)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Kf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Jf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Qf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===eh)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===th)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===nh)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ih)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===rh)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===sh||i===oh||i===ah)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===sh)return o===at?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===oh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ah)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===lh||i===ch||i===uh||i===dh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===lh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ch)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===uh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===dh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Aa?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const CA=`
void main() {
...
void main() {
...
}`;class IA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new wv(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Ti({vertexShader:CA,fragmentShader:PA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ct(new ou(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class LA extends xo{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,d=null,f=null,u=null,p=null,g=null;const v=typeof XRWebGLBinding<"u",x=new IA,h={},m=t.getContextAttributes();let _=null,S=null;const w=[],b=[],R=new $e;let y=null;const T=new Jt;T.viewport=new _t;const U=new Jt;U.viewport=new _t;const L=[T,U],z=new UE;let G=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let re=w[j];return re===void 0&&(re=new qu,w[j]=re),re.getTargetRaySpace()},this.getControllerGrip=function(j){let re=w[j];return re===void 0&&(re=new qu,w[j]=re),re.getGripSpace()},this.getHand=function(j){let re=w[j];return re===void 0&&(re=new qu,w[j]=re),re.getHandSpace()};function F(j){const re=b.indexOf(j.inputSource);if(re===-1)return;const se=w[re];se!==void 0&&(se.update(j.inputSource,j.frame,c||o),se.dispatchEvent({type:j.type,data:j.inputSource}))}function C(){r.removeEventListener("select",F),r.removeEventListener("selectstart",F),r.removeEventListener("selectend",F),r.removeEventListener("squeeze",F),r.removeEventListener("squeezestart",F),r.removeEventListener("squeezeend",F),r.removeEventListener("end",C),r.removeEventListener("inputsourceschange",N);for(let j=0;j<w.length;j++){const re=b[j];re!==null&&(b[j]=null,w[j].disconnect(re))}G=null,W=null,x.reset();for(const j in h)delete h[j];e.setRenderTarget(_),p=null,u=null,f=null,r=null,S=null,pe.stop(),i.isPresenting=!1,e.setPixelRatio(y),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,i.isPresenting===!0&&Le("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){a=j,i.isPresenting===!0&&Le("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(j){c=j},this.getBaseLayer=function(){return u!==null?u:p},this.getBinding=function(){return f===null&&v&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(_=e.getRenderTarget(),r.addEventListener("select",F),r.addEventListener("selectstart",F),r.addEventListener("selectend",F),r.addEventListener("squeeze",F),r.addEventListener("squeezestart",F),r.addEventListener("squeezeend",F),r.addEventListener("end",C),r.addEventListener("inputsourceschange",N),m.xrCompatible!==!0&&await t.makeXRCompatible(),y=e.getPixelRatio(),e.getSize(R),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let se=null,Oe=null,ne=null;m.depth&&(ne=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,se=m.stencil?Kr:Ji,Oe=m.stencil?Aa:wi);const _e={colorFormat:t.RGBA8,depthFormat:ne,scaleFactor:s};f=this.getBinding(),u=f.createProjectionLayer(_e),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),S=new Ei(u.textureWidth,u.textureHeight,{format:kn,type:bn,depthTexture:new Da(u.textureWidth,u.textureHeight,Oe,void 0,void 0,void 0,void 0,void 0,void 0,se),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const se={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,se),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Ei(p.framebufferWidth,p.framebufferHeight,{format:kn,type:bn,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),pe.setContext(r),pe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function N(j){for(let re=0;re<j.removed.length;re++){const se=j.removed[re],Oe=b.indexOf(se);Oe>=0&&(b[Oe]=null,w[Oe].disconnect(se))}for(let re=0;re<j.added.length;re++){const se=j.added[re];let Oe=b.indexOf(se);if(Oe===-1){for(let _e=0;_e<w.length;_e++)if(_e>=b.length){b.push(se),Oe=_e;break}else if(b[_e]===null){b[_e]=se,Oe=_e;break}if(Oe===-1)break}const ne=w[Oe];ne&&ne.connect(se)}}const P=new k,O=new k;function X(j,re,se){P.setFromMatrixPosition(re.matrixWorld),O.setFromMatrixPosition(se.matrixWorld);const Oe=P.distanceTo(O),ne=re.projectionMatrix.elements,_e=se.projectionMatrix.elements,tt=ne[14]/(ne[10]-1),De=ne[14]/(ne[10]+1),et=(ne[9]+1)/ne[5],rt=(ne[9]-1)/ne[5],He=(ne[8]-1)/ne[0],Mt=(_e[8]+1)/_e[0],D=tt*He,ht=tt*Mt,st=Oe/(-He+Mt),Je=st*-He;if(re.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(Je),j.translateZ(st),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert(),ne[10]===-1)j.projectionMatrix.copy(re.projectionMatrix),j.projectionMatrixInverse.copy(re.projectionMatrixInverse);else{const ve=tt+st,I=De+st,M=D-Je,V=ht+(Oe-Je),Q=et*De/I*ve,te=rt*De/I*ve;j.projectionMatrix.makePerspective(M,V,Q,te,ve,I),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}}function Z(j,re){re===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(re.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;let re=j.near,se=j.far;x.texture!==null&&(x.depthNear>0&&(re=x.depthNear),x.depthFar>0&&(se=x.depthFar)),z.near=U.near=T.near=re,z.far=U.far=T.far=se,(G!==z.near||W!==z.far)&&(r.updateRenderState({depthNear:z.near,depthFar:z.far}),G=z.near,W=z.far),z.layers.mask=j.layers.mask|6,T.layers.mask=z.layers.mask&-5,U.layers.mask=z.layers.mask&-3;const Oe=j.parent,ne=z.cameras;Z(z,Oe);for(let _e=0;_e<ne.length;_e++)Z(ne[_e],Oe);ne.length===2?X(z,T,U):z.projectionMatrix.copy(T.projectionMatrix),ee(j,z,Oe)};function ee(j,re,se){se===null?j.matrix.copy(re.matrixWorld):(j.matrix.copy(se.matrixWorld),j.matrix.invert(),j.matrix.multiply(re.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(re.projectionMatrix),j.projectionMatrixInverse.copy(re.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=ao*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return z},this.getFoveation=function(){if(!(u===null&&p===null))return l},this.setFoveation=function(j){l=j,u!==null&&(u.fixedFoveation=j),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=j)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(z)},this.getCameraTexture=function(j){return h[j]};let Ce=null;function ze(j,re){if(d=re.getViewerPose(c||o),g=re,d!==null){const se=d.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let Oe=!1;se.length!==z.cameras.length&&(z.cameras.length=0,Oe=!0);for(let De=0;De<se.length;De++){const et=se[De];let rt=null;if(p!==null)rt=p.getViewport(et);else{const Mt=f.getViewSubImage(u,et);rt=Mt.viewport,De===0&&(e.setRenderTargetTextures(S,Mt.colorTexture,Mt.depthStencilTexture),e.setRenderTarget(S))}let He=L[De];He===void 0&&(He=new Jt,He.layers.enable(De),He.viewport=new _t,L[De]=He),He.matrix.fromArray(et.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(et.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(rt.x,rt.y,rt.width,rt.height),De===0&&(z.matrix.copy(He.matrix),z.matrix.decompose(z.position,z.quaternion,z.scale)),Oe===!0&&z.cameras.push(He)}const ne=r.enabledFeatures;if(ne&&ne.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){f=i.getBinding();const De=f.getDepthInformation(se[0]);De&&De.isValid&&De.texture&&x.init(De,r.renderState)}if(ne&&ne.includes("camera-access")&&v){e.state.unbindTexture(),f=i.getBinding();for(let De=0;De<se.length;De++){const et=se[De].camera;if(et){let rt=h[et];rt||(rt=new wv,h[et]=rt);const He=f.getCameraImage(et);rt.sourceTexture=He}}}}for(let se=0;se<w.length;se++){const Oe=b[se],ne=w[se];Oe!==null&&ne!==void 0&&ne.update(Oe,re,c||o)}Ce&&Ce(j,re),re.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:re}),g=null}const pe=new Pv;pe.setAnimationLoop(ze),this.setAnimationLoop=function(j){Ce=j},this.dispose=function(){}}}const Br=new ri,NA=new je;function DA(n,e){function t(x,h){x.matrixAutoUpdate===!0&&x.updateMatrix(),h.value.copy(x.matrix)}function i(x,h){h.color.getRGB(x.fogColor.value,Tv(n)),h.isFog?(x.fogNear.value=h.near,x.fogFar.value=h.far):h.isFogExp2&&(x.fogDensity.value=h.density)}function r(x,h,m,_,S){h.isMeshBasicMaterial?s(x,h):h.isMeshLambertMaterial?(s(x,h),h.envMap&&(x.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(s(x,h),f(x,h)):h.isMeshPhongMaterial?(s(x,h),d(x,h),h.envMap&&(x.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(s(x,h),u(x,h),h.isMeshPhysicalMaterial&&p(x,h,S)):h.isMeshMatcapMaterial?(s(x,h),g(x,h)):h.isMeshDepthMaterial?s(x,h):h.isMeshDistanceMaterial?(s(x,h),v(x,h)):h.isMeshNormalMaterial?s(x,h):h.isLineBasicMaterial?(o(x,h),h.isLineDashedMaterial&&a(x,h)):h.isPointsMaterial?l(x,h,m,_):h.isSpriteMaterial?c(x,h):h.isShadowMaterial?(x.color.value.copy(h.color),x.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(x,h){x.opacity.value=h.opacity,h.color&&x.diffuse.value.copy(h.color),h.emissive&&x.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(x.map.value=h.map,t(h.map,x.mapTransform)),h.alphaMap&&(x.alphaMap.value=h.alphaMap,t(h.alphaMap,x.alphaMapTransform)),h.bumpMap&&(x.bumpMap.value=h.bumpMap,t(h.bumpMap,x.bumpMapTransform),x.bumpScale.value=h.bumpScale,h.side===hn&&(x.bumpScale.value*=-1)),h.normalMap&&(x.normalMap.value=h.normalMap,t(h.normalMap,x.normalMapTransform),x.normalScale.value.copy(h.normalScale),h.side===hn&&x.normalScale.value.negate()),h.displacementMap&&(x.displacementMap.value=h.displacementMap,t(h.displacementMap,x.displacementMapTransform),x.displacementScale.value=h.displacementScale,x.displacementBias.value=h.displacementBias),h.emissiveMap&&(x.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,x.emissiveMapTransform)),h.specularMap&&(x.specularMap.value=h.specularMap,t(h.specularMap,x.specularMapTransform)),h.alphaTest>0&&(x.alphaTest.value=h.alphaTest);const m=e.get(h),_=m.envMap,S=m.envMapRotation;_&&(x.envMap.value=_,Br.copy(S),Br.x*=-1,Br.y*=-1,Br.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Br.y*=-1,Br.z*=-1),x.envMapRotation.value.setFromMatrix4(NA.makeRotationFromEuler(Br)),x.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,x.reflectivity.value=h.reflectivity,x.ior.value=h.ior,x.refractionRatio.value=h.refractionRatio),h.lightMap&&(x.lightMap.value=h.lightMap,x.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,x.lightMapTransform)),h.aoMap&&(x.aoMap.value=h.aoMap,x.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,x.aoMapTransform))}function o(x,h){x.diffuse.value.copy(h.color),x.opacity.value=h.opacity,h.map&&(x.map.value=h.map,t(h.map,x.mapTransform))}function a(x,h){x.dashSize.value=h.dashSize,x.totalSize.value=h.dashSize+h.gapSize,x.scale.value=h.scale}function l(x,h,m,_){x.diffuse.value.copy(h.color),x.opacity.value=h.opacity,x.size.value=h.size*m,x.scale.value=_*.5,h.map&&(x.map.value=h.map,t(h.map,x.uvTransform)),h.alphaMap&&(x.alphaMap.value=h.alphaMap,t(h.alphaMap,x.alphaMapTransform)),h.alphaTest>0&&(x.alphaTest.value=h.alphaTest)}function c(x,h){x.diffuse.value.copy(h.color),x.opacity.value=h.opacity,x.rotation.value=h.rotation,h.map&&(x.map.value=h.map,t(h.map,x.mapTransform)),h.alphaMap&&(x.alphaMap.value=h.alphaMap,t(h.alphaMap,x.alphaMapTransform)),h.alphaTest>0&&(x.alphaTest.value=h.alphaTest)}function d(x,h){x.specular.value.copy(h.specular),x.shininess.value=Math.max(h.shininess,1e-4)}function f(x,h){h.gradientMap&&(x.gradientMap.value=h.gradientMap)}function u(x,h){x.metalness.value=h.metalness,h.metalnessMap&&(x.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,x.metalnessMapTransform)),x.roughness.value=h.roughness,h.roughnessMap&&(x.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,x.roughnessMapTransform)),h.envMap&&(x.envMapIntensity.value=h.envMapIntensity)}function p(x,h,m){x.ior.value=h.ior,h.sheen>0&&(x.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),x.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(x.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,x.sheenColorMapTransform)),h.sheenRoughnessMap&&(x.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,x.sheenRoughnessMapTransform))),h.clearcoat>0&&(x.clearcoat.value=h.clearcoat,x.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(x.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,x.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(x.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===hn&&x.clearcoatNormalScale.value.negate())),h.dispersion>0&&(x.dispersion.value=h.dispersion),h.iridescence>0&&(x.iridescence.value=h.iridescence,x.iridescenceIOR.value=h.iridescenceIOR,x.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(x.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,x.iridescenceMapTransform)),h.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),h.transmission>0&&(x.transmission.value=h.transmission,x.transmissionSamplerMap.value=m.texture,x.transmissionSamplerSize.value.set(m.width,m.height),h.transmissionMap&&(x.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,x.transmissionMapTransform)),x.thickness.value=h.thickness,h.thicknessMap&&(x.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=h.attenuationDistance,x.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(x.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(x.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=h.specularIntensity,x.specularColor.value.copy(h.specularColor),h.specularColorMap&&(x.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,x.specularColorMapTransform)),h.specularIntensityMap&&(x.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,x.specularIntensityMapTransform))}function g(x,h){h.matcap&&(x.matcap.value=h.matcap)}function v(x,h){const m=e.get(h).light;x.referencePosition.value.setFromMatrixPosition(m.matrixWorld),x.nearDistance.value=m.shadow.camera.near,x.farDistance.value=m.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function UA(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(m,_){const S=_.program;i.uniformBlockBinding(m,S)}function c(m,_){let S=r[m.id];S===void 0&&(g(m),S=d(m),r[m.id]=S,m.addEventListener("dispose",x));const w=_.program;i.updateUBOMapping(m,w);const b=e.render.frame;s[m.id]!==b&&(u(m),s[m.id]=b)}function d(m){const _=f();m.__bindingPointIndex=_;const S=n.createBuffer(),w=m.__size,b=m.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,w,b),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,_,S),S}function f(){for(let m=0;m<a;m++)if(o.indexOf(m)===-1)return o.push(m),m;return Fe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(m){const _=r[m.id],S=m.uniforms,w=m.__cache;n.bindBuffer(n.UNIFORM_BUFFER,_);for(let b=0,R=S.length;b<R;b++){const y=Array.isArray(S[b])?S[b]:[S[b]];for(let T=0,U=y.length;T<U;T++){const L=y[T];if(p(L,b,T,w)===!0){const z=L.__offset,G=Array.isArray(L.value)?L.value:[L.value];let W=0;for(let F=0;F<G.length;F++){const C=G[F],N=v(C);typeof C=="number"||typeof C=="boolean"?(L.__data[0]=C,n.bufferSubData(n.UNIFORM_BUFFER,z+W,L.__data)):C.isMatrix3?(L.__data[0]=C.elements[0],L.__data[1]=C.elements[1],L.__data[2]=C.elements[2],L.__data[3]=0,L.__data[4]=C.elements[3],L.__data[5]=C.elements[4],L.__data[6]=C.elements[5],L.__data[7]=0,L.__data[8]=C.elements[6],L.__data[9]=C.elements[7],L.__data[10]=C.elements[8],L.__data[11]=0):(C.toArray(L.__data,W),W+=N.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,z,L.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(m,_,S,w){const b=m.value,R=_+"_"+S;if(w[R]===void 0)return typeof b=="number"||typeof b=="boolean"?w[R]=b:w[R]=b.clone(),!0;{const y=w[R];if(typeof b=="number"||typeof b=="boolean"){if(y!==b)return w[R]=b,!0}else if(y.equals(b)===!1)return y.copy(b),!0}return!1}function g(m){const _=m.uniforms;let S=0;const w=16;for(let R=0,y=_.length;R<y;R++){const T=Array.isArray(_[R])?_[R]:[_[R]];for(let U=0,L=T.length;U<L;U++){const z=T[U],G=Array.isArray(z.value)?z.value:[z.value];for(let W=0,F=G.length;W<F;W++){const C=G[W],N=v(C),P=S%w,O=P%N.boundary,X=P+O;S+=O,X!==0&&w-X<N.storage&&(S+=w-X),z.__data=new Float32Array(N.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=S,S+=N.storage}}}const b=S%w;return b>0&&(S+=w-b),m.__size=S,m.__cache={},this}function v(m){const _={boundary:0,storage:0};return typeof m=="number"||typeof m=="boolean"?(_.boundary=4,_.storage=4):m.isVector2?(_.boundary=8,_.storage=8):m.isVector3||m.isColor?(_.boundary=16,_.storage=12):m.isVector4?(_.boundary=16,_.storage=16):m.isMatrix3?(_.boundary=48,_.storage=48):m.isMatrix4?(_.boundary=64,_.storage=64):m.isTexture?Le("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Le("WebGLRenderer: Unsupported uniform value type.",m),_}function x(m){const _=m.target;_.removeEventListener("dispose",x);const S=o.indexOf(_.__bindingPointIndex);o.splice(S,1),n.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function h(){for(const m in r)n.deleteBuffer(r[m]);o=[],r={},s={}}return{bind:l,update:c,dispose:h}}const FA=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ui=null;function OA(){return ui===null&&(ui=new Np(FA,16,16,oo,Zi),ui.name="DFG_LUT",ui.minFilter=Vt,ui.magFilter=Vt,ui.wrapS=xi,ui.wrapT=xi,ui.generateMipmaps=!1,ui.needsUpdate=!0),ui}class zp{constructor(e={}){const{canvas:t=f1(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:u=!1,outputBufferType:p=bn}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=o;const v=p,x=new Set([bp,Tp,wp]),h=new Set([bn,wi,ba,Aa,Sp,Mp]),m=new Uint32Array(4),_=new Int32Array(4);let S=null,w=null;const b=[],R=[];let y=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Mi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const T=this;let U=!1;this._outputColorSpace=kt;let L=0,z=0,G=null,W=-1,F=null;const C=new _t,N=new _t;let P=null;const O=new ke(0);let X=0,Z=t.width,ee=t.height,Ce=1,ze=null,pe=null;const j=new _t(0,0,Z,ee),re=new _t(0,0,Z,ee);let se=!1;const Oe=new Up;let ne=!1,_e=!1;const tt=new je,De=new k,et=new _t,rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let He=!1;function Mt(){return G===null?Ce:1}let D=i;function ht(A,H){return t.getContext(A,H)}try{const A={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${_p}`),t.addEventListener("webglcontextlost",Te,!1),t.addEventListener("webglcontextrestored",Be,!1),t.addEventListener("webglcontextcreationerror",mt,!1),D===null){const H="webgl2";if(D=ht(H,A),D===null)throw ht(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw Fe("WebGLRenderer: "+A.message),A}let st,Je,ve,I,M,V,Q,te,J,Ee,de,Ne,Ue,ae,ce,we,be,xe,Xe,B,fe,ue,Me;function le(){st=new kb(D),st.init(),fe=new RA(D,st),Je=new Pb(D,st,e,fe),ve=new bA(D,st),Je.reversedDepthBuffer&&u&&ve.buffers.depth.setReversed(!0),I=new Vb(D),M=new fA,V=new AA(D,st,ve,M,Je,fe,I),Q=new Ob(T),te=new XE(D),ue=new Rb(D,te),J=new Bb(D,te,I,ue),Ee=new Gb(D,J,te,ue,I),xe=new Hb(D,Je,V),ce=new Ib(M),de=new dA(T,Q,st,Je,ue,ce),Ne=new DA(T,M),Ue=new pA,ae=new yA(st),be=new Ab(T,Q,ve,Ee,g,l),we=new TA(T,Ee,Je),Me=new UA(D,I,Je,ve),Xe=new Cb(D,st,I),B=new zb(D,st,I),I.programs=de.programs,T.capabilities=Je,T.extensions=st,T.properties=M,T.renderLists=Ue,T.shadowMap=we,T.state=ve,T.info=I}le(),v!==bn&&(y=new jb(v,t.width,t.height,r,s));const K=new LA(T,D);this.xr=K,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const A=st.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=st.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return Ce},this.setPixelRatio=function(A){A!==void 0&&(Ce=A,this.setSize(Z,ee,!1))},this.getSize=function(A){return A.set(Z,ee)},this.setSize=function(A,H,$=!0){if(K.isPresenting){Le("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=A,ee=H,t.width=Math.floor(A*Ce),t.height=Math.floor(H*Ce),$===!0&&(t.style.width=A+"px",t.style.height=H+"px"),y!==null&&y.setSize(t.width,t.height),this.setViewport(0,0,A,H)},this.getDrawingBufferSize=function(A){return A.set(Z*Ce,ee*Ce).floor()},this.setDrawingBufferSize=function(A,H,$){Z=A,ee=H,Ce=$,t.width=Math.floor(A*$),t.height=Math.floor(H*$),this.setViewport(0,0,A,H)},this.setEffects=function(A){if(v===bn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let H=0;H<A.length;H++)if(A[H].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}y.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(C)},this.getViewport=function(A){return A.copy(j)},this.setViewport=function(A,H,$,q){A.isVector4?j.set(A.x,A.y,A.z,A.w):j.set(A,H,$,q),ve.viewport(C.copy(j).multiplyScalar(Ce).round())},this.getScissor=function(A){return A.copy(re)},this.setScissor=function(A,H,$,q){A.isVector4?re.set(A.x,A.y,A.z,A.w):re.set(A,H,$,q),ve.scissor(N.copy(re).multiplyScalar(Ce).round())},this.getScissorTest=function(){return se},this.setScissorTest=function(A){ve.setScissorTest(se=A)},this.setOpaqueSort=function(A){ze=A},this.setTransparentSort=function(A){pe=A},this.getClearColor=function(A){return A.copy(be.getClearColor())},this.setClearColor=function(){be.setClearColor(...arguments)},this.getClearAlpha=function(){return be.getClearAlpha()},this.setClearAlpha=function(){be.setClearAlpha(...arguments)},this.clear=function(A=!0,H=!0,$=!0){let q=0;if(A){let Y=!1;if(G!==null){const me=G.texture.format;Y=x.has(me)}if(Y){const me=G.texture.type,ye=h.has(me),ge=be.getClearColor(),Ae=be.getClearAlpha(),Pe=ge.r,Ve=ge.g,Ye=ge.b;ye?(m[0]=Pe,m[1]=Ve,m[2]=Ye,m[3]=Ae,D.clearBufferuiv(D.COLOR,0,m)):(_[0]=Pe,_[1]=Ve,_[2]=Ye,_[3]=Ae,D.clearBufferiv(D.COLOR,0,_))}else q|=D.COLOR_BUFFER_BIT}H&&(q|=D.DEPTH_BUFFER_BIT),$&&(q|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),q!==0&&D.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Te,!1),t.removeEventListener("webglcontextrestored",Be,!1),t.removeEventListener("webglcontextcreationerror",mt,!1),be.dispose(),Ue.dispose(),ae.dispose(),M.dispose(),Q.dispose(),Ee.dispose(),ue.dispose(),Me.dispose(),de.dispose(),K.dispose(),K.removeEventListener("sessionstart",jp),K.removeEventListener("sessionend",Xp),Lr.stop()};function Te(A){A.preventDefault(),Cc("WebGLRenderer: Context Lost."),U=!0}function Be(){Cc("WebGLRenderer: Context Restored."),U=!1;const A=I.autoReset,H=we.enabled,$=we.autoUpdate,q=we.needsUpdate,Y=we.type;le(),I.autoReset=A,we.enabled=H,we.autoUpdate=$,we.needsUpdate=q,we.type=Y}function mt(A){Fe("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function ot(A){const H=A.target;H.removeEventListener("dispose",ot),Ri(H)}function Ri(A){Ci(A),M.remove(A)}function Ci(A){const H=M.get(A).programs;H!==void 0&&(H.forEach(function($){de.releaseProgram($)}),A.isShaderMaterial&&de.releaseShaderCache(A))}this.renderBufferDirect=function(A,H,$,q,Y,me){H===null&&(H=rt);const ye=Y.isMesh&&Y.matrixWorld.determinant()<0,ge=$v(A,H,$,q,Y);ve.setMaterial(q,ye);let Ae=$.index,Pe=1;if(q.wireframe===!0){if(Ae=J.getWireframeAttribute($),Ae===void 0)return;Pe=2}const Ve=$.drawRange,Ye=$.attributes.position;let Ie=Ve.start*Pe,dt=(Ve.start+Ve.count)*Pe;me!==null&&(Ie=Math.max(Ie,me.start*Pe),dt=Math.min(dt,(me.start+me.count)*Pe)),Ae!==null?(Ie=Math.max(Ie,0),dt=Math.min(dt,Ae.count)):Ye!=null&&(Ie=Math.max(Ie,0),dt=Math.min(dt,Ye.count));const It=dt-Ie;if(It<0||It===1/0)return;ue.setup(Y,q,ge,$,Ae);let At,ft=Xe;if(Ae!==null&&(At=te.get(Ae),ft=B,ft.setIndex(At)),Y.isMesh)q.wireframe===!0?(ve.setLineWidth(q.wireframeLinewidth*Mt()),ft.setMode(D.LINES)):ft.setMode(D.TRIANGLES);else if(Y.isLine){let tn=q.linewidth;tn===void 0&&(tn=1),ve.setLineWidth(tn*Mt()),Y.isLineSegments?ft.setMode(D.LINES):Y.isLineLoop?ft.setMode(D.LINE_LOOP):ft.setMode(D.LINE_STRIP)}else Y.isPoints?ft.setMode(D.POINTS):Y.isSprite&&ft.setMode(D.TRIANGLES);if(Y.isBatchedMesh)if(Y._multiDrawInstances!==null)Pc("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ft.renderMultiDrawInstances(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount,Y._multiDrawInstances);else if(st.get("WEBGL_multi_draw"))ft.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const tn=Y._multiDrawStarts,Re=Y._multiDrawCounts,Mn=Y._multiDrawCount,it=Ae?te.get(Ae).bytesPerElement:1,Hn=M.get(q).currentProgram.getUniforms();for(let ai=0;ai<Mn;ai++)Hn.setValue(D,"_gl_DrawID",ai),ft.render(tn[ai]/it,Re[ai])}else if(Y.isInstancedMesh)ft.renderInstances(Ie,It,Y.count);else if($.isInstancedBufferGeometry){const tn=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,Re=Math.min($.instanceCount,tn);ft.renderInstances(Ie,It,Re)}else ft.render(Ie,It)};function Wp(A,H,$){A.transparent===!0&&A.side===gi&&A.forceSinglePass===!1?(A.side=hn,A.needsUpdate=!0,Ha(A,H,$),A.side=Ki,A.needsUpdate=!0,Ha(A,H,$),A.side=gi):Ha(A,H,$)}this.compile=function(A,H,$=null){$===null&&($=A),w=ae.get($),w.init(H),R.push(w),$.traverseVisible(function(Y){Y.isLight&&Y.layers.test(H.layers)&&(w.pushLight(Y),Y.castShadow&&w.pushShadow(Y))}),A!==$&&A.traverseVisible(function(Y){Y.isLight&&Y.layers.test(H.layers)&&(w.pushLight(Y),Y.castShadow&&w.pushShadow(Y))}),w.setupLights();const q=new Set;return A.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const me=Y.material;if(me)if(Array.isArray(me))for(let ye=0;ye<me.length;ye++){const ge=me[ye];Wp(ge,$,Y),q.add(ge)}else Wp(me,$,Y),q.add(me)}),w=R.pop(),q},this.compileAsync=function(A,H,$=null){const q=this.compile(A,H,$);return new Promise(Y=>{function me(){if(q.forEach(function(ye){M.get(ye).currentProgram.isReady()&&q.delete(ye)}),q.size===0){Y(A);return}setTimeout(me,10)}st.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let fu=null;function qv(A){fu&&fu(A)}function jp(){Lr.stop()}function Xp(){Lr.start()}const Lr=new Pv;Lr.setAnimationLoop(qv),typeof self<"u"&&Lr.setContext(self),this.setAnimationLoop=function(A){fu=A,K.setAnimationLoop(A),A===null?Lr.stop():Lr.start()},K.addEventListener("sessionstart",jp),K.addEventListener("sessionend",Xp),this.render=function(A,H){if(H!==void 0&&H.isCamera!==!0){Fe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(U===!0)return;const $=K.enabled===!0&&K.isPresenting===!0,q=y!==null&&(G===null||$)&&y.begin(T,G);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),K.enabled===!0&&K.isPresenting===!0&&(y===null||y.isCompositing()===!1)&&(K.cameraAutoUpdate===!0&&K.updateCamera(H),H=K.getCamera()),A.isScene===!0&&A.onBeforeRender(T,A,H,G),w=ae.get(A,R.length),w.init(H),R.push(w),tt.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),Oe.setFromProjectionMatrix(tt,_i,H.reversedDepth),_e=this.localClippingEnabled,ne=ce.init(this.clippingPlanes,_e),S=Ue.get(A,b.length),S.init(),b.push(S),K.enabled===!0&&K.isPresenting===!0){const ye=T.xr.getDepthSensingMesh();ye!==null&&hu(ye,H,-1/0,T.sortObjects)}hu(A,H,0,T.sortObjects),S.finish(),T.sortObjects===!0&&S.sort(ze,pe),He=K.enabled===!1||K.isPresenting===!1||K.hasDepthSensing()===!1,He&&be.addToRenderList(S,A),this.info.render.frame++,ne===!0&&ce.beginShadows();const Y=w.state.shadowsArray;if(we.render(Y,A,H),ne===!0&&ce.endShadows(),this.info.autoReset===!0&&this.info.reset(),(q&&y.hasRenderPass())===!1){const ye=S.opaque,ge=S.transmissive;if(w.setupLights(),H.isArrayCamera){const Ae=H.cameras;if(ge.length>0)for(let Pe=0,Ve=Ae.length;Pe<Ve;Pe++){const Ye=Ae[Pe];qp(ye,ge,A,Ye)}He&&be.render(A);for(let Pe=0,Ve=Ae.length;Pe<Ve;Pe++){const Ye=Ae[Pe];Yp(S,A,Ye,Ye.viewport)}}else ge.length>0&&qp(ye,ge,A,H),He&&be.render(A),Yp(S,A,H)}G!==null&&z===0&&(V.updateMultisampleRenderTarget(G),V.updateRenderTargetMipmap(G)),q&&y.end(T),A.isScene===!0&&A.onAfterRender(T,A,H),ue.resetDefaultState(),W=-1,F=null,R.pop(),R.length>0?(w=R[R.length-1],ne===!0&&ce.setGlobalState(T.clippingPlanes,w.state.camera)):w=null,b.pop(),b.length>0?S=b[b.length-1]:S=null};function hu(A,H,$,q){if(A.visible===!1)return;if(A.layers.test(H.layers)){if(A.isGroup)$=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(H);else if(A.isLight)w.pushLight(A),A.castShadow&&w.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Oe.intersectsSprite(A)){q&&et.setFromMatrixPosition(A.matrixWorld).applyMatrix4(tt);const ye=Ee.update(A),ge=A.material;ge.visible&&S.push(A,ye,ge,$,et.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Oe.intersectsObject(A))){const ye=Ee.update(A),ge=A.material;if(q&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),et.copy(A.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),et.copy(ye.boundingSphere.center)),et.applyMatrix4(A.matrixWorld).applyMatrix4(tt)),Array.isArray(ge)){const Ae=ye.groups;for(let Pe=0,Ve=Ae.length;Pe<Ve;Pe++){const Ye=Ae[Pe],Ie=ge[Ye.materialIndex];Ie&&Ie.visible&&S.push(A,ye,Ie,$,et.z,Ye)}}else ge.visible&&S.push(A,ye,ge,$,et.z,null)}}const me=A.children;for(let ye=0,ge=me.length;ye<ge;ye++)hu(me[ye],H,$,q)}function Yp(A,H,$,q){const{opaque:Y,transmissive:me,transparent:ye}=A;w.setupLightsView($),ne===!0&&ce.setGlobalState(T.clippingPlanes,$),q&&ve.viewport(C.copy(q)),Y.length>0&&Va(Y,H,$),me.length>0&&Va(me,H,$),ye.length>0&&Va(ye,H,$),ve.buffers.depth.setTest(!0),ve.buffers.depth.setMask(!0),ve.buffers.color.setMask(!0),ve.setPolygonOffset(!1)}function qp(A,H,$,q){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[q.id]===void 0){const Ie=st.has("EXT_color_buffer_half_float")||st.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[q.id]=new Ei(1,1,{generateMipmaps:!0,type:Ie?Zi:bn,minFilter:zi,samples:Math.max(4,Je.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Qe.workingColorSpace})}const me=w.state.transmissionRenderTarget[q.id],ye=q.viewport||C;me.setSize(ye.z*T.transmissionResolutionScale,ye.w*T.transmissionResolutionScale);const ge=T.getRenderTarget(),Ae=T.getActiveCubeFace(),Pe=T.getActiveMipmapLevel();T.setRenderTarget(me),T.getClearColor(O),X=T.getClearAlpha(),X<1&&T.setClearColor(16777215,.5),T.clear(),He&&be.render($);const Ve=T.toneMapping;T.toneMapping=Mi;const Ye=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),w.setupLightsView(q),ne===!0&&ce.setGlobalState(T.clippingPlanes,q),Va(A,$,q),V.updateMultisampleRenderTarget(me),V.updateRenderTargetMipmap(me),st.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let dt=0,It=H.length;dt<It;dt++){const At=H[dt],{object:ft,geometry:tn,material:Re,group:Mn}=At;if(Re.side===gi&&ft.layers.test(q.layers)){const it=Re.side;Re.side=hn,Re.needsUpdate=!0,$p(ft,$,q,tn,Re,Mn),Re.side=it,Re.needsUpdate=!0,Ie=!0}}Ie===!0&&(V.updateMultisampleRenderTarget(me),V.updateRenderTargetMipmap(me))}T.setRenderTarget(ge,Ae,Pe),T.setClearColor(O,X),Ye!==void 0&&(q.viewport=Ye),T.toneMapping=Ve}function Va(A,H,$){const q=H.isScene===!0?H.overrideMaterial:null;for(let Y=0,me=A.length;Y<me;Y++){const ye=A[Y],{object:ge,geometry:Ae,group:Pe}=ye;let Ve=ye.material;Ve.allowOverride===!0&&q!==null&&(Ve=q),ge.layers.test($.layers)&&$p(ge,H,$,Ae,Ve,Pe)}}function $p(A,H,$,q,Y,me){A.onBeforeRender(T,H,$,q,Y,me),A.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),Y.onBeforeRender(T,H,$,q,A,me),Y.transparent===!0&&Y.side===gi&&Y.forceSinglePass===!1?(Y.side=hn,Y.needsUpdate=!0,T.renderBufferDirect($,H,q,Y,A,me),Y.side=Ki,Y.needsUpdate=!0,T.renderBufferDirect($,H,q,Y,A,me),Y.side=gi):T.renderBufferDirect($,H,q,Y,A,me),A.onAfterRender(T,H,$,q,Y,me)}function Ha(A,H,$){H.isScene!==!0&&(H=rt);const q=M.get(A),Y=w.state.lights,me=w.state.shadowsArray,ye=Y.state.version,ge=de.getParameters(A,Y.state,me,H,$),Ae=de.getProgramCacheKey(ge);let Pe=q.programs;q.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?H.environment:null,q.fog=H.fog;const Ve=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;q.envMap=Q.get(A.envMap||q.environment,Ve),q.envMapRotation=q.environment!==null&&A.envMap===null?H.environmentRotation:A.envMapRotation,Pe===void 0&&(A.addEventListener("dispose",ot),Pe=new Map,q.programs=Pe);let Ye=Pe.get(Ae);if(Ye!==void 0){if(q.currentProgram===Ye&&q.lightsStateVersion===ye)return Zp(A,ge),Ye}else ge.uniforms=de.getUniforms(A),A.onBeforeCompile(ge,T),Ye=de.acquireProgram(ge,Ae),Pe.set(Ae,Ye),q.uniforms=ge.uniforms;const Ie=q.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Ie.clippingPlanes=ce.uniform),Zp(A,ge),q.needsLights=Zv(A),q.lightsStateVersion=ye,q.needsLights&&(Ie.ambientLightColor.value=Y.state.ambient,Ie.lightProbe.value=Y.state.probe,Ie.directionalLights.value=Y.state.directional,Ie.directionalLightShadows.value=Y.state.directionalShadow,Ie.spotLights.value=Y.state.spot,Ie.spotLightShadows.value=Y.state.spotShadow,Ie.rectAreaLights.value=Y.state.rectArea,Ie.ltc_1.value=Y.state.rectAreaLTC1,Ie.ltc_2.value=Y.state.rectAreaLTC2,Ie.pointLights.value=Y.state.point,Ie.pointLightShadows.value=Y.state.pointShadow,Ie.hemisphereLights.value=Y.state.hemi,Ie.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,Ie.spotLightMatrix.value=Y.state.spotLightMatrix,Ie.spotLightMap.value=Y.state.spotLightMap,Ie.pointShadowMatrix.value=Y.state.pointShadowMatrix),q.currentProgram=Ye,q.uniformsList=null,Ye}function Kp(A){if(A.uniformsList===null){const H=A.currentProgram.getUniforms();A.uniformsList=ec.seqWithValue(H.seq,A.uniforms)}return A.uniformsList}function Zp(A,H){const $=M.get(A);$.outputColorSpace=H.outputColorSpace,$.batching=H.batching,$.batchingColor=H.batchingColor,$.instancing=H.instancing,$.instancingColor=H.instancingColor,$.instancingMorph=H.instancingMorph,$.skinning=H.skinning,$.morphTargets=H.morphTargets,$.morphNormals=H.morphNormals,$.morphColors=H.morphColors,$.morphTargetsCount=H.morphTargetsCount,$.numClippingPlanes=H.numClippingPlanes,$.numIntersection=H.numClipIntersection,$.vertexAlphas=H.vertexAlphas,$.vertexTangents=H.vertexTangents,$.toneMapping=H.toneMapping}function $v(A,H,$,q,Y){H.isScene!==!0&&(H=rt),V.resetTextureUnits();const me=H.fog,ye=q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial?H.environment:null,ge=G===null?T.outputColorSpace:G.isXRRenderTarget===!0?G.texture.colorSpace:pn,Ae=q.isMeshStandardMaterial||q.isMeshLambertMaterial&&!q.envMap||q.isMeshPhongMaterial&&!q.envMap,Pe=Q.get(q.envMap||ye,Ae),Ve=q.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,Ye=!!$.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ie=!!$.morphAttributes.position,dt=!!$.morphAttributes.normal,It=!!$.morphAttributes.color;let At=Mi;q.toneMapped&&(G===null||G.isXRRenderTarget===!0)&&(At=T.toneMapping);const ft=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,tn=ft!==void 0?ft.length:0,Re=M.get(q),Mn=w.state.lights;if(ne===!0&&(_e===!0||A!==F)){const jt=A===F&&q.id===W;ce.setState(q,A,jt)}let it=!1;q.version===Re.__version?(Re.needsLights&&Re.lightsStateVersion!==Mn.state.version||Re.outputColorSpace!==ge||Y.isBatchedMesh&&Re.batching===!1||!Y.isBatchedMesh&&Re.batching===!0||Y.isBatchedMesh&&Re.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Re.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Re.instancing===!1||!Y.isInstancedMesh&&Re.instancing===!0||Y.isSkinnedMesh&&Re.skinning===!1||!Y.isSkinnedMesh&&Re.skinning===!0||Y.isInstancedMesh&&Re.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Re.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Re.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Re.instancingMorph===!1&&Y.morphTexture!==null||Re.envMap!==Pe||q.fog===!0&&Re.fog!==me||Re.numClippingPlanes!==void 0&&(Re.numClippingPlanes!==ce.numPlanes||Re.numIntersection!==ce.numIntersection)||Re.vertexAlphas!==Ve||Re.vertexTangents!==Ye||Re.morphTargets!==Ie||Re.morphNormals!==dt||Re.morphColors!==It||Re.toneMapping!==At||Re.morphTargetsCount!==tn)&&(it=!0):(it=!0,Re.__version=q.version);let Hn=Re.currentProgram;it===!0&&(Hn=Ha(q,H,Y));let ai=!1,Nr=!1,ls=!1;const pt=Hn.getUniforms(),Kt=Re.uniforms;if(ve.useProgram(Hn.program)&&(ai=!0,Nr=!0,ls=!0),q.id!==W&&(W=q.id,Nr=!0),ai||F!==A){ve.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),pt.setValue(D,"projectionMatrix",A.projectionMatrix),pt.setValue(D,"viewMatrix",A.matrixWorldInverse);const nr=pt.map.cameraPosition;nr!==void 0&&nr.setValue(D,De.setFromMatrixPosition(A.matrixWorld)),Je.logarithmicDepthBuffer&&pt.setValue(D,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&pt.setValue(D,"isOrthographic",A.isOrthographicCamera===!0),F!==A&&(F=A,Nr=!0,ls=!0)}if(Re.needsLights&&(Mn.state.directionalShadowMap.length>0&&pt.setValue(D,"directionalShadowMap",Mn.state.directionalShadowMap,V),Mn.state.spotShadowMap.length>0&&pt.setValue(D,"spotShadowMap",Mn.state.spotShadowMap,V),Mn.state.pointShadowMap.length>0&&pt.setValue(D,"pointShadowMap",Mn.state.pointShadowMap,V)),Y.isSkinnedMesh){pt.setOptional(D,Y,"bindMatrix"),pt.setOptional(D,Y,"bindMatrixInverse");const jt=Y.skeleton;jt&&(jt.boneTexture===null&&jt.computeBoneTexture(),pt.setValue(D,"boneTexture",jt.boneTexture,V))}Y.isBatchedMesh&&(pt.setOptional(D,Y,"batchingTexture"),pt.setValue(D,"batchingTexture",Y._matricesTexture,V),pt.setOptional(D,Y,"batchingIdTexture"),pt.setValue(D,"batchingIdTexture",Y._indirectTexture,V),pt.setOptional(D,Y,"batchingColorTexture"),Y._colorsTexture!==null&&pt.setValue(D,"batchingColorTexture",Y._colorsTexture,V));const tr=$.morphAttributes;if((tr.position!==void 0||tr.normal!==void 0||tr.color!==void 0)&&xe.update(Y,$,Hn),(Nr||Re.receiveShadow!==Y.receiveShadow)&&(Re.receiveShadow=Y.receiveShadow,pt.setValue(D,"receiveShadow",Y.receiveShadow)),(q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial)&&q.envMap===null&&H.environment!==null&&(Kt.envMapIntensity.value=H.environmentIntensity),Kt.dfgLUT!==void 0&&(Kt.dfgLUT.value=OA()),Nr&&(pt.setValue(D,"toneMappingExposure",T.toneMappingExposure),Re.needsLights&&Kv(Kt,ls),me&&q.fog===!0&&Ne.refreshFogUniforms(Kt,me),Ne.refreshMaterialUniforms(Kt,q,Ce,ee,w.state.transmissionRenderTarget[A.id]),ec.upload(D,Kp(Re),Kt,V)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(ec.upload(D,Kp(Re),Kt,V),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&pt.setValue(D,"center",Y.center),pt.setValue(D,"modelViewMatrix",Y.modelViewMatrix),pt.setValue(D,"normalMatrix",Y.normalMatrix),pt.setValue(D,"modelMatrix",Y.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const jt=q.uniformsGroups;for(let nr=0,cs=jt.length;nr<cs;nr++){const Jp=jt[nr];Me.update(Jp,Hn),Me.bind(Jp,Hn)}}return Hn}function Kv(A,H){A.ambientLightColor.needsUpdate=H,A.lightProbe.needsUpdate=H,A.directionalLights.needsUpdate=H,A.directionalLightShadows.needsUpdate=H,A.pointLights.needsUpdate=H,A.pointLightShadows.needsUpdate=H,A.spotLights.needsUpdate=H,A.spotLightShadows.needsUpdate=H,A.rectAreaLights.needsUpdate=H,A.hemisphereLights.needsUpdate=H}function Zv(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return L},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return G},this.setRenderTargetTextures=function(A,H,$){const q=M.get(A);q.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),M.get(A.texture).__webglTexture=H,M.get(A.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:$,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,H){const $=M.get(A);$.__webglFramebuffer=H,$.__useDefaultFramebuffer=H===void 0};const Jv=D.createFramebuffer();this.setRenderTarget=function(A,H=0,$=0){G=A,L=H,z=$;let q=null,Y=!1,me=!1;if(A){const ge=M.get(A);if(ge.__useDefaultFramebuffer!==void 0){ve.bindFramebuffer(D.FRAMEBUFFER,ge.__webglFramebuffer),C.copy(A.viewport),N.copy(A.scissor),P=A.scissorTest,ve.viewport(C),ve.scissor(N),ve.setScissorTest(P),W=-1;return}else if(ge.__webglFramebuffer===void 0)V.setupRenderTarget(A);else if(ge.__hasExternalTextures)V.rebindTextures(A,M.get(A.texture).__webglTexture,M.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Ve=A.depthTexture;if(ge.__boundDepthTexture!==Ve){if(Ve!==null&&M.has(Ve)&&(A.width!==Ve.image.width||A.height!==Ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");V.setupDepthRenderbuffer(A)}}const Ae=A.texture;(Ae.isData3DTexture||Ae.isDataArrayTexture||Ae.isCompressedArrayTexture)&&(me=!0);const Pe=M.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Pe[H])?q=Pe[H][$]:q=Pe[H],Y=!0):A.samples>0&&V.useMultisampledRTT(A)===!1?q=M.get(A).__webglMultisampledFramebuffer:Array.isArray(Pe)?q=Pe[$]:q=Pe,C.copy(A.viewport),N.copy(A.scissor),P=A.scissorTest}else C.copy(j).multiplyScalar(Ce).floor(),N.copy(re).multiplyScalar(Ce).floor(),P=se;if($!==0&&(q=Jv),ve.bindFramebuffer(D.FRAMEBUFFER,q)&&ve.drawBuffers(A,q),ve.viewport(C),ve.scissor(N),ve.setScissorTest(P),Y){const ge=M.get(A.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+H,ge.__webglTexture,$)}else if(me){const ge=H;for(let Ae=0;Ae<A.textures.length;Ae++){const Pe=M.get(A.textures[Ae]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+Ae,Pe.__webglTexture,$,ge)}}else if(A!==null&&$!==0){const ge=M.get(A.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ge.__webglTexture,$)}W=-1},this.readRenderTargetPixels=function(A,H,$,q,Y,me,ye,ge=0){if(!(A&&A.isWebGLRenderTarget)){Fe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ae=M.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&ye!==void 0&&(Ae=Ae[ye]),Ae){ve.bindFramebuffer(D.FRAMEBUFFER,Ae);try{const Pe=A.textures[ge],Ve=Pe.format,Ye=Pe.type;if(A.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ge),!Je.textureFormatReadable(Ve)){Fe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Je.textureTypeReadable(Ye)){Fe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=A.width-q&&$>=0&&$<=A.height-Y&&D.readPixels(H,$,q,Y,fe.convert(Ve),fe.convert(Ye),me)}finally{const Pe=G!==null?M.get(G).__webglFramebuffer:null;ve.bindFramebuffer(D.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(A,H,$,q,Y,me,ye,ge=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ae=M.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&ye!==void 0&&(Ae=Ae[ye]),Ae)if(H>=0&&H<=A.width-q&&$>=0&&$<=A.height-Y){ve.bindFramebuffer(D.FRAMEBUFFER,Ae);const Pe=A.textures[ge],Ve=Pe.format,Ye=Pe.type;if(A.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ge),!Je.textureFormatReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Je.textureTypeReadable(Ye))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ie=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Ie),D.bufferData(D.PIXEL_PACK_BUFFER,me.byteLength,D.STREAM_READ),D.readPixels(H,$,q,Y,fe.convert(Ve),fe.convert(Ye),0);const dt=G!==null?M.get(G).__webglFramebuffer:null;ve.bindFramebuffer(D.FRAMEBUFFER,dt);const It=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await h1(D,It,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,Ie),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,me),D.deleteBuffer(Ie),D.deleteSync(It),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,H=null,$=0){const q=Math.pow(2,-$),Y=Math.floor(A.image.width*q),me=Math.floor(A.image.height*q),ye=H!==null?H.x:0,ge=H!==null?H.y:0;V.setTexture2D(A,0),D.copyTexSubImage2D(D.TEXTURE_2D,$,0,0,ye,ge,Y,me),ve.unbindTexture()};const Qv=D.createFramebuffer(),ey=D.createFramebuffer();this.copyTextureToTexture=function(A,H,$=null,q=null,Y=0,me=0){let ye,ge,Ae,Pe,Ve,Ye,Ie,dt,It;const At=A.isCompressedTexture?A.mipmaps[me]:A.image;if($!==null)ye=$.max.x-$.min.x,ge=$.max.y-$.min.y,Ae=$.isBox3?$.max.z-$.min.z:1,Pe=$.min.x,Ve=$.min.y,Ye=$.isBox3?$.min.z:0;else{const Kt=Math.pow(2,-Y);ye=Math.floor(At.width*Kt),ge=Math.floor(At.height*Kt),A.isDataArrayTexture?Ae=At.depth:A.isData3DTexture?Ae=Math.floor(At.depth*Kt):Ae=1,Pe=0,Ve=0,Ye=0}q!==null?(Ie=q.x,dt=q.y,It=q.z):(Ie=0,dt=0,It=0);const ft=fe.convert(H.format),tn=fe.convert(H.type);let Re;H.isData3DTexture?(V.setTexture3D(H,0),Re=D.TEXTURE_3D):H.isDataArrayTexture||H.isCompressedArrayTexture?(V.setTexture2DArray(H,0),Re=D.TEXTURE_2D_ARRAY):(V.setTexture2D(H,0),Re=D.TEXTURE_2D),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,H.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,H.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,H.unpackAlignment);const Mn=D.getParameter(D.UNPACK_ROW_LENGTH),it=D.getParameter(D.UNPACK_IMAGE_HEIGHT),Hn=D.getParameter(D.UNPACK_SKIP_PIXELS),ai=D.getParameter(D.UNPACK_SKIP_ROWS),Nr=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,At.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,At.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Pe),D.pixelStorei(D.UNPACK_SKIP_ROWS,Ve),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Ye);const ls=A.isDataArrayTexture||A.isData3DTexture,pt=H.isDataArrayTexture||H.isData3DTexture;if(A.isDepthTexture){const Kt=M.get(A),tr=M.get(H),jt=M.get(Kt.__renderTarget),nr=M.get(tr.__renderTarget);ve.bindFramebuffer(D.READ_FRAMEBUFFER,jt.__webglFramebuffer),ve.bindFramebuffer(D.DRAW_FRAMEBUFFER,nr.__webglFramebuffer);for(let cs=0;cs<Ae;cs++)ls&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,M.get(A).__webglTexture,Y,Ye+cs),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,M.get(H).__webglTexture,me,It+cs)),D.blitFramebuffer(Pe,Ve,ye,ge,Ie,dt,ye,ge,D.DEPTH_BUFFER_BIT,D.NEAREST);ve.bindFramebuffer(D.READ_FRAMEBUFFER,null),ve.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(Y!==0||A.isRenderTargetTexture||M.has(A)){const Kt=M.get(A),tr=M.get(H);ve.bindFramebuffer(D.READ_FRAMEBUFFER,Qv),ve.bindFramebuffer(D.DRAW_FRAMEBUFFER,ey);for(let jt=0;jt<Ae;jt++)ls?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Kt.__webglTexture,Y,Ye+jt):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Kt.__webglTexture,Y),pt?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,tr.__webglTexture,me,It+jt):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,tr.__webglTexture,me),Y!==0?D.blitFramebuffer(Pe,Ve,ye,ge,Ie,dt,ye,ge,D.COLOR_BUFFER_BIT,D.NEAREST):pt?D.copyTexSubImage3D(Re,me,Ie,dt,It+jt,Pe,Ve,ye,ge):D.copyTexSubImage2D(Re,me,Ie,dt,Pe,Ve,ye,ge);ve.bindFramebuffer(D.READ_FRAMEBUFFER,null),ve.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else pt?A.isDataTexture||A.isData3DTexture?D.texSubImage3D(Re,me,Ie,dt,It,ye,ge,Ae,ft,tn,At.data):H.isCompressedArrayTexture?D.compressedTexSubImage3D(Re,me,Ie,dt,It,ye,ge,Ae,ft,At.data):D.texSubImage3D(Re,me,Ie,dt,It,ye,ge,Ae,ft,tn,At):A.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,me,Ie,dt,ye,ge,ft,tn,At.data):A.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,me,Ie,dt,At.width,At.height,ft,At.data):D.texSubImage2D(D.TEXTURE_2D,me,Ie,dt,ye,ge,ft,tn,At);D.pixelStorei(D.UNPACK_ROW_LENGTH,Mn),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,it),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Hn),D.pixelStorei(D.UNPACK_SKIP_ROWS,ai),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Nr),me===0&&H.generateMipmaps&&D.generateMipmap(Re),ve.unbindTexture()},this.initRenderTarget=function(A){M.get(A).__webglFramebuffer===void 0&&V.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?V.setTextureCube(A,0):A.isData3DTexture?V.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?V.setTexture2DArray(A,0):V.setTexture2D(A,0),ve.unbindTexture()},this.resetState=function(){L=0,z=0,G=null,ve.reset(),ue.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return _i}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Qe._getDrawingBufferColorSpace(e),t.unpackColorSpace=Qe._getUnpackColorSpace()}}function T0(n,e){if(e===t1)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),n;if(e===fh||e===pv){let t=n.getIndex();if(t===null){const o=[],a=n.getAttribute("position");if(a!==void 0){for(let l=0;l<a.count;l++)o.push(l);n.setIndex(o),t=n.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),n}const i=t.count-2,r=[];if(e===fh)for(let o=1;o<=i;o++)r.push(t.getX(0)),r.push(t.getX(o)),r.push(t.getX(o+1));else for(let o=0;o<i;o++)o%2===0?(r.push(t.getX(o)),r.push(t.getX(o+1)),r.push(t.getX(o+2))):(r.push(t.getX(o+2)),r.push(t.getX(o+1)),r.push(t.getX(o)));r.length/3!==i&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const s=n.clone();return s.setIndex(r),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),n}function kA(n){const e=new Map,t=new Map,i=n.clone();return Fv(n,i,function(r,s){e.set(s,r),t.set(r,s)}),i.traverse(function(r){if(!r.isSkinnedMesh)return;const s=r,o=e.get(r),a=o.skeleton.bones;s.skeleton=o.skeleton.clone(),s.bindMatrix.copy(o.bindMatrix),s.skeleton.bones=a.map(function(l){return t.get(l)}),s.bind(s.skeleton,s.bindMatrix)}),i}function Fv(n,e,t){t(n,e);for(let i=0;i<n.children.length;i++)Fv(n.children[i],e.children[i],t)}class Ov extends Mo{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new GA(t)}),this.register(function(t){return new WA(t)}),this.register(function(t){return new QA(t)}),this.register(function(t){return new eR(t)}),this.register(function(t){return new tR(t)}),this.register(function(t){return new XA(t)}),this.register(function(t){return new YA(t)}),this.register(function(t){return new qA(t)}),this.register(function(t){return new $A(t)}),this.register(function(t){return new HA(t)}),this.register(function(t){return new KA(t)}),this.register(function(t){return new jA(t)}),this.register(function(t){return new JA(t)}),this.register(function(t){return new ZA(t)}),this.register(function(t){return new zA(t)}),this.register(function(t){return new b0(t,qe.EXT_MESHOPT_COMPRESSION)}),this.register(function(t){return new b0(t,qe.KHR_MESHOPT_COMPRESSION)}),this.register(function(t){return new nR(t)})}load(e,t,i,r){const s=this;let o;if(this.resourcePath!=="")o=this.resourcePath;else if(this.path!==""){const c=la.extractUrlBase(e);o=la.resolveURL(c,this.path)}else o=la.extractUrlBase(e);this.manager.itemStart(e);const a=function(c){r?r(c):console.error(c),s.manager.itemError(e),s.manager.itemEnd(e)},l=new Rv(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{s.parse(c,o,function(d){t(d),s.manager.itemEnd(e)},a)}catch(d){a(d)}},i,a)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,i,r){let s;const o={},a={},l=new TextDecoder;if(typeof e=="string")s=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===kv){try{o[qe.KHR_BINARY_GLTF]=new iR(e)}catch(f){r&&r(f);return}s=JSON.parse(o[qe.KHR_BINARY_GLTF].content)}else s=JSON.parse(l.decode(e));else s=e;if(s.asset===void 0||s.asset.version[0]<2){r&&r(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new gR(s,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let d=0;d<this.pluginCallbacks.length;d++){const f=this.pluginCallbacks[d](c);f.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[f.name]=f,o[f.name]=!0}if(s.extensionsUsed)for(let d=0;d<s.extensionsUsed.length;++d){const f=s.extensionsUsed[d],u=s.extensionsRequired||[];switch(f){case qe.KHR_MATERIALS_UNLIT:o[f]=new VA;break;case qe.KHR_DRACO_MESH_COMPRESSION:o[f]=new rR(s,this.dracoLoader);break;case qe.KHR_TEXTURE_TRANSFORM:o[f]=new sR;break;case qe.KHR_MESH_QUANTIZATION:o[f]=new oR;break;default:u.indexOf(f)>=0&&a[f]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+f+'".')}}c.setExtensions(o),c.setPlugins(a),c.parse(i,r)}parseAsync(e,t){const i=this;return new Promise(function(r,s){i.parse(e,t,r,s)})}}function BA(){let n={};return{get:function(e){return n[e]},add:function(e,t){n[e]=t},remove:function(e){delete n[e]},removeAll:function(){n={}}}}function Nt(n,e,t){const i=n.json.materials[e];return i.extensions&&i.extensions[t]?i.extensions[t]:null}const qe={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class zA{constructor(e){this.parser=e,this.name=qe.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let i=0,r=t.length;i<r;i++){const s=t[i];s.extensions&&s.extensions[this.name]&&s.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,s.extensions[this.name].light)}}_loadLight(e){const t=this.parser,i="light:"+e;let r=t.cache.get(i);if(r)return r;const s=t.json,l=((s.extensions&&s.extensions[this.name]||{}).lights||[])[e];let c;const d=new ke(16777215);l.color!==void 0&&d.setRGB(l.color[0],l.color[1],l.color[2],pn);const f=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new qs(d),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new vi(d),c.distance=f;break;case"spot":c=new CE(d),c.distance=f,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),hi(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),r=Promise.resolve(c),t.cache.add(i,r),r}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,i=this.parser,s=i.json.nodes[e],a=(s.extensions&&s.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(l){return i._getNodeRef(t.cache,a,l)})}}class VA{constructor(){this.name=qe.KHR_MATERIALS_UNLIT}getMaterialType(){return Jn}extendParams(e,t,i){const r=[];e.color=new ke(1,1,1),e.opacity=1;const s=t.pbrMetallicRoughness;if(s){if(Array.isArray(s.baseColorFactor)){const o=s.baseColorFactor;e.color.setRGB(o[0],o[1],o[2],pn),e.opacity=o[3]}s.baseColorTexture!==void 0&&r.push(i.assignTexture(e,"map",s.baseColorTexture,kt))}return Promise.all(r)}}class HA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);return i===null||i.emissiveStrength!==void 0&&(t.emissiveIntensity=i.emissiveStrength),Promise.resolve()}}class GA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];if(i.clearcoatFactor!==void 0&&(t.clearcoat=i.clearcoatFactor),i.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,"clearcoatMap",i.clearcoatTexture)),i.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=i.clearcoatRoughnessFactor),i.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,"clearcoatRoughnessMap",i.clearcoatRoughnessTexture)),i.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,"clearcoatNormalMap",i.clearcoatNormalTexture)),i.clearcoatNormalTexture.scale!==void 0)){const s=i.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new $e(s,s)}return Promise.all(r)}}class WA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);return i===null||(t.dispersion=i.dispersion!==void 0?i.dispersion:0),Promise.resolve()}}class jA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];return i.iridescenceFactor!==void 0&&(t.iridescence=i.iridescenceFactor),i.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,"iridescenceMap",i.iridescenceTexture)),i.iridescenceIor!==void 0&&(t.iridescenceIOR=i.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),i.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=i.iridescenceThicknessMinimum),i.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=i.iridescenceThicknessMaximum),i.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,"iridescenceThicknessMap",i.iridescenceThicknessTexture)),Promise.all(r)}}class XA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_SHEEN}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];if(t.sheenColor=new ke(0,0,0),t.sheenRoughness=0,t.sheen=1,i.sheenColorFactor!==void 0){const s=i.sheenColorFactor;t.sheenColor.setRGB(s[0],s[1],s[2],pn)}return i.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=i.sheenRoughnessFactor),i.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,"sheenColorMap",i.sheenColorTexture,kt)),i.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,"sheenRoughnessMap",i.sheenRoughnessTexture)),Promise.all(r)}}class YA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];return i.transmissionFactor!==void 0&&(t.transmission=i.transmissionFactor),i.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,"transmissionMap",i.transmissionTexture)),Promise.all(r)}}class qA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_VOLUME}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];t.thickness=i.thicknessFactor!==void 0?i.thicknessFactor:0,i.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,"thicknessMap",i.thicknessTexture)),t.attenuationDistance=i.attenuationDistance||1/0;const s=i.attenuationColor||[1,1,1];return t.attenuationColor=new ke().setRGB(s[0],s[1],s[2],pn),Promise.all(r)}}class $A{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_IOR}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);return i===null||(t.ior=i.ior!==void 0?i.ior:1.5),Promise.resolve()}}class KA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];t.specularIntensity=i.specularFactor!==void 0?i.specularFactor:1,i.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,"specularIntensityMap",i.specularTexture));const s=i.specularColorFactor||[1,1,1];return t.specularColor=new ke().setRGB(s[0],s[1],s[2],pn),i.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,"specularColorMap",i.specularColorTexture,kt)),Promise.all(r)}}class ZA{constructor(e){this.parser=e,this.name=qe.EXT_MATERIALS_BUMP}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];return t.bumpScale=i.bumpFactor!==void 0?i.bumpFactor:1,i.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,"bumpMap",i.bumpTexture)),Promise.all(r)}}class JA{constructor(e){this.parser=e,this.name=qe.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Nt(this.parser,e,this.name)!==null?Ai:null}extendMaterialParams(e,t){const i=Nt(this.parser,e,this.name);if(i===null)return Promise.resolve();const r=[];return i.anisotropyStrength!==void 0&&(t.anisotropy=i.anisotropyStrength),i.anisotropyRotation!==void 0&&(t.anisotropyRotation=i.anisotropyRotation),i.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,"anisotropyMap",i.anisotropyTexture)),Promise.all(r)}}class QA{constructor(e){this.parser=e,this.name=qe.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,i=t.json,r=i.textures[e];if(!r.extensions||!r.extensions[this.name])return null;const s=r.extensions[this.name],o=t.options.ktx2Loader;if(!o){if(i.extensionsRequired&&i.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,s.source,o)}}class eR{constructor(e){this.parser=e,this.name=qe.EXT_TEXTURE_WEBP}loadTexture(e){const t=this.name,i=this.parser,r=i.json,s=r.textures[e];if(!s.extensions||!s.extensions[t])return null;const o=s.extensions[t],a=r.images[o.source];let l=i.textureLoader;if(a.uri){const c=i.options.manager.getHandler(a.uri);c!==null&&(l=c)}return i.loadTextureImage(e,o.source,l)}}class tR{constructor(e){this.parser=e,this.name=qe.EXT_TEXTURE_AVIF}loadTexture(e){const t=this.name,i=this.parser,r=i.json,s=r.textures[e];if(!s.extensions||!s.extensions[t])return null;const o=s.extensions[t],a=r.images[o.source];let l=i.textureLoader;if(a.uri){const c=i.options.manager.getHandler(a.uri);c!==null&&(l=c)}return i.loadTextureImage(e,o.source,l)}}class b0{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){const t=this.parser.json,i=t.bufferViews[e];if(i.extensions&&i.extensions[this.name]){const r=i.extensions[this.name],s=this.parser.getDependency("buffer",r.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return s.then(function(a){const l=r.byteOffset||0,c=r.byteLength||0,d=r.count,f=r.byteStride,u=new Uint8Array(a,l,c);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(d,f,u,r.mode,r.filter).then(function(p){return p.buffer}):o.ready.then(function(){const p=new ArrayBuffer(d*f);return o.decodeGltfBuffer(new Uint8Array(p),d,f,u,r.mode,r.filter),p})})}else return null}}class nR{constructor(e){this.name=qe.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,i=t.nodes[e];if(!i.extensions||!i.extensions[this.name]||i.mesh===void 0)return null;const r=t.meshes[i.mesh];for(const c of r.primitives)if(c.mode!==Nn.TRIANGLES&&c.mode!==Nn.TRIANGLE_STRIP&&c.mode!==Nn.TRIANGLE_FAN&&c.mode!==void 0)return null;const o=i.extensions[this.name].attributes,a=[],l={};for(const c in o)a.push(this.parser.getDependency("accessor",o[c]).then(d=>(l[c]=d,l[c])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(c=>{const d=c.pop(),f=d.isGroup?d.children:[d],u=c[0].count,p=[];for(const g of f){const v=new je,x=new k,h=new er,m=new k(1,1,1),_=new Mv(g.geometry,g.material,u);for(let S=0;S<u;S++)l.TRANSLATION&&x.fromBufferAttribute(l.TRANSLATION,S),l.ROTATION&&h.fromBufferAttribute(l.ROTATION,S),l.SCALE&&m.fromBufferAttribute(l.SCALE,S),_.setMatrixAt(S,v.compose(x,h,m));for(const S in l)if(S==="_COLOR_0"){const w=l[S];_.instanceColor=new ph(w.array,w.itemSize,w.normalized)}else S!=="TRANSLATION"&&S!=="ROTATION"&&S!=="SCALE"&&g.geometry.setAttribute(S,l[S]);St.prototype.copy.call(_,g),this.parser.assignFinalMaterial(_),p.push(_)}return d.isGroup?(d.clear(),d.add(...p),d):p[0]}))}}const kv="glTF",Vo=12,A0={JSON:1313821514,BIN:5130562};class iR{constructor(e){this.name=qe.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,Vo),i=new TextDecoder;if(this.header={magic:i.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==kv)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const r=this.header.length-Vo,s=new DataView(e,Vo);let o=0;for(;o<r;){const a=s.getUint32(o,!0);o+=4;const l=s.getUint32(o,!0);if(o+=4,l===A0.JSON){const c=new Uint8Array(e,Vo+o,a);this.content=i.decode(c)}else if(l===A0.BIN){const c=Vo+o;this.body=e.slice(c,c+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class rR{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=qe.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const i=this.json,r=this.dracoLoader,s=e.extensions[this.name].bufferView,o=e.extensions[this.name].attributes,a={},l={},c={};for(const d in o){const f=vh[d]||d.toLowerCase();a[f]=o[d]}for(const d in e.attributes){const f=vh[d]||d.toLowerCase();if(o[d]!==void 0){const u=i.accessors[e.attributes[d]],p=$s[u.componentType];c[f]=p.name,l[f]=u.normalized===!0}}return t.getDependency("bufferView",s).then(function(d){return new Promise(function(f,u){r.decodeDracoFile(d,function(p){for(const g in p.attributes){const v=p.attributes[g],x=l[g];x!==void 0&&(v.normalized=x)}f(p)},a,c,pn,u)})})}}class sR{constructor(){this.name=qe.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class oR{constructor(){this.name=qe.KHR_MESH_QUANTIZATION}}class Bv extends vo{constructor(e,t,i,r){super(e,t,i,r)}copySampleValue_(e){const t=this.resultBuffer,i=this.sampleValues,r=this.valueSize,s=e*r*3+r;for(let o=0;o!==r;o++)t[o]=i[s+o];return t}interpolate_(e,t,i,r){const s=this.resultBuffer,o=this.sampleValues,a=this.valueSize,l=a*2,c=a*3,d=r-t,f=(i-t)/d,u=f*f,p=u*f,g=e*c,v=g-c,x=-2*p+3*u,h=p-u,m=1-x,_=h-u+f;for(let S=0;S!==a;S++){const w=o[v+S+a],b=o[v+S+l]*d,R=o[g+S+a],y=o[g+S]*d;s[S]=m*w+_*b+x*R+h*y}return s}}const aR=new er;class lR extends Bv{interpolate_(e,t,i,r){const s=super.interpolate_(e,t,i,r);return aR.fromArray(s).normalize().toArray(s),s}}const Nn={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},$s={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},R0={9728:zt,9729:Vt,9984:av,9985:$l,9986:qo,9987:zi},C0={33071:xi,33648:Ac,10497:so},Md={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},vh={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},ur={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},cR={CUBICSPLINE:void 0,LINEAR:Ca,STEP:Ra},Ed={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function uR(n){return n.DefaultMaterial===void 0&&(n.DefaultMaterial=new ss({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Ki})),n.DefaultMaterial}function zr(n,e,t){for(const i in t.extensions)n[i]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[i]=t.extensions[i])}function hi(n,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(n.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function dR(n,e,t){let i=!1,r=!1,s=!1;for(let c=0,d=e.length;c<d;c++){const f=e[c];if(f.POSITION!==void 0&&(i=!0),f.NORMAL!==void 0&&(r=!0),f.COLOR_0!==void 0&&(s=!0),i&&r&&s)break}if(!i&&!r&&!s)return Promise.resolve(n);const o=[],a=[],l=[];for(let c=0,d=e.length;c<d;c++){const f=e[c];if(i){const u=f.POSITION!==void 0?t.getDependency("accessor",f.POSITION):n.attributes.position;o.push(u)}if(r){const u=f.NORMAL!==void 0?t.getDependency("accessor",f.NORMAL):n.attributes.normal;a.push(u)}if(s){const u=f.COLOR_0!==void 0?t.getDependency("accessor",f.COLOR_0):n.attributes.color;l.push(u)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(l)]).then(function(c){const d=c[0],f=c[1],u=c[2];return i&&(n.morphAttributes.position=d),r&&(n.morphAttributes.normal=f),s&&(n.morphAttributes.color=u),n.morphTargetsRelative=!0,n})}function fR(n,e){if(n.updateMorphTargets(),e.weights!==void 0)for(let t=0,i=e.weights.length;t<i;t++)n.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(n.morphTargetInfluences.length===t.length){n.morphTargetDictionary={};for(let i=0,r=t.length;i<r;i++)n.morphTargetDictionary[t[i]]=i}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function hR(n){let e;const t=n.extensions&&n.extensions[qe.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+wd(t.attributes):e=n.indices+":"+wd(n.attributes)+":"+n.mode,n.targets!==void 0)for(let i=0,r=n.targets.length;i<r;i++)e+=":"+wd(n.targets[i]);return e}function wd(n){let e="";const t=Object.keys(n).sort();for(let i=0,r=t.length;i<r;i++)e+=t[i]+":"+n[t[i]]+";";return e}function yh(n){switch(n){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function pR(n){return n.search(/\.jpe?g($|\?)/i)>0||n.search(/^data\:image\/jpeg/)===0?"image/jpeg":n.search(/\.webp($|\?)/i)>0||n.search(/^data\:image\/webp/)===0?"image/webp":n.search(/\.ktx2($|\?)/i)>0||n.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const mR=new je;class gR{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new BA,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let i=!1,r=-1,s=!1,o=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){const a=navigator.userAgent;i=/^((?!chrome|android).)*safari/i.test(a)===!0;const l=a.match(/Version\/(\d+)/);r=i&&l?parseInt(l[1],10):-1,s=a.indexOf("Firefox")>-1,o=s?a.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||i&&r<17||s&&o<98?this.textureLoader=new AE(this.options.manager):this.textureLoader=new NE(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Rv(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const i=this,r=this.json,s=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([i.getDependencies("scene"),i.getDependencies("animation"),i.getDependencies("camera")])}).then(function(o){const a={scene:o[0][r.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:r.asset,parser:i,userData:{}};return zr(s,a,r),hi(a,r),Promise.all(i._invokeAll(function(l){return l.afterRoot&&l.afterRoot(a)})).then(function(){for(const l of a.scenes)l.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],i=this.json.meshes||[];for(let r=0,s=t.length;r<s;r++){const o=t[r].joints;for(let a=0,l=o.length;a<l;a++)e[o[a]].isBone=!0}for(let r=0,s=e.length;r<s;r++){const o=e[r];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(i[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,i){if(e.refs[t]<=1)return i;const r=i.clone(),s=(o,a)=>{const l=this.associations.get(o);l!=null&&this.associations.set(a,l);for(const[c,d]of o.children.entries())s(d,a.children[c])};return s(i,r),r.name+="_instance_"+e.uses[t]++,r}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let i=0;i<t.length;i++){const r=e(t[i]);if(r)return r}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const i=[];for(let r=0;r<t.length;r++){const s=e(t[r]);s&&i.push(s)}return i}getDependency(e,t){const i=e+":"+t;let r=this.cache.get(i);if(!r){switch(e){case"scene":r=this.loadScene(t);break;case"node":r=this._invokeOne(function(s){return s.loadNode&&s.loadNode(t)});break;case"mesh":r=this._invokeOne(function(s){return s.loadMesh&&s.loadMesh(t)});break;case"accessor":r=this.loadAccessor(t);break;case"bufferView":r=this._invokeOne(function(s){return s.loadBufferView&&s.loadBufferView(t)});break;case"buffer":r=this.loadBuffer(t);break;case"material":r=this._invokeOne(function(s){return s.loadMaterial&&s.loadMaterial(t)});break;case"texture":r=this._invokeOne(function(s){return s.loadTexture&&s.loadTexture(t)});break;case"skin":r=this.loadSkin(t);break;case"animation":r=this._invokeOne(function(s){return s.loadAnimation&&s.loadAnimation(t)});break;case"camera":r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(s){return s!=this&&s.getDependency&&s.getDependency(e,t)}),!r)throw new Error("Unknown type: "+e);break}this.cache.add(i,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){const i=this,r=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(r.map(function(s,o){return i.getDependency(e,o)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],i=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[qe.KHR_BINARY_GLTF].body);const r=this.options;return new Promise(function(s,o){i.load(la.resolveURL(t.uri,r.path),s,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(i){const r=t.byteLength||0,s=t.byteOffset||0;return i.slice(s,s+r)})}loadAccessor(e){const t=this,i=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){const o=Md[r.type],a=$s[r.componentType],l=r.normalized===!0,c=new a(r.count*o);return Promise.resolve(new Ht(c,o,l))}const s=[];return r.bufferView!==void 0?s.push(this.getDependency("bufferView",r.bufferView)):s.push(null),r.sparse!==void 0&&(s.push(this.getDependency("bufferView",r.sparse.indices.bufferView)),s.push(this.getDependency("bufferView",r.sparse.values.bufferView))),Promise.all(s).then(function(o){const a=o[0],l=Md[r.type],c=$s[r.componentType],d=c.BYTES_PER_ELEMENT,f=d*l,u=r.byteOffset||0,p=r.bufferView!==void 0?i.bufferViews[r.bufferView].byteStride:void 0,g=r.normalized===!0;let v,x;if(p&&p!==f){const h=Math.floor(u/p),m="InterleavedBuffer:"+r.bufferView+":"+r.componentType+":"+h+":"+r.count;let _=t.cache.get(m);_||(v=new c(a,h*p,r.count*p/d),_=new q1(v,p/d),t.cache.add(m,_)),x=new Lp(_,l,u%p/d,g)}else a===null?v=new c(r.count*l):v=new c(a,u,r.count*l),x=new Ht(v,l,g);if(r.sparse!==void 0){const h=Md.SCALAR,m=$s[r.sparse.indices.componentType],_=r.sparse.indices.byteOffset||0,S=r.sparse.values.byteOffset||0,w=new m(o[1],_,r.sparse.count*h),b=new c(o[2],S,r.sparse.count*l);a!==null&&(x=new Ht(x.array.slice(),x.itemSize,x.normalized)),x.normalized=!1;for(let R=0,y=w.length;R<y;R++){const T=w[R];if(x.setX(T,b[R*l]),l>=2&&x.setY(T,b[R*l+1]),l>=3&&x.setZ(T,b[R*l+2]),l>=4&&x.setW(T,b[R*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}x.normalized=g}return x})}loadTexture(e){const t=this.json,i=this.options,s=t.textures[e].source,o=t.images[s];let a=this.textureLoader;if(o.uri){const l=i.manager.getHandler(o.uri);l!==null&&(a=l)}return this.loadTextureImage(e,s,a)}loadTextureImage(e,t,i){const r=this,s=this.json,o=s.textures[e],a=s.images[t],l=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,i).then(function(d){d.flipY=!1,d.name=o.name||a.name||"",d.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(d.name=a.uri);const u=(s.samplers||{})[o.sampler]||{};return d.magFilter=R0[u.magFilter]||Vt,d.minFilter=R0[u.minFilter]||zi,d.wrapS=C0[u.wrapS]||so,d.wrapT=C0[u.wrapT]||so,d.generateMipmaps=!d.isCompressedTexture&&d.minFilter!==zt&&d.minFilter!==Vt,r.associations.set(d,{textures:e}),d}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const i=this,r=this.json,s=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(f=>f.clone());const o=r.images[e],a=self.URL||self.webkitURL;let l=o.uri||"",c=!1;if(o.bufferView!==void 0)l=i.getDependency("bufferView",o.bufferView).then(function(f){c=!0;const u=new Blob([f],{type:o.mimeType});return l=a.createObjectURL(u),l});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const d=Promise.resolve(l).then(function(f){return new Promise(function(u,p){let g=u;t.isImageBitmapLoader===!0&&(g=function(v){const x=new $t(v);x.needsUpdate=!0,u(x)}),t.load(la.resolveURL(f,s.path),g,void 0,p)})}).then(function(f){return c===!0&&a.revokeObjectURL(l),hi(f,o),f.userData.mimeType=o.mimeType||pR(o.uri),f}).catch(function(f){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),f});return this.sourceCache[e]=d,d}assignTexture(e,t,i,r){const s=this;return this.getDependency("texture",i.index).then(function(o){if(!o)return null;if(i.texCoord!==void 0&&i.texCoord>0&&(o=o.clone(),o.channel=i.texCoord),s.extensions[qe.KHR_TEXTURE_TRANSFORM]){const a=i.extensions!==void 0?i.extensions[qe.KHR_TEXTURE_TRANSFORM]:void 0;if(a){const l=s.associations.get(o);o=s.extensions[qe.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),s.associations.set(o,l)}}return r!==void 0&&(o.colorSpace=r),e[t]=o,o})}assignFinalMaterial(e){const t=e.geometry;let i=e.material;const r=t.attributes.tangent===void 0,s=t.attributes.color!==void 0,o=t.attributes.normal===void 0;if(e.isPoints){const a="PointsMaterial:"+i.uuid;let l=this.cache.get(a);l||(l=new Na,ni.prototype.copy.call(l,i),l.color.copy(i.color),l.map=i.map,l.sizeAttenuation=!1,this.cache.add(a,l)),i=l}else if(e.isLine){const a="LineBasicMaterial:"+i.uuid;let l=this.cache.get(a);l||(l=new lo,ni.prototype.copy.call(l,i),l.color.copy(i.color),l.map=i.map,this.cache.add(a,l)),i=l}if(r||s||o){let a="ClonedMaterial:"+i.uuid+":";r&&(a+="derivative-tangents:"),s&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let l=this.cache.get(a);l||(l=i.clone(),s&&(l.vertexColors=!0),o&&(l.flatShading=!0),r&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(a,l),this.associations.set(l,this.associations.get(i))),i=l}e.material=i}getMaterialType(){return ss}loadMaterial(e){const t=this,i=this.json,r=this.extensions,s=i.materials[e];let o;const a={},l=s.extensions||{},c=[];if(l[qe.KHR_MATERIALS_UNLIT]){const f=r[qe.KHR_MATERIALS_UNLIT];o=f.getMaterialType(),c.push(f.extendParams(a,s,t))}else{const f=s.pbrMetallicRoughness||{};if(a.color=new ke(1,1,1),a.opacity=1,Array.isArray(f.baseColorFactor)){const u=f.baseColorFactor;a.color.setRGB(u[0],u[1],u[2],pn),a.opacity=u[3]}f.baseColorTexture!==void 0&&c.push(t.assignTexture(a,"map",f.baseColorTexture,kt)),a.metalness=f.metallicFactor!==void 0?f.metallicFactor:1,a.roughness=f.roughnessFactor!==void 0?f.roughnessFactor:1,f.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(a,"metalnessMap",f.metallicRoughnessTexture)),c.push(t.assignTexture(a,"roughnessMap",f.metallicRoughnessTexture))),o=this._invokeOne(function(u){return u.getMaterialType&&u.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(u){return u.extendMaterialParams&&u.extendMaterialParams(e,a)})))}s.doubleSided===!0&&(a.side=gi);const d=s.alphaMode||Ed.OPAQUE;if(d===Ed.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,d===Ed.MASK&&(a.alphaTest=s.alphaCutoff!==void 0?s.alphaCutoff:.5)),s.normalTexture!==void 0&&o!==Jn&&(c.push(t.assignTexture(a,"normalMap",s.normalTexture)),a.normalScale=new $e(1,1),s.normalTexture.scale!==void 0)){const f=s.normalTexture.scale;a.normalScale.set(f,f)}if(s.occlusionTexture!==void 0&&o!==Jn&&(c.push(t.assignTexture(a,"aoMap",s.occlusionTexture)),s.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=s.occlusionTexture.strength)),s.emissiveFactor!==void 0&&o!==Jn){const f=s.emissiveFactor;a.emissive=new ke().setRGB(f[0],f[1],f[2],pn)}return s.emissiveTexture!==void 0&&o!==Jn&&c.push(t.assignTexture(a,"emissiveMap",s.emissiveTexture,kt)),Promise.all(c).then(function(){const f=new o(a);return s.name&&(f.name=s.name),hi(f,s),t.associations.set(f,{materials:e}),s.extensions&&zr(r,f,s),f})}createUniqueName(e){const t=ct.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,i=this.extensions,r=this.primitiveCache;function s(a){return i[qe.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,t).then(function(l){return P0(l,a,t)})}const o=[];for(let a=0,l=e.length;a<l;a++){const c=e[a],d=hR(c),f=r[d];if(f)o.push(f.promise);else{let u;c.extensions&&c.extensions[qe.KHR_DRACO_MESH_COMPRESSION]?u=s(c):u=P0(new Pt,c,t),r[d]={primitive:c,promise:u},o.push(u)}}return Promise.all(o)}loadMesh(e){const t=this,i=this.json,r=this.extensions,s=i.meshes[e],o=s.primitives,a=[];for(let l=0,c=o.length;l<c;l++){const d=o[l].material===void 0?uR(this.cache):this.getDependency("material",o[l].material);a.push(d)}return a.push(t.loadGeometries(o)),Promise.all(a).then(function(l){const c=l.slice(0,l.length-1),d=l[l.length-1],f=[];for(let p=0,g=d.length;p<g;p++){const v=d[p],x=o[p];let h;const m=c[p];if(x.mode===Nn.TRIANGLES||x.mode===Nn.TRIANGLE_STRIP||x.mode===Nn.TRIANGLE_FAN||x.mode===void 0)h=s.isSkinnedMesh===!0?new J1(v,m):new Ct(v,m),h.isSkinnedMesh===!0&&h.normalizeSkinWeights(),x.mode===Nn.TRIANGLE_STRIP?h.geometry=T0(h.geometry,pv):x.mode===Nn.TRIANGLE_FAN&&(h.geometry=T0(h.geometry,fh));else if(x.mode===Nn.LINES)h=new mh(v,m);else if(x.mode===Nn.LINE_STRIP)h=new La(v,m);else if(x.mode===Nn.LINE_LOOP)h=new rE(v,m);else if(x.mode===Nn.POINTS)h=new Nc(v,m);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+x.mode);Object.keys(h.geometry.morphAttributes).length>0&&fR(h,s),h.name=t.createUniqueName(s.name||"mesh_"+e),hi(h,s),x.extensions&&zr(r,h,x),t.assignFinalMaterial(h),f.push(h)}for(let p=0,g=f.length;p<g;p++)t.associations.set(f[p],{meshes:e,primitives:p});if(f.length===1)return s.extensions&&zr(r,f[0],s),f[0];const u=new Vi;s.extensions&&zr(r,u,s),t.associations.set(u,{meshes:e});for(let p=0,g=f.length;p<g;p++)u.add(f[p]);return u})}loadCamera(e){let t;const i=this.json.cameras[e],r=i[i.type];if(!r){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return i.type==="perspective"?t=new Jt(I1.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):i.type==="orthographic"&&(t=new lu(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),i.name&&(t.name=this.createUniqueName(i.name)),hi(t,i),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],i=[];for(let r=0,s=t.joints.length;r<s;r++)i.push(this._loadNodeShallow(t.joints[r]));return t.inverseBindMatrices!==void 0?i.push(this.getDependency("accessor",t.inverseBindMatrices)):i.push(null),Promise.all(i).then(function(r){const s=r.pop(),o=r,a=[],l=[];for(let c=0,d=o.length;c<d;c++){const f=o[c];if(f){a.push(f);const u=new je;s!==null&&u.fromArray(s.array,c*16),l.push(u)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Dp(a,l)})}loadAnimation(e){const t=this.json,i=this,r=t.animations[e],s=r.name?r.name:"animation_"+e,o=[],a=[],l=[],c=[],d=[];for(let f=0,u=r.channels.length;f<u;f++){const p=r.channels[f],g=r.samplers[p.sampler],v=p.target,x=v.node,h=r.parameters!==void 0?r.parameters[g.input]:g.input,m=r.parameters!==void 0?r.parameters[g.output]:g.output;v.node!==void 0&&(o.push(this.getDependency("node",x)),a.push(this.getDependency("accessor",h)),l.push(this.getDependency("accessor",m)),c.push(g),d.push(v))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(l),Promise.all(c),Promise.all(d)]).then(function(f){const u=f[0],p=f[1],g=f[2],v=f[3],x=f[4],h=[];for(let _=0,S=u.length;_<S;_++){const w=u[_],b=p[_],R=g[_],y=v[_],T=x[_];if(w===void 0)continue;w.updateMatrix&&w.updateMatrix();const U=i._createAnimationTracks(w,b,R,y,T);if(U)for(let L=0;L<U.length;L++)h.push(U[L])}const m=new yE(s,void 0,h);return hi(m,r),m})}createNodeMesh(e){const t=this.json,i=this,r=t.nodes[e];return r.mesh===void 0?null:i.getDependency("mesh",r.mesh).then(function(s){const o=i._getNodeRef(i.meshCache,r.mesh,s);return r.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let l=0,c=r.weights.length;l<c;l++)a.morphTargetInfluences[l]=r.weights[l]}),o})}loadNode(e){const t=this.json,i=this,r=t.nodes[e],s=i._loadNodeShallow(e),o=[],a=r.children||[];for(let c=0,d=a.length;c<d;c++)o.push(i.getDependency("node",a[c]));const l=r.skin===void 0?Promise.resolve(null):i.getDependency("skin",r.skin);return Promise.all([s,Promise.all(o),l]).then(function(c){const d=c[0],f=c[1],u=c[2];u!==null&&d.traverse(function(p){p.isSkinnedMesh&&p.bind(u,mR)});for(let p=0,g=f.length;p<g;p++)d.add(f[p]);if(d.userData.pivot!==void 0&&f.length>0){const p=d.userData.pivot,g=f[0];d.pivot=new k().fromArray(p),d.position.x-=p[0],d.position.y-=p[1],d.position.z-=p[2],g.position.set(0,0,0),delete d.userData.pivot}return d})}_loadNodeShallow(e){const t=this.json,i=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const s=t.nodes[e],o=s.name?r.createUniqueName(s.name):"",a=[],l=r._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&a.push(l),s.camera!==void 0&&a.push(r.getDependency("camera",s.camera).then(function(c){return r._getNodeRef(r.cameraCache,s.camera,c)})),r._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){a.push(c)}),this.nodeCache[e]=Promise.all(a).then(function(c){let d;if(s.isBone===!0?d=new Sv:c.length>1?d=new Vi:c.length===1?d=c[0]:d=new St,d!==c[0])for(let f=0,u=c.length;f<u;f++)d.add(c[f]);if(s.name&&(d.userData.name=s.name,d.name=o),hi(d,s),s.extensions&&zr(i,d,s),s.matrix!==void 0){const f=new je;f.fromArray(s.matrix),d.applyMatrix4(f)}else s.translation!==void 0&&d.position.fromArray(s.translation),s.rotation!==void 0&&d.quaternion.fromArray(s.rotation),s.scale!==void 0&&d.scale.fromArray(s.scale);if(!r.associations.has(d))r.associations.set(d,{});else if(s.mesh!==void 0&&r.meshCache.refs[s.mesh]>1){const f=r.associations.get(d);r.associations.set(d,{...f})}return r.associations.get(d).nodes=e,d}),this.nodeCache[e]}loadScene(e){const t=this.extensions,i=this.json.scenes[e],r=this,s=new Vi;i.name&&(s.name=r.createUniqueName(i.name)),hi(s,i),i.extensions&&zr(t,s,i);const o=i.nodes||[],a=[];for(let l=0,c=o.length;l<c;l++)a.push(r.getDependency("node",o[l]));return Promise.all(a).then(function(l){for(let d=0,f=l.length;d<f;d++){const u=l[d];u.parent!==null?s.add(kA(u)):s.add(u)}const c=d=>{const f=new Map;for(const[u,p]of r.associations)(u instanceof ni||u instanceof $t)&&f.set(u,p);return d.traverse(u=>{const p=r.associations.get(u);p!=null&&f.set(u,p)}),f};return r.associations=c(s),s})}_createAnimationTracks(e,t,i,r,s){const o=[],a=e.name?e.name:e.uuid,l=[];ur[s.path]===ur.weights?e.traverse(function(u){u.morphTargetInfluences&&l.push(u.name?u.name:u.uuid)}):l.push(a);let c;switch(ur[s.path]){case ur.weights:c=uo;break;case ur.rotation:c=fo;break;case ur.translation:case ur.scale:c=ho;break;default:switch(i.itemSize){case 1:c=uo;break;case 2:case 3:default:c=ho;break}break}const d=r.interpolation!==void 0?cR[r.interpolation]:Ca,f=this._getArrayFromAccessor(i);for(let u=0,p=l.length;u<p;u++){const g=new c(l[u]+"."+ur[s.path],t.array,f,d);r.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),o.push(g)}return o}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const i=yh(t.constructor),r=new Float32Array(t.length);for(let s=0,o=t.length;s<o;s++)r[s]=t[s]*i;t=r}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(i){const r=this instanceof fo?lR:Bv;return new r(this.times,this.values,this.getValueSize()/3,i)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function xR(n,e,t){const i=e.attributes,r=new si;if(i.POSITION!==void 0){const a=t.json.accessors[i.POSITION],l=a.min,c=a.max;if(l!==void 0&&c!==void 0){if(r.set(new k(l[0],l[1],l[2]),new k(c[0],c[1],c[2])),a.normalized){const d=yh($s[a.componentType]);r.min.multiplyScalar(d),r.max.multiplyScalar(d)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const s=e.targets;if(s!==void 0){const a=new k,l=new k;for(let c=0,d=s.length;c<d;c++){const f=s[c];if(f.POSITION!==void 0){const u=t.json.accessors[f.POSITION],p=u.min,g=u.max;if(p!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(p[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(p[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(p[2]),Math.abs(g[2]))),u.normalized){const v=yh($s[u.componentType]);l.multiplyScalar(v)}a.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}r.expandByVector(a)}n.boundingBox=r;const o=new bi;r.getCenter(o.center),o.radius=r.min.distanceTo(r.max)/2,n.boundingSphere=o}function P0(n,e,t){const i=e.attributes,r=[];function s(o,a){return t.getDependency("accessor",o).then(function(l){n.setAttribute(a,l)})}for(const o in i){const a=vh[o]||o.toLowerCase();a in n.attributes||r.push(s(i[o],a))}if(e.indices!==void 0&&!n.index){const o=t.getDependency("accessor",e.indices).then(function(a){n.setIndex(a)});r.push(o)}return Qe.workingColorSpace!==pn&&"COLOR_0"in i&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Qe.workingColorSpace}" not supported.`),hi(n,e),xR(n,e,t),Promise.all(r).then(function(){return e.targets!==void 0?dR(n,e.targets,t):n})}class zv extends ru{constructor(){super(),this.name="RoomEnvironment",this.position.y=-3.5;const e=new _o;e.deleteAttribute("uv");const t=new ss({side:hn}),i=new ss,r=new vi(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);const s=new Ct(e,t);s.position.set(-.757,13.219,.717),s.scale.set(31.713,28.305,28.591),this.add(s);const o=new Mv(e,i,6),a=new St;a.position.set(-10.906,2.009,1.846),a.rotation.set(0,-.195,0),a.scale.set(2.328,7.905,4.651),a.updateMatrix(),o.setMatrixAt(0,a.matrix),a.position.set(-5.607,-.754,-.758),a.rotation.set(0,.994,0),a.scale.set(1.97,1.534,3.955),a.updateMatrix(),o.setMatrixAt(1,a.matrix),a.position.set(6.167,.857,7.803),a.rotation.set(0,.561,0),a.scale.set(3.927,6.285,3.687),a.updateMatrix(),o.setMatrixAt(2,a.matrix),a.position.set(-2.017,.018,6.124),a.rotation.set(0,.333,0),a.scale.set(2.002,4.566,2.064),a.updateMatrix(),o.setMatrixAt(3,a.matrix),a.position.set(2.291,-.756,-2.621),a.rotation.set(0,-.286,0),a.scale.set(1.546,1.552,1.496),a.updateMatrix(),o.setMatrixAt(4,a.matrix),a.position.set(-2.193,-.369,-5.547),a.rotation.set(0,.516,0),a.scale.set(3.875,3.487,2.986),a.updateMatrix(),o.setMatrixAt(5,a.matrix),this.add(o);const l=new Ct(e,As(50));l.position.set(-16.116,14.37,8.208),l.scale.set(.1,2.428,2.739),this.add(l);const c=new Ct(e,As(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);const d=new Ct(e,As(17));d.position.set(14.904,12.198,-1.832),d.scale.set(.15,4.265,6.331),this.add(d);const f=new Ct(e,As(43));f.position.set(-.462,8.89,14.52),f.scale.set(4.38,5.441,.088),this.add(f);const u=new Ct(e,As(20));u.position.set(3.235,11.486,-12.541),u.scale.set(2.5,2,.1),this.add(u);const p=new Ct(e,As(100));p.position.set(0,20,0),p.scale.set(1,.1,1),this.add(p)}dispose(){const e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(const t of e)t.dispose()}}function As(n){return new dE({color:0,emissive:16777215,emissiveIntensity:n})}const _R=`
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;700;900&display=swap');

  .lp-root {
    position: fixed; inset: 0; background: #14141e;
  ...
  .lp-vignette {
    position: absolute; inset: 0; z-index: 2; pointer-events: none;
    background: radial-gradient(ellipse at 50% 40%, rgba(0,0,0,0.0) 30%, rgba(10,10,18,0.85) 100%);
  }
...
`;function vR({onEnter:n}){const e=ie.useRef(null),t=ie.useRef(null),i=ie.useRef(null),r=ie.useRef(null),[s,o]=ie.useState(!1);function a(){s||(o(!0),t.current&&t.current.classList.add("active"),setTimeout(n,650))}return ie.useEffect(()=>{const l=e.current;if(!l)return;const c=new zp({antialias:!0,alpha:!1});c.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),c.setSize(l.offsetWidth,l.offsetHeight),c.setClearColor(1315870,1),c.shadowMap.enabled=!0,c.outputColorSpace=kt,c.toneMapping=tu,c.toneMappingExposure=2.8,l.appendChild(c.domElement);const d=new Fc(c);d.compileEquirectangularShader();const f=d.fromScene(new zv,.1).texture;d.dispose();const u=new ru;u.fog=new iu(1315870,.012),u.environment=f;const p=new Jt(48,l.offsetWidth/l.offsetHeight,.1,300);p.position.set(-4,2,12),p.lookAt(0,0,0);const g=new qs(16774632,8);g.position.set(-6,8,10),u.add(g);const v=new qs(13162751,6);v.position.set(8,2,-4),u.add(v);const x=new qs(2105408,3);x.position.set(0,-6,6),u.add(x);const h=new vi(16720384,12,10);h.position.set(-1,0,6),u.add(h);const m=new vi(16746564,6,14);m.position.set(6,1,5),u.add(m);const _=new vi(2278750,8,20);_.position.set(0,5,7),u.add(_);const S=new vi(46296,6,28);S.position.set(4,4,8),u.add(S);const w=30,b=2,R=[];for(let ne=-w;ne<=w;ne+=b)R.push(new k(-w,0,ne),new k(w,0,ne)),R.push(new k(ne,0,-w),new k(ne,0,w));const y=new Pt().setFromPoints(R),T=new lo({color:30646,transparent:!0,opacity:.2}),U=new mh(y,T);U.position.y=-5,u.add(U);const L=[new k(-w,0,0),new k(w,0,0),new k(0,0,-w),new k(0,0,w)],z=new mh(new Pt().setFromPoints(L),new lo({color:46296,transparent:!0,opacity:.55}));z.position.y=-5,u.add(z);const G=200,W=new Float32Array(G*3),F=new Float32Array(G),C=new Float32Array(G*3);for(let ne=0;ne<G;ne++){W[ne*3]=(Math.random()-.5)*40,W[ne*3+1]=(Math.random()-.5)*24-6,W[ne*3+2]=(Math.random()-.5)*30-5,F[ne]=.02+Math.random()*.04;const _e=Math.random();_e<.35?(C[ne*3]=0,C[ne*3+1]=.71,C[ne*3+2]=.85):_e<.6?(C[ne*3]=0,C[ne*3+1]=.47,C[ne*3+2]=.85):_e<.78?(C[ne*3]=.13,C[ne*3+1]=.77,C[ne*3+2]=.37):_e<.9?(C[ne*3]=1,C[ne*3+1]=.42,C[ne*3+2]=.21):(C[ne*3]=.86,C[ne*3+1]=.15,C[ne*3+2]=.09)}const N=new Pt;N.setAttribute("position",new Ht(W,3)),N.setAttribute("color",new Ht(C,3));const P=new Nc(N,new Na({size:.09,sizeAttenuation:!0,vertexColors:!0,transparent:!0,opacity:.7}));u.add(P);const O=[[-14,8,-20,46296,1.8],[10,12,-25,30646,2.4],[18,4,-22,4770532,1.2],[-8,-4,-18,46296,1],[5,16,-28,147082,3],[-18,14,-30,38599,2],[14,-2,-15,16739125,.6]];for(const[ne,_e,tt,De,et]of O){const rt=new Ct(new Fp(et,8,8),new Jn({color:De,transparent:!0,opacity:.1+Math.random()*.08}));rt.position.set(ne,_e,tt),u.add(rt)}let X=null;new Ov().load("/eden-pipeline/robotic_eye.glb",ne=>{const _e=ne.scene;_e.traverse(D=>{if(D.name&&console.log("[RoboticEye] Node:",D.name,D.type),D.isMesh){const ht=D;ht.castShadow=!0,ht.receiveShadow=!0}}),_e.traverse(D=>{if(D.isMesh){const ht=D;(Array.isArray(ht.material)?ht.material:[ht.material]).forEach(Je=>{if(Je instanceof ss){Je.envMap=f,Je.envMapIntensity=2;const ve=Je.color;ve.r>.5&&ve.g<.3&&ve.b<.3&&(Je.emissive.set(16720384),Je.emissiveIntensity=1.8),ve.r>.4&&ve.g>.2&&ve.b<.2&&(Je.emissive.set(16737826),Je.emissiveIntensity=.4),Je.needsUpdate=!0}})}});const tt=new si().setFromObject(_e),De=tt.getSize(new k),He=8/Math.max(De.x,De.y,De.z);_e.scale.setScalar(He),tt.setFromObject(_e);const Mt=tt.getCenter(new k);_e.position.sub(Mt),X=new Vi,X.add(_e),u.add(X),i.current&&i.current.classList.add("hidden")},ne=>{if(ne.total>0&&r.current){const _e=Math.round(ne.loaded/ne.total*100);r.current.style.width=_e+"%"}},ne=>{console.error("[LandingPage] GLB load error:",ne),i.current&&i.current.classList.add("hidden")});const ee={x:0,y:0},Ce=ne=>{ee.x=(ne.clientX/window.innerWidth-.5)*2,ee.y=(ne.clientY/window.innerHeight-.5)*2};window.addEventListener("mousemove",Ce);const ze=()=>{p.aspect=l.offsetWidth/l.offsetHeight,p.updateProjectionMatrix(),c.setSize(l.offsetWidth,l.offsetHeight)};window.addEventListener("resize",ze);let pe,j=0,re=performance.now();const se={x:0,y:0};function Oe(){pe=requestAnimationFrame(Oe);const ne=performance.now(),_e=Math.min((ne-re)/1e3,.05);j+=_e,re=ne,X&&(se.y+=(ee.x*.5-se.y)*.04,se.x+=(-ee.y*.3-se.x)*.04,X.rotation.y=se.y+j*.15,X.rotation.x=se.x,X.position.y=Math.sin(j*.8)*.25),_.position.x=Math.sin(j*.5)*6,_.position.z=Math.cos(j*.5)*6+4,_.intensity=6+Math.sin(j*2.1)*2,h.intensity=8+Math.sin(j*3.2)*4,eyeSpot.intensity=25+Math.sin(j*7.4)*8;const tt=N.attributes.position.array;for(let De=0;De<G;De++)tt[De*3+1]+=F[De],tt[De*3+1]>12&&(tt[De*3+1]=-10,tt[De*3]=(Math.random()-.5)*40,tt[De*3+2]=(Math.random()-.5)*30-5);N.attributes.position.needsUpdate=!0,p.position.x=-4+Math.sin(j*.12)*.6,p.position.y=2+Math.sin(j*.18)*.3,p.lookAt(0,0,0),c.render(u,p)}return Oe(),()=>{cancelAnimationFrame(pe),window.removeEventListener("mousemove",Ce),window.removeEventListener("resize",ze),c.dispose(),l.contains(c.domElement)&&l.removeChild(c.domElement)}},[]),E.jsxs(E.Fragment,{children:[E.jsx("style",{children:_R}),E.jsxs("div",{className:"lp-root",onClick:a,children:[E.jsx("div",{ref:e,style:{position:"absolute",inset:0,zIndex:1}}),E.jsx("div",{className:"lp-scanlines"}),E.jsx("div",{className:"lp-vignette"}),E.jsx("div",{className:"lp-water"}),E.jsx("div",{className:"lp-grid-deco"}),E.jsx("div",{className:"lp-grid-deco-bl"}),E.jsxs("div",{ref:i,className:"lp-loader",children:[E.jsx("div",{className:"lp-loader-ring"}),E.jsx("div",{className:"lp-loader-text",children:"Initializing System"}),E.jsx("div",{className:"lp-loader-bar",children:E.jsx("div",{ref:r,className:"lp-loader-fill",style:{width:"0%"}})})]}),E.jsxs("div",{className:"lp-badge",children:[E.jsx("div",{className:"lp-badge-cross",children:E.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",children:[E.jsx("rect",{x:"8",y:"0",width:"4",height:"20",rx:"1.5",fill:"#dc2626",fillOpacity:"0.8"}),E.jsx("rect",{x:"0",y:"8",width:"20",height:"4",rx:"1.5",fill:"#dc2626",fillOpacity:"0.8"})]})}),E.jsx("span",{className:"lp-badge-text",children:"Eden Care — Medical AI"})]}),E.jsx("div",{className:"lp-overlay",children:E.jsxs("div",{className:"lp-brand",children:[E.jsx("div",{className:"lp-eyebrow",children:"by Eden Care"}),E.jsx("div",{className:"lp-title",children:"GINJA AI"}),E.jsx("div",{className:"lp-subtitle",children:"Medical Code Intelligence"}),E.jsx("div",{className:"lp-desc",children:"Insurance catalog processing pipeline · 7 AI modules · SHA-256 secured"}),E.jsxs("button",{className:"lp-btn",onClick:l=>{l.stopPropagation(),a()},children:[E.jsx("span",{className:"lp-btn-dot"}),"ENTER SYSTEM"]})]})}),E.jsx("div",{className:"lp-hint",children:"Click anywhere to enter"}),E.jsx("div",{ref:t,className:"lp-fadeout"})]})]})}const Vv="Muthigani",yR=[{username:"Muthigani",passwordHash:"c62b2152b8513d4c0c03ca8ba2716a45dc7e5227c1b051e50c765c8c97eddf25",role:"SUPER_ADMIN"}],tc="eden_session_v2",Vp="eden_login_attempts",nc=5,Sh=15*60*1e3,Hv="eden_users_v2";function Hp(){try{const n=localStorage.getItem(Hv);return n?JSON.parse(atob(n)):[]}catch{return[]}}function Gv(n){try{const e=n.filter(t=>t.username.toLowerCase()!==Vv.toLowerCase());localStorage.setItem(Hv,btoa(JSON.stringify(e)))}catch{}}function du(){return[...yR,...Hp()]}function SR(n){return du().find(e=>e.username.toLowerCase()===n.trim().toLowerCase())}function MR(n,e){if(du().some(r=>r.username.toLowerCase()===n.trim().toLowerCase()))throw new Error(`Username "${n}" is already taken.`);const i=Hp();i.push({username:n.trim(),passwordHash:e,role:"USER"}),Gv(i)}function ER(n){if(n.toLowerCase()===Vv.toLowerCase())throw new Error("Cannot remove the super admin.");const e=Hp().filter(t=>t.username.toLowerCase()!==n.toLowerCase());Gv(e)}async function wR(n){const e=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(n));return Array.from(new Uint8Array(e)).map(t=>t.toString(16).padStart(2,"0")).join("")}function Wv(){const n=ie.useRef(null);return ie.useEffect(()=>{const e=n.current;if(!e)return;const t=new zp({antialias:!0,alpha:!1});t.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),t.setSize(window.innerWidth,window.innerHeight),t.setClearColor(16054008,1),e.appendChild(t.domElement);const i=new ru;i.fog=new iu(16054008,.038);const r=new Jt(60,window.innerWidth/window.innerHeight,.1,200);r.position.set(0,0,28);const s=new Jn({color:1483594,wireframe:!0}),o=new Jn({color:14427686,wireframe:!0}),a=new Jn({color:13421772,wireframe:!0}),l=[],c=[[new jr(2.2,0),s,[-14,5,-5],1],[new jr(1.4,0),o,[12,-3,-8],.8],[new jr(3,0),a,[-6,-8,-15],.5],[new aa(1.8,0),s,[16,7,-10],.9],[new aa(2.5,0),a,[0,10,-12],.4],[new Dc(2,0),s,[-18,-5,-8],.7],[new Dc(1.2,0),o,[8,-9,-6],1.1],[new jr(1.6,1),a,[-10,12,-18],.3],[new aa(1,0),s,[20,-8,-12],.6],[new jr(.8,0),o,[-4,-12,-4],1.3],[new Uc(1.5,.06,6,20),s,[-20,8,-6],.5],[new Uc(2.2,.06,5,16),a,[6,14,-20],.3]];for(const[F,C,N,P]of c){const O=new Ct(F,C);O.position.set(...N),O.rotation.set(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2),i.add(O),l.push({mesh:O,rx:(Math.random()-.5)*.006*P,ry:(Math.random()-.5)*.008*P,rz:(Math.random()-.5)*.004*P,drift:new k((Math.random()-.5)*.004,(Math.random()-.5)*.003,0)})}function d(){const F=[];for(let P=0;P<400;P++){const O=P/400*40-20;let X=0;const Z=(O%5+5)%5;Z<.2?X=Math.sin(Z*Math.PI/.2)*.3:Z<.6?X=0:Z<.65?X=-.5:Z<.72?X=Math.sin((Z-.65)*Math.PI/.07)*3.5:Z<.78?X=-.4:Z<1.5?X=Math.sin((Z-.78)*Math.PI/.72)*.6:X=0,F.push(new k(O,X-8,-2))}return new Pt().setFromPoints(F)}const f=new La(d(),new lo({color:1483594,linewidth:1,transparent:!0,opacity:.5}));i.add(f);function u(){const F=[];for(let P=0;P<300;P++){const O=P/300*40-20,X=(O%4+4)%4;let Z=0;X<.1?Z=Math.sin(X*Math.PI/.1)*.2:X<.4?Z=0:X<.45?Z=-.3:X<.5?Z=Math.sin((X-.45)*Math.PI/.05)*2.2:X<.55?Z=-.25:X<1.2?Z=Math.sin((X-.55)*Math.PI/.65)*.4:Z=0,F.push(new k(O,Z+9,-8))}return new Pt().setFromPoints(F)}const p=new La(u(),new lo({color:14427686,linewidth:1,transparent:!0,opacity:.3}));i.add(p);const g=120,v=new Float32Array(g*3);for(let F=0;F<g;F++)v[F*3]=(Math.random()-.5)*60,v[F*3+1]=(Math.random()-.5)*40,v[F*3+2]=(Math.random()-.5)*30-10;const x=new Pt;x.setAttribute("position",new Ht(v,3));const h=new Nc(x,new Na({color:1483594,size:.12,sizeAttenuation:!0,transparent:!0,opacity:.5}));i.add(h);const m=200,_=new Float32Array(m*3);for(let F=0;F<m;F++)_[F*3]=(Math.random()-.5)*70,_[F*3+1]=(Math.random()-.5)*50,_[F*3+2]=(Math.random()-.5)*40-15;const S=new Pt;S.setAttribute("position",new Ht(_,3));const w=new Nc(S,new Na({color:11184810,size:.06,sizeAttenuation:!0,transparent:!0,opacity:.3}));i.add(w);const b={x:0,y:0},R={x:0,y:0},y=F=>{b.x=(F.clientX/window.innerWidth-.5)*2,b.y=(F.clientY/window.innerHeight-.5)*2};window.addEventListener("mousemove",y);let T=0;const U=()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)};window.addEventListener("resize",U);let L,z=0,G=performance.now();function W(){L=requestAnimationFrame(W);const F=performance.now();z+=(F-G)/1e3,G=F;for(const C of l)C.mesh.rotation.x+=C.rx,C.mesh.rotation.y+=C.ry,C.mesh.rotation.z+=C.rz,C.mesh.position.x+=C.drift.x,C.mesh.position.y+=C.drift.y,C.mesh.position.x>25&&(C.drift.x*=-1),C.mesh.position.x<-25&&(C.drift.x*=-1),C.mesh.position.y>18&&(C.drift.y*=-1),C.mesh.position.y<-18&&(C.drift.y*=-1);T-=.015,f.position.x=T%5,p.position.x=T*.7%4,h.rotation.y=z*.04,w.rotation.y=-z*.025,R.x+=(b.y*.04-R.x)*.04,R.y+=(b.x*.06-R.y)*.04,i.rotation.x=R.x,i.rotation.y=R.y,t.render(i,r)}return W(),()=>{cancelAnimationFrame(L),window.removeEventListener("mousemove",y),window.removeEventListener("resize",U),t.dispose(),e.contains(t.domElement)&&e.removeChild(t.domElement)}},[]),E.jsx("div",{ref:n,style:{position:"fixed",inset:0,zIndex:0,pointerEvents:"none"}})}async function TR(n){const e=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(n));return Array.from(new Uint8Array(e)).map(t=>t.toString(16).padStart(2,"0")).join("")}function Oc(){try{return JSON.parse(localStorage.getItem(Vp)||'{"attempts":[],"lockedUntil":0}')}catch{return{attempts:[],lockedUntil:0}}}function Dl(){const n=Oc(),e=Date.now();return n.lockedUntil>e?{locked:!0,remainingMs:n.lockedUntil-e}:{locked:!1,remainingMs:0}}function bR(){const n=Oc(),e=Date.now();n.attempts=[...(n.attempts||[]).filter(t=>e-t<Sh),e],n.attempts.length>=nc&&(n.lockedUntil=e+Sh),localStorage.setItem(Vp,JSON.stringify(n))}function AR(){localStorage.removeItem(Vp)}function I0(n){const e=Math.ceil(n/1e3);return e>=60?Math.ceil(e/60)+"m":e+"s"}const RR=`
  /* 3D tilt card */
